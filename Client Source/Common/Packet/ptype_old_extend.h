...
struct RecoverMsg : public pTypeBase
{
	int index_char;
	int recover_hp;
};
...
inline void makeRecoverHpMsg(CNetMsg::SP& msg, int charIndex, int poweValue)
{
	RecoverMsg* packet = reinterpret_cast<RecoverMsg*>(msg->m_buf);
	packet->type = MSG_SKILL;
	packet->subType = MSG_SKILL_RECOVER_HP;

	packet->index_char = charIndex;
	packet->recover_hp = poweValue;
	msg->setSize(sizeof(RecoverMsg));
}
#endif
}
//////////////////////////////////////////////////////////////////////////
