...
/* End: Define _CRTIMP */
  ...
  #if (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (defined ENABLE_X86_ASM) /* rcg10042001 */
    #define SAFEBREAKPOINT try { _asm { int 3 }; } catch(...) {;}
  #elif (defined _MSC_VER) && (defined  PLATFORM_64BIT) || (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT)
