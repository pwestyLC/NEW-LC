...
int CInvenData::GetCalcIndex( int tab, int invenIndex )
{
	...
	if (tab > INVENTORY_TAB_CASH_3)
		nDataIndex += ITEM_COUNT_IN_INVENTORY_CASH_3;
	
	if (tab > INVENTORY_TAB_CASH_4)
		nDataIndex += ITEM_COUNT_IN_INVENTORY_CASH_4;

	if (tab > INVENTORY_TAB_CASH_5)
		nDataIndex += ITEM_COUNT_IN_INVENTORY_CASH_5;

	if (tab > INVENTORY_TAB_CASH_6)
		nDataIndex += ITEM_COUNT_IN_INVENTORY_CASH_6;
