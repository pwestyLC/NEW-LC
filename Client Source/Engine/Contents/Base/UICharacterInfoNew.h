...
protected:
	//////////////////////////////////////////////////////////////////////////
	//NEW_USER_INTERFACE
	void	SetCurrentPageNewCharacterInfo(int nTabNum);		// ���� �� ����
	void	SetCurrentSkillInfo(int nSideTab, int nUpperTab);	// ��ųâ �� ����
	COLOR	GetStrColor(int nAdded);						// �ɷ�ġ ���� ������
...
public:
	...
	void	initCahrInfo(); // Tab 1 ĳ���� ����
	void	initSyndicateInfo(); // Tab 5 ���� ����
	
	void	initSecondTab(); // Tab 2 ������, Ư��, ��ǥ
	void	SetSSkill();
	void	SetItemSkill();
	void	SetSeal();

	void	initThirdTab(); // Tab 3 �׼�, �Ҽ�
	void	SetAction();
	void	SetSocial();

	void	initCommunity(); // Tab 4 ���, ��Ƽ
	void	SetGuild();
	void	SetParty();
	...
	void		UpdateHonorPoints();

	void		SendResetStatPoint();
...
private:
	...
	enum eCHARINFO_STAT
	{
		...
		eCHARINFO_STAT_STATPOINT_ADDITION,
		eCHARINFO_STAT_HP,
		eCHARINFO_STAT_MP,
	...
	CUIText*    m_honor;
	CUIProgressBar* m_pPbHonorPoints;
	enum eTAB_SKILL
	{
		eTAB_SKILL_ITEM = 0,
		eTAB_SKILL_SSKILL,
