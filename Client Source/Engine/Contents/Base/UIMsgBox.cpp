...
void CUIMsgBox::SetOkFCommand(_ui_func pCmd )
{
	if (_pBtnOk != NULL)
		_pBtnOk->SetCommandFUp(pCmd);
	else
	{
		//if (pCmd != NULL)
		//	SAFE_DELETE(pCmd);
...
void CUIMsgBox::SetCloseFCommand( _ui_func pCmd )
{
	#ifndef UI_TOOL
	if (_pBtnClose != NULL)
		_pBtnClose->SetCommandFUp(boost::bind(pCmd,this));
	else
	{
		//if (pCmd != NULL)
			//SAFE_DELETE(pCmd);
...
void CUIMsgBox::SetNoFCommand( _ui_func pCmd )
{
#ifndef UI_TOOL
	if (_pBtnNo != NULL)
		_pBtnNo->SetCommandFUp(boost::bind(pCmd,this));
	else
	{
		//if (pCmd != NULL)
			//SAFE_DELETE(pCmd);
