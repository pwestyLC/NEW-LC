...
public:
	...
	//new function commands reza
	void	SetOkFCommand(_ui_func pCmd);
	void	SetCloseFCommand(_ui_func pCmd);
	void	SetNoFCommand(_ui_func pCmd);
	//---------------------------
protected:
	CUIButton*	_pBtnOk;
	CUIButton*	_pBtnNo;
...
public:
	...
	void DestroyAll();
	void DeleteAll();
	UINT CreateMsgBoxNEW(const char* strTitle, const char* strContent, eMSG_TYPE eType,
		bool bDestroy = true, _ui_func pCmdOk = NULL, _ui_func pCmdNo = NULL, _ui_func pCmdClose = NULL, CTString* oktxt = NULL, CTString* closetxt = NULL);
...
private:
	...
	void SetMsgBoxInfoNEW(CUIMsgBox* pMsgBox, UINT nID, int x, int y, const char* strTitle, const char* strContent,
		_ui_func pCmdOk = NULL, _ui_func pCmdNo = NULL, _ui_func pCmdClose = NULL, bool bDestroy = true);
