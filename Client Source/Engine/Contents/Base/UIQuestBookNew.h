...
public:
	...
	void PressCheckAutoDelivery();//Cloud auto quest
	BOOL		GetSaveAutoQuest()				{ return m_bAutoSave; }//Cloud auto quest
#endif
	// 업데이트
...
#ifdef CLOUD_AUTO_QUEST_DELIVERY
	CUICheckButton* m_pBtnAutoDelivery;//Cloud auto quest
	BOOL	m_bAutoSave;//Cloud auto quest
#endif
