...
public:
	...
	void	UpdateZoomSpeed(eJob eClass);	// RomeoST
	void	UpdateDistance(eJob eClass);	// RomeoST
...
private:
	...
	FLOAT			m_fZSpeed, m_fYSpeed, m_fXSpeed;
	FLOAT			m_fAngle;

	FLOAT 			m_fMinDistance, m_fMaxDistance, m_fMaxHeight, m_fMinHeight;

	eUI_Ani_state	m_eAniState;
	int				m_nPlayActionId;
		
	FLOAT			m_fMinDistanceX, m_fMaxDistanceX;
	FLOAT			m_fMinDistanceY, m_fMaxDistanceY;
	FLOAT			m_fMinDistanceZ, m_fMaxDistanceZ;
};
