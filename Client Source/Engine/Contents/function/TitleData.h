...
public:
	...
	void SendTitleMake(int tab, int invenIdx, int virIdx, std::vector<int> indexSealsTab, std::vector<int> indexSealsInvenIdx, std::vector<int> indexSeals);
	void RecvTitleMessage(CNetworkMessage* istr); // �⼮ üũ
