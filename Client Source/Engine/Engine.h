...
extern ENGINE_API BOOL _bUseBloomInWorldEditor;		// �����Ϳ� Bloom ȿ�� On/Off�� ���� �߰�	:Su-won
extern ENGINE_API BOOL _bTranslucentModel;			// �����Ϳ� ���� ���������� ��Ÿ���� ���� �߰�	:Su-won
extern ENGINE_API BOOL _bInvisibleOff;				// �����Ϳ� Invisible�� �������� ��Ÿ���� ���� �߰�	:Su-won
extern ENGINE_API BOOL _bShowPortalPolygon;			// �����Ϳ��� Portal�Ӽ����� �Ǿ��ִ� �������� ȭ�鿡 ��Ÿ���� ���� :Su-won
extern ENGINE_API BOOL _bAttributemap_DepthTest;	//�����Ϳ��� Attribute ���� �׸� �� DepthTest ���� ���� :Su-won
