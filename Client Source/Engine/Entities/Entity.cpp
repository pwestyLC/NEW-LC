...
void CEntity::SetTargetInfoReal( float fMaxHealth, float fHealth, int level,int Pk,int pkstate,SQUAD llCount,int pkLegit,CCharacterTarget* ct, int nType )
{
	...
	{
		targetInfo.TargetType = CHARACTER;
		targetInfo.iReborn = ct->cha_reborn;
...
//������ ���� ����	//(For Performance)(0.2)
	if(GetLightSource()) 
	{
		...
		//Light entity�� ���°� ���� ������ m_vectorLights�� ���� entity�� �����͸� ��� ����. 
		//�׷��� entity�� ������ �� �� �߿� �ϳ��� �����Ǿ�, vector���� ������ entity �����͸� �������鼭 ������ �߻�.
		//=>m_vectorLights�� �������� �ʴ� entity�� ����.
...
void CEntity::FallDownToFloor( void)
{
	...
	if( bFloorHitted)
	{
		if (IsPlayer() && (g_slZone == 26 || g_slZone == 27 || g_slZone == 28)) // ���� ����������
		{
...
/*	ASSERTMSG(timeAbsolute>_pTimer->CurrentTick() ||
		timeAbsolute==THINKTIME_NEVER, "Do not SetThink() back in time!");*/ // eons �ӽ� �ּ� ó��
	// set the timer
