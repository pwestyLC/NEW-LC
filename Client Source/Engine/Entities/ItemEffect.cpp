...
#		undef MIN
 ...
 // newslot - alanssoares
	...
	// ���� ������ ��쿡�� 6�ܰ� ������ ����Ʈ�� ������ �����Ѵ�.
	if((CItemData::IsLordItem( ItemData->GetItemIndex() )||CItemData::IsUniqueItem(ItemData->GetItemIndex()) || CItemData::IsPremiumPheonixItem(ItemData->GetItemIndex())) && itemPlusNew != -1)
	{
		szLevel = "6";
	}
	else 
