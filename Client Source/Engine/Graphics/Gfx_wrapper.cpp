...
// functions' pointers
extern void (*gfxEnableDepthWrite)(void) = nullptr;
extern void (*gfxEnableDepthBias)(void) = nullptr;
extern void (*gfxEnableDepthTest)(void) = nullptr;
extern void (*gfxEnableAlphaTest)(void) = nullptr;
extern void (*gfxEnableBlend)(void) = nullptr;
extern void (*gfxEnableDither)(void) = nullptr;
extern void (*gfxEnableTexture)(void) = nullptr;
extern void (*gfxEnableLight)( INDEX iLight) = nullptr;
extern void (*gfxEnableLighting)(void) = nullptr;
extern void (*gfxEnableClipping)(void) = nullptr;
extern void (*gfxEnableClipPlane)(void) = nullptr;
extern void (*gfxDisableDepthWrite)(void) = nullptr;
extern void (*gfxDisableDepthBias)(void) = nullptr;
extern void (*gfxDisableDepthTest)(void) = nullptr;
extern void (*gfxDisableAlphaTest)(void) = nullptr;
extern void (*gfxDisableBlend)(void) = nullptr;
extern void (*gfxDisableDither)(void) = nullptr;
extern void (*gfxDisableTexture)(void) = nullptr;
extern void (*gfxDisableLight)( INDEX iLight) = nullptr;
extern void (*gfxDisableLighting)(void) = nullptr;
extern void (*gfxDisableClipping)(void) = nullptr;
extern void (*gfxDisableClipPlane)(void) = nullptr;
extern void (*gfxBlendFunc)( GfxBlend eSrc, GfxBlend eDst) = nullptr;
extern void (*gfxDepthFunc)( GfxComp eFunc) = nullptr;
extern void (*gfxDepthRange)( FLOAT fMin, FLOAT fMax) = nullptr;
extern void (*gfxCullFace)(  GfxFace eFace) = nullptr;
extern void (*gfxFrontFace)( GfxFace eFace) = nullptr;
extern void (*gfxClipPlane)( const DOUBLE *pdPlane) = nullptr;
extern void (*gfxSetOrtho)( const FLOAT fLeft, const FLOAT fRight, const FLOAT fTop,  const FLOAT fBottom, const FLOAT fNear, const FLOAT fFar, const BOOL bSubPixelAdjust) = nullptr;
extern void (*gfxSetFrustum)( FLOAT fLeft, FLOAT fRight, FLOAT fTop, FLOAT fBottom, FLOAT fNear, FLOAT fFar) = nullptr;
extern void (*gfxSetLightColor)( INDEX iLight, COLOR colLight, COLOR colAmbient, COLOR colSpecular/*=0*/) = nullptr;
extern void (*gfxSetLightDirection)( INDEX iLight, const FLOAT3D &vLightDir) = nullptr;
extern void (*gfxSetTextureMatrix)( const FLOAT *pfMatrix) = nullptr;
extern void (*gfxSetViewMatrix)( const FLOAT *pfMatrix) = nullptr;
extern void (*gfxPolygonMode)( GfxPolyMode ePolyMode) = nullptr;
extern void (*gfxSetTextureWrapping)( enum GfxWrap eWrapU, enum GfxWrap eWrapV) = nullptr;
extern void (*gfxSetTextureModulation)( INDEX iScale) = nullptr;
extern void (*gfxGenerateTexture)( ULONG64 &ulTexObject) = nullptr;
extern void (*gfxDeleteTexture)( ULONG64 &ulTexObject) = nullptr;
extern void (*gfxSetVertexArray)( GFXVertex *pvtx, INDEX ctVtx) = nullptr;
extern void (*gfxSetNormalArray)( GFXNormal *pnor) = nullptr;
extern void (*gfxSetWeightArray)( GFXWeight *pwgh) = nullptr;
extern void (*gfxSetTexCoordArray)( GFXTexCoord *ptex, BOOL bProjectiveMapping) = nullptr;
extern void (*gfxSetColorArray)( GFXColor *pcol) = nullptr;
extern void (*gfxDrawElements)( const INDEX ctIndices, const UWORD *puwIndices) = nullptr;
extern void (*gfxSetConstantColor)(COLOR col) = nullptr;
extern void (*gfxEnableColorArray)(void) = nullptr;
extern void (*gfxDisableColorArray)(void) = nullptr;
extern void (*gfxFinish)( BOOL bReadBack) = nullptr;
extern void (*gfxLockArrays)(void) = nullptr;
extern void (*gfxEnableTruform)( void) = nullptr;
extern void (*gfxDisableTruform)(void) = nullptr;
extern void (*gfxSetColorMask)( ULONG ulColorMask) = nullptr;
extern void* (*gfxLockSubBuffer)(   const INDEX iID, const INDEX i1stVertex, const INDEX ctVertices, const enum GfxLockType eLockType) = nullptr;
extern void  (*gfxUnlockSubBuffer)( const INDEX iID, const INDEX ctVertices) = nullptr;
extern void  (*gfxSetVertexSubBuffer)( const INDEX iID, const INDEX i1stVertex, const INDEX ctVertices) = nullptr;
extern void  (*gfxSetSubBuffer)(const INDEX iID, const INDEX iUnit, const INDEX tedt, const INDEX tedt2) = nullptr;

extern void  (*gfxSetVertexProgram)( const ULONG ulHandle) = nullptr;
extern void  (*gfxSetPixelProgram)(  LPDIRECT3DPIXELSHADER9 ulHandle) = nullptr;
extern void  (*gfxDeleteVertexProgram)( ULONG ulHandle) = nullptr;
extern void  (*gfxDeletePixelProgram)(  LPDIRECT3DPIXELSHADER9 ulHandle) = nullptr;
extern void  (*gfxSetVertexProgramConst)( INDEX iRegister, const void *pData, INDEX ctRegisters) = nullptr;
extern void  (*gfxSetPixelProgramConst)(  INDEX iRegister, const void *pData, INDEX ctRegisters) = nullptr;
extern ULONG (*gfxCreateVertexProgram)( const char *strVertexProgram, ULONG ulStreamFlags) = nullptr;
extern LPDIRECT3DPIXELSHADER9 (*gfxCreatePixelProgram)(  const char *strVertexProgram) = nullptr;
...
static void none_const_ulong64(const ULONG64 ul)
{
	ASSERT(_pGfx->gl_eCurrentAPI == GAT_NONE);
}

static void none_ulong64(ULONG64 ul)
{
	ASSERT(_pGfx->gl_eCurrentAPI == GAT_NONE);
}

static void none_dxpixelshader(LPDIRECT3DPIXELSHADER9 ul)
{
	ASSERT(_pGfx->gl_eCurrentAPI == GAT_NONE);
}
...
extern void gfxSetTextureSelectArg(INDEX iStage, GFX_TEXTURE_ARG argColor, GFX_TEXTURE_ARG argAlpha)
{
	...
	HRESULT hr;
	hr = _pGfx->gl_pd3d9Device->SetTextureStageState( iStage, D3DTSS_COLORARG1, argColor);
...
{ 
	...
	{ // just set it
		...
		for( INDEX iUnit=0; iUnit<_pGfx->gl_ctTextureUnits; iUnit++) { // loop thru tex units
			hr = _pGfx->gl_pd3d9Device->SetSamplerState(iUnit, D3DSAMP_MIPMAPLODBIAS, *((DWORD*)&fLODBias));
			D3D_CHECKERROR(hr);
		}
	}
...
extern ULONG64 _ulPatternTexture = NONE;
extern ULONG64 _ulLastUploadedPattern = 0;
...
extern void gfxSetTruform( INDEX iLevel, BOOL bLinearNormals)
{
	...
	// if disabled, Direct3D will set tessellation level at "enable" call
		...
		HRESULT hr = _pGfx->gl_pd3d9Device->SetRenderState(((D3DRENDERSTATETYPE)164), *((DWORD*)&fSegments));
		D3D_CHECKERROR(hr);
	}
...
static void  none_SetSubBuffer(const INDEX iID, const INDEX iUnit, const INDEX tedt, const INDEX tedt2) { NOTHING; };
...
static LPDIRECT3DPIXELSHADER9 none_CreatePixelProgram(  const char *strPixelProgram) { return NONE; };
...
extern void GFX_SetFunctionPointers( INDEX iAPI)
{
	...
	else
	{
		...
		gfxSetPixelProgram      = &none_dxpixelshader;
		gfxDeleteVertexProgram  = &none_ulong;
		gfxDeletePixelProgram   = &none_dxpixelshader;
