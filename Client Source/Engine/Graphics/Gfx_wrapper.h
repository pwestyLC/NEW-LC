...
public:
	...
	inline BOOL IsEqual(CTexParams tp) {
		return tp_iFilter == tp.tp_iFilter && tp_iAnisotropy == tp.tp_iAnisotropy && //liquid fix
...
extern void  (*gfxSetPixelProgram)(  LPDIRECT3DPIXELSHADER9 ulHandle);
extern void  (*gfxDeleteVertexProgram)( ULONG ulHandle);
extern void  (*gfxDeletePixelProgram)(  LPDIRECT3DPIXELSHADER9 ulHandle);
...
extern LPDIRECT3DPIXELSHADER9 (*gfxCreatePixelProgram)(  const char *strPixelProgram);
