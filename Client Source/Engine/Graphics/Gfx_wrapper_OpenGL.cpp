...
static void ogl_SetPixelProgram(const ULONG64 ulHandle)
{
  ASSERT( _pGfx->gl_eCurrentAPI==GAT_OGL);
  ASSERTALWAYS("Not implemented yet");
}
...
static void ogl_DeletePixelProgram(ULONG64 ulHandle)
{
  ASSERT( _pGfx->gl_eCurrentAPI==GAT_OGL);
  ASSERTALWAYS("Not implemented yet");
}
...
static ULONG64 ogl_CreatePixelProgram(const char *strPixelProgram)
{
  ASSERT( _pGfx->gl_eCurrentAPI==GAT_OGL);
  ASSERTALWAYS("Not implemented yet");
  return NONE;
