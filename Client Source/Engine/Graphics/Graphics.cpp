...
static void MakeOneMipmap( ULONG *pulSrcMipmap, ULONG *pulDstMipmap, PIX pixWidth, PIX pixHeight /*, BOOL bBilinear = TRUE;*/)
{
  // some safety checks
...
#if (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (defined ENABLE_X86_ASM) || (defined __GNU_INLINE_X86_32__)
// nothing
#else
...
extern "C" { ULONG aulRows[4096]; }
//extern ULONG aulRows[4096] = { 0 };  // filtering will be skipped if width of bitmap is larger than this buffer
...
#if !(defined USE_MMX_INTRINSICS) || (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (defined ENABLE_X86_ASM) || (defined __GNU_INLINE_X86_32__)
// nothing
...
#elif (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (defined ENABLE_X86_ASM)
  __asm {
    cld
