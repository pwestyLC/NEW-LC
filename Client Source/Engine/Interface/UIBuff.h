...
public:
	...
	CEffectGroup * m_pEG;
	SLONG		m_slRemainCount;			//2012/11/12 jeil ��ųȮ�� ���� �߰�
	...
	void	Init()
	{
		...
		m_slRemain = 0;
		m_pEG = NULL;
		m_slRemainCount = -1;			//2012/11/12 jeil ��ųȮ�� ���� �߰�
	}
...
#define	BUFF_GOOD_COUNT				66				//Buff���� Ȯ�� 22 - > 30 // �ϴ� ũ���ø� ���� �ʰ� 30--> 40���� �ø�
#define	BUFF_BAD_COUNT				10
#define MAX_BUFF_GOOD				(BUFF_GOOD_COUNT * 2)
#define MAX_BUFF_BAD				(BUFF_BAD_COUNT * 2)
#define	MAX_BUFF_COUNT 				(MAX_BUFF_BAD + MAX_BUFF_GOOD)
...
#define	MAX_BUFF_ROW				8				//Buff���� Ȯ�� 4 - > 5 // [2012/03/02 : Sora] ���� �ִ� ���� ���� 6 -> 7
...
public:
	...
	BuffInfo* GetBuffInfoSkill(SLONG skillindex);
