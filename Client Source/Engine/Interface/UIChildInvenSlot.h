...
#define ITEM_SLOT_UV_NEW_HEIGHT         (ITEM_SLOT_UV_SY + 288)
#define ITEM_SLOT_NEW_HEIGHT            288
#define ITEM_SLOT_MIDDLE_NEW_HEIGHT     (ITEM_SLOT_NEW_HEIGHT + ITEM_SLOT_HEIGHT_GAP)
#define ITEM_SLOT_TOTAL_NEW_HEIGHT      (ITEM_SLOT_TITLE_HEIGHT + ITEM_SLOT_MIDDLE_NEW_HEIGHT + ITEM_SLOT_BOTTOM_HEIGHT)
#endif
...
#ifdef EXPANSION_INVENTORY
	BOOL                m_bNewItem[INVEN_ONE_NEW_BAG];
	BOOL                m_bStartEffect[INVEN_ONE_NEW_BAG];
	int                 m_nPlayCount[INVEN_ONE_NEW_BAG];
#else
