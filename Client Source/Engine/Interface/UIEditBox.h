...
protected:
	...
	void	MoveCursor(MoveDirection mdDirection, BOOL isBack = FALSE);
...
public:
	...
	void setInputCallbackF(_ui_func callback) { m_pFuncInputCallback = callback; }
