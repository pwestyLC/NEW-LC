...
const int guildMarkMax =  180;	// ��帶ũ�� ����� ������ �ϵ��ڵ� �Ǿ� ����
const int guildMarkBGMax = 35;	// (������ �þ�� �ٲ��ٰ�)
...
void CUIGuildMark::Create( CUIWindow *pParentWnd, int nX, int nY, int nWidth, int nHeight )
{
	...
	m_btnInitGuildMark.Create(this, _S( 194, "�ʱ�ȭ" ), 8,295,108,21);
	...
	m_btnRegisterGuildMark.Create(this, _S( 5506, "��� ��ũ ���" ), 249,295,108,21);
	...
	m_btnCancel.Create(this, _S( 139, "���" ), 366,295,108,21);
...
void CUIGuildMark::Render()
{
	...
	pDrawPort->PutTextExCX( _S( 5506, "��� ��ũ ���"), m_nPosX + ( guildMarkWndWidth / 2 ), m_nPosY + 18, 0xDED9A0FF );

	pDrawPort->PutTextExCX( _S( 4432, "���� ����"), m_nPosX + 127, m_nPosY + 52, 0xDED9A0FF );
	
	strTemp.PrintF( _s("%d"), m_guildMarkPage );
	pDrawPort->PutTextExCX( strTemp, m_nPosX + 127, m_nPosY + 228 );

	pDrawPort->PutTextExCX( _S( 5507, "��� ����"), m_nPosX + 355, m_nPosY + 52, 0xDED9A0FF );

	strTemp.PrintF( _s("%d"), m_guildMarkBGPage );
	pDrawPort->PutTextExCX( strTemp, m_nPosX + 355, m_nPosY + 228 );

	strTemp.PrintF( _s("%s : %s" ), _S( 3451, "��� ��"), _pNetwork->MyCharacterInfo.strGuildName );
		...
		case MSGCMD_GUILD_MARK_CONFIRM:
			{
				if( bOK )
				{
					...
					MsgBoxInfo.SetMsgBoxInfo( _S( 191, "Ȯ��" ), UMBS_OKCANCEL, UI_GUILD_MARK, MSGCMD_GUILD_MARK_REGISTER );
					MsgBoxInfo.AddString( _S( 5510, "�����Ͻ� ��ũ�� ��� ��ũ�� ����Ͻðڽ��ϱ�?") );
...
{
	CUIMsgBox_Info	MsgBoxInfo;
	CTString strMessage = _S( 5508, "��� ��ũ ��� �㰡��");
	...
	strMessage = _S( 5509, "����Ͻ� ��� ��ũ ��ϱ��� �����Ͽ� �ֽñ� �ٶ��ϴ�.");
