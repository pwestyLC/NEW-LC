...
void CUIInvenCashBagBox::SetTitle()
{
	if( !m_pTextTitle )
		return;
	CTString strMessage;
	strMessage.PrintF(_S(6060, "%d�� ���̸��� ����"), m_nCashBagNum);
...
void CUIInvenCashBagBox::ErrMessage( int errCode )
{
	...
	case eERR_CAN_NOT_OPEN_KEY:
		{
			strMessage.PrintF( _S(6065, "���̸��� ������ �� �� �ִ� ���谡 �ƴմϴ�."));
		}
		break;
	case eERR_EMPTY_KEY:
		{
			strMessage.PrintF( _S(6063, "������ �� �� �ִ� ���踦 �÷��ּ���."));
		}
		break;
	}
...
void CUIInvenCashBagBox::UseItemMessage( int nCashBagIdx )
{
	...
	CUIMsgBox_Info	MsgBoxInfo;
	MsgBoxInfo.SetMsgBoxInfo( _S( 191, "Ȯ��" ), UMBS_OK, UI_NONE, MSGCMD_NULL );								
	strMessage.PrintF( _S(6064, "%d�� ���̸��� ������ ���Ƚ��ϴ�."), nCashBagIdx + 1);
	MsgBoxInfo.AddString( strMessage );
	pUIManager->CreateMessageBox( MsgBoxInfo );
}
