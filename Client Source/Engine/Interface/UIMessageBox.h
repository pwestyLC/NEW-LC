...
#define UMBS_CONFIRMPASSWORD			0x00001000	// �н����� Ȯ�� 
...
#define	UMBS_ALIGN_CENTER				0x00000000	// ��ư ���� (�⺻)
...
// Date : 2006-06-01(���� 4:22:25), By eons
#define UMBS_SECOND_INPUTBOX			0x00004000	// Second edit box
#define UMBS_BUTTONEX					0x00008000	// buttonex slot( ���� SetBtnType()�Լ��� �� ��� )

// [071122: Su-won]
#define UMBS_SPINBUTTON					0x00020000

// [sora] �ð� ����
#define UMBS_USE_TIMER					0x00040000	// ������ �ð��� �ڵ����� ������ ���� ����
...
public:
	...
	__int64			m_nTime;					// [sora] ��� �ð�
	BOOL			m_bTimeOutBtnMessage;		// [sora] ���� �޽���
...
public:
	...
	void	SetMsgBoxTimer(__int64 nTime, BOOL bTimeOutBtnMessage)	// [sora] ���� �ð� ����
	{
		m_nTime = nTime;
...
// �߰� ����ü. [11/19/2009 rumist]
// �̰͵� ���� �ȵ�. [11/19/2009 rumist]
...
public:
	...
	void	ReturnCommonCommand(); // Ŀ�� �޽��� �ڽ��� Ŀ�ǵ� ȣ��
	// Create
