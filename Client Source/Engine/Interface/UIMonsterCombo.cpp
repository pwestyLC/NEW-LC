...
//	m_rtMissionSlot.SetUV(4, 151, 206, 204,fTexWidth,fTexHeight);
	...
	//Button
	m_btnDel.Create(this, _S(2379,"����"), 10, 337, 60, 30);
	...
	m_btnMakeView.Create(this, _S(4021,"���� �Ϸ�"), 80, 337, 80, 30);
	...
	m_btnAdmission.Create(this, _S(4022,"����"), 170, 337, 60, 30);
...
//	m_lbComboHelp.Create( this, 0, 0, 260, 260, _nMsgBoxLineHeight, 8, 8, 2, FALSE);
	...
	pUIManager->GetHelp3()->AddHelpString(_S(4023,"��Ƽ�� �����޺��� ���� ���� ��Ƽ�常 �����޺��� ����� �ֽ��ϴ�."),0xFFE7ADFF,42);
	pUIManager->GetHelp3()->AddHelpString(_S(4024,"�����޺� �÷��̵� �� ��Ƽ�� ��ü�Ǹ� �����޺��� �������� ���ϰ� ���ź���� �̵��ϰ� �˴ϴ�."),0xFFE7ADFF,42);
	pUIManager->GetHelp3()->AddHelpString(_S(4025,"�����޺����� �����ϴ� ���Ϳ��Լ� ����ġ ���õ��� ȹ���Ҽ� ������ �������� ������� �ʽ��ϴ�."),0xFFE7ADFF,42);
	pUIManager->GetHelp3()->AddHelpString(_S(4026,"�����޺������� ��Ƽ ����, �����̵� ������, ��ȯ ������, �޸� ��ũ���� ����� �� �����ϴ�."),0xFFE7ADFF,42);
	pUIManager->GetHelp3()->AddHelpString(_S(4027,"�����޺� ������ ���� �����޺� �������ڷ� ���� ȹ���� �� �ִ� ��ȭ�� ������ �ٸ��ϴ�."),0xFFE7ADFF,42);
	pUIManager->GetHelp3()->AddHelpString(_S(4028,"�����޺� �����Ϳ��� ������ �����޺����ڴ� �����޺� ��ȭ�� �־�߸� ���� �ֽ��ϴ�."),0xFFE7ADFF,42);
...
void CUIMonsterCombo::Render()
{
	...
	m_bxContentsBox.SetBoxPos(WRect(10, 302, 270+15, 327));		// ���� �޺� ����
	m_bxContentsBox.Render(nX,nY);
	m_bxContentsBox.SetBoxPos(WRect(315, 302, 575+15, 327));	// ���� �ݾ�
	m_bxContentsBox.Render(nX,nY);
	m_bxContentsBox.SetBoxPos(WRect(315, 337, 575+15, 362));	// ����� 
	m_bxContentsBox.Render(nX,nY);
...
// 													0xFFFFFFFF );
		...
		{	
			...
			m_bxContentsBox.Render(nX,nY);
			// [2010/10/13 : Sora] ��ǥ�� ���� m_lbComboHelp�� parent�� GetHelp3���� parent�� ��ǥ�� ���ְ� �̵����Ѿ� ��
...
void CUIMonsterCombo::MissionCaseRender(int iX, int iY)
{
	...
	for(int i = 0; i < MISSION_SLOT_MAX; i++)
	{
		...
		if (g_iCountry == RUSSIA)
		{
			...
			strTemp.PrintF( _S(4141, "�г�Ƽ: %s %s Nas %s Point"), MC->bSkill ? _S( 192, "Yes"):_S( 193, "No"), strNas, strPoint);
...
void CUIMonsterCombo::RecComboErrorMessage(UBYTE comboMessage)
{
	...
	switch( comboMessage ) 
	{
		case MSG_EX_MONSTERCOMBO_ERROR_EDIT_COMPLETE_OK: // �����Ϸ�
			{
				strMessage1 = _S(4030,"���� �޺� ������ �Ϸ� �Ͽ����ϴ�.");
				m_bComboComplete = TRUE;
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_EDIT_COMPLETE_FAIL: // �����Ϸ� ����
			{
				strMessage1 = _S(4031,"���� �޺� ������ ���� �Ͽ����ϴ�.");
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_MONEY:   // ��������
			{
				strMessage1 = _S(4032,"���� �޺� ����ᰡ �����Ͽ� ������ �� �����ϴ�.");
				pUIManager->SetCSFlagOff(CSF_TELEPORT);
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_FULL:   // �޺��� ������ ���� ���
			{
				strMessage1 = _S(4033,"���� �޺����� ��ȭ�����̹Ƿ� ������ �� �����ϴ�.");
				pUIManager->SetCSFlagOff(CSF_TELEPORT);
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_NOT_EDIT:  // �����Ϸᰡ �ȵ�
			{
				strMessage1 = _S(4034,"���� �޺� �����Ϸᰡ ���� �ʾҽ��ϴ�.");
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_NOT_COMPLETE_STAGE: // �������� �Ϸ���� �ʾ���
			{
				strMessage1 = _S(4035,"���������� ���� �Ϸ���� �ʾ� ������ �� �����ϴ�.");
			}
			break;	
		case MSG_EX_MONSTERCOMBO_ERROR_DEAD_CHAR: // ���� ĳ���Ͱ� �־ �������� ������ �� ����
			{
				strMessage1 = _S(4795,"���� ĳ���Ͱ� �־ ���������� ������ �� �����ϴ�.");
				m_bStageClear = 1; // MSG_EX_MONSTERCOMBO_GOTO_STAGE���� FALSE�� �����ѽ������� Ŭ���� ���� ����
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_ALREADY_START: // ���������� �̹� ���۵Ǿ� ��ȯ�� �� ����
			{
				strMessage1 = _S(4796,"���������� �̹� ���۵Ǿ� ��ȯ�� �� �����ϴ�.");
			}
			break;
		case MSG_EX_MONSTERCOMBO_ERROR_NOT_EXIST_NPC:
			{
				strMessage1 = _S(5913,"���������� �̹� ���۵Ǿ� ��ȯ�� �� �����ϴ�.");
			}
		case MSG_EX_MONSTERCOMBO_ERORR_NOT_HIGH_LEVEL:
			{
				strMessage1 = _S(8452,"���������� �̹� ���۵Ǿ� ��ȯ�� �� �����ϴ�.");
			}
			break;
	}
