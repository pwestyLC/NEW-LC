...
public:
	...
	void InitXmlInfo(int nLineHeight);
	void InitFont();
	void Create();
	// Messages
	...
	void SetCursorMove(BOOL bMove);
	void SetOnlyNumMode(BOOL bOnlyNum);

	void SetMaxCharTb(CUIText* m_tbText);
