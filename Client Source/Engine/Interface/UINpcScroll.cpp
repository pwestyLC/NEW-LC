...
void CUINpcScroll::SetViewList()
{
	...
	CTString	tempDesc;
	tempDesc.PrintF(_S(5031,"%s ������ NPC�� ������ �̵��� �� �ִ� ��Ż�� �����մϴ�. \
							����Ʈ���� �̸��� Ŭ���ϸ� ��ġ �ȳ� �Ǵ� ��Ż�� ��� �Ͻ� �� �ֽ��ϴ�."),
...
void CUINpcScroll::OpenNPCScrollInfo(SLONG slIndex)
{
	...
	switch(slIndex)
	{
		case MSG_NPC_PORTAL_ERROR_MOB:
			{
				strMessage.PrintF(_S(4741,"���� �ʵ忡 �ش� ���Ͱ� �������� �ʽ��ϴ�."));
			}
			break;

		case MSG_NPC_PORTAL_ERROR_LIST:
			{
				strMessage.PrintF(_S(4742,"�� �������� ���� �������� ��� �� �� �����ϴ�."));
			}
			break;
		default:	// ���� �𸣴� ���� ���� �̴�. [eons]
			{
	...
	// error ������ �׶� �׶� ���� ��Ȯ�� �ѷ� �־�� �Ѵ�.  return; -> ClosemessageBox [eons]
	// �޼��� Ÿ���� �߸� ����Ͽ���. �˸� �޼��� �ڽ��� MSGLCMD�� �ƴ϶� MSGCMD�̴�.
	//�ܼ��� Ȯ�� â�̹Ƿ� MSGLCMD_NPC_SCROLL_MESSAGE�� MSGCMD_NULL���� ó���Ѵ�. UI_NPC_SCROLL���� UI_NONE����
	ErrorMsgBoxInfo.SetMsgBoxInfo(_S(1748, "�ȳ�"), UMBS_OK, UI_NONE, MSGCMD_NULL);
...
{
	if (std::count(m_vectorNpclist.begin(), m_vectorNpclist.end(), nIndex))	
		return TRUE;
...
void CUINpcScroll::choose( int idx, bool bnpc )
{
	...
	if (bnpc == true)
	{
		...
		if (pMob != NULL)
		{
			if (m_pTxtJob != NULL && pMob->GetName() != NULL)
				m_pTxtJob->SetText((CTString)pMob->GetName());

			if (m_pTbDescMove != NULL && pMob->GetDesc() != NULL)
