...
void CUIPersonalShop::Create( CUIWindow *pParentWnd, int nX, int nY, int nWidth, int nHeight )
{
	...
	m_btnShopCancel.Create( this, _S( 139, "���" ), 159, 419, 51, 21 );
	...
	m_btnShopStart.Create( this, _S( 742, "�ǸŰ���" ), 148, 419, 62, 21 );		
	...
	// Stop button of shop
	m_btnShopStop.Create( this, _S( 743, "�Ǹ�����" ), 148, 419, 62, 21 );		
	...
	// Package OK of shop
	m_btnPackageOK.Create( this, _S( 191, "Ȯ��" ), 105, 186, 51, 21 );		
	...
	m_btnPackageCancel.Create( this, _S( 139, "���" ), 159, 186, 51, 21 );		
	...
	int	nStrWidth = ( strlen( _S( 744, "�����̾�" ) ) + 1 ) *				
					( _pUIFontTexMgr->GetFontWidth() + _pUIFontTexMgr->GetFontSpacing() );
	m_cbtnPremium.Create( this, 193, 128, 11, 11, _S( 744, "�����̾�" ), TRUE, nStrWidth, nStrWidth );		
...
void CUIPersonalShop::Render()
{
	...
	if( !m_bBuyShop )
	{
		pDrawPort->PutTextExCX( _S( 753, "���� �̸�" ), m_nPosX + 55, m_nPosY + 368 );		
		pDrawPort->PutTextExCX( _S( 754, "��ǰ ���" ), m_nPosX + 55, m_nPosY + 26 );		
	}
	else
	{
		pDrawPort->PutTextExCX( _S( 755, "�Ǹ� ��ǰ" ), m_nPosX + 55, m_nPosY + 26 );		
	}
	pDrawPort->PutTextExCX( _S( 756, "��Ű�� �Ǹ�" ), m_nPosX + 55, m_nPosY + 128 );		

	// Flush all render text queue
	pDrawPort->EndTextEx();

	// Render item information
	pDrawPort->PutTextEx( _S( 757, "���λ���" ), m_nPosX + INVEN_TITLE_TEXT_OFFSETX,	
			...
			if( IsInside( nX, nY ) )
			{
				...
				else if( m_bPremium && !m_bBuyShop && IsInsideRect( nX, nY, m_rcMiddle ) )
				{
					...
					for( int iItem = 0; iItem < PERSONAL_PACKAGE_SLOT_COL; ++iItem )
					{
						...
						{
							// Update selected item
							m_nSelPackageItemID = iItem;			// ���õ� ������ ������ ID
