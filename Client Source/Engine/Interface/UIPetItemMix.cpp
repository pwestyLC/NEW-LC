...
void CUIPetItemMix::Create( CUIWindow *pParentWnd, int nX, int nY, int nWidth, int nHeight )
{
	...
	// Process Texture ���� - SkillLearn Texture ���
	...
	// Cancel button
	m_btnCancel.Create( this, _S( 139, "���" ), 149, 372-diff, 54, 21 );
...
//	m_nProcessText			= -1;				
	...
	m_nJobIndex[TITAN] = 918; // Ÿ��ź
	m_nJobIndex[KNIGHT] = 923; // ���
	m_nJobIndex[HEALER] = 938; // ����
	m_nJobIndex[MAGE] = 928; // ������
	m_nJobIndex[ROGUE] = 933; // �α�
	m_nJobIndex[SORCERER] = 943; // �Ҽ���
#ifdef CHAR_EX_ROGUE
	m_nJobIndex[EX_ROGUE] = 933; // [2012/08/27 : Sora] EX�α� �߰�
#endif
#ifdef CHAR_EX_MAGE
	m_nJobIndex[EX_MAGE] = 928; // 2013/01/08 jeil EX������ �߰� 
#endif
...
// Add render regions -----------------------------------------------------------------------------------------------
	...
	if( m_nPetType == DRAGON_WEAPON )
		pDrawPort->PutTextExCX( _S( 2460, "�巡�� ���� ����" ), m_nPosX + 106, m_nPosY + 35, COLOR_TITLE );
	else if( m_nPetType == KNIGHT_AMOR )
		pDrawPort->PutTextExCX( _S( 2461, "����Ʈ �޾� �� ����" ), m_nPosX + 106, m_nPosY + 35, COLOR_TITLE );
	...
	case WM_MOUSEMOVE:
		{
			...
			// Close button
				...
				return WMSG_SUCCESS;
			// OK button
			else if( m_btnOK[1].MouseMessage( pMsg ) != WMSG_FAIL )  // ���� Ÿ�� A
				return WMSG_SUCCESS;
			else if( m_btnOK[2].MouseMessage( pMsg ) != WMSG_FAIL )  // ���� Ÿ�� B
				return WMSG_SUCCESS;
...
// �ʿ� ��ų ��� 
	...
	{
		AddString ( _S( 2463, "�ʿ� ���A" ), COLOR_SUB_TITLE );
		...
		AddString ( _S( 2464, "�ʿ� ���B" ), COLOR_SUB_TITLE );
