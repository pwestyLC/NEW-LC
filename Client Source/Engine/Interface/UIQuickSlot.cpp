...
#define SHIFT_VAL 38
	...
	//  [12/10/2012 ï¿½ï¿½ï¿½ï¿½] UIï¿½ï¿½ï¿½ï¿½ SlotNumber
	...
	m_rtSlotNumberText3.SetUV(120, 557, 526, 564, fTexWidth, fTexHeight);
	...
	// [12/10/2012 ï¿½ï¿½ï¿½ï¿½] ï¿½ï¿½ï¿½ï¿½ UI ï¿½ï¿½Æ°
	...
	//ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ë¸ï¿½ ï¿½ï¿½Æ° UV	:Su-won
	...
	// [12/10/2012 ï¿½ï¿½ï¿½ï¿½] ï¿½ï¿½ï¿½ï¿½UI Add, Delete ï¿½ï¿½Æ° 
	// Add slot button
	...
	//ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ë¸ï¿½ ï¿½ï¿½Æ°	:Su-won
...
void CUIQuickSlot::ShowExSlotInfo( BOOL bShowInfo, int nSlotIndex )
{
	...
	// Update slot information
	{
		...
		case 1:
			{
				m_btnCashShop.GetAbsPos( nInfoPosX, nInfoPosY );
				m_strSlotInfo = _S(2572,"¾ÆÀÌ¸®½º »óÁ¡");
			}
			break;
		...
		case 3:
			{
				...
				CTString str;
				str.PrintF("%d %s(Alt+%d)", PrevPage, _S(3076, "ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½"), PrevPage);
				m_strSlotInfo =str;
		...
		case 4:
			{
				...
				CTString str;
				str.PrintF("%d %s(Alt+%d)", NextPage, _S(3076, "ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½"), NextPage);
				m_strSlotInfo =str;
		...
		// NOTE : ï¿½ï¿½ï¿½ï¿½ Ç¥ï¿½ï¿½ï¿½Ò¶ï¿½ï¿½ï¿½ QUICKSLOTï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ã¶ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½.
...
void CUIQuickSlot::Render()
{
	...
	// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½Ä¡ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ [12/20/2012 Ranma]
	...
	// [12/10/2012 ï¿½ï¿½ï¿½ï¿½] Add, Delete Button 
	m_btnAddSlot.Render();
...
// 
// 			// ï¿½ï¿½ï¿½Ìµï¿½ ï¿½ï¿½ ï¿½ï¿½Å³ï¿½Ì¸ï¿½ ï¿½ï¿½ï¿½ï¿½
// 			if(rSelSkill.GetJob() == WILDPET_JOB)
// 				continue;
// 			
// 			// ï¿½ï¿½ ï¿½ï¿½Å³ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½
	...
	for( iPage = 0; iPage < QSLOT_PAGE_COUNT; iPage++ )
	{
		for( iBtn = 0; iBtn < QSLOT_BTN_COUNT; iBtn++ )
		{
			...
			{				
				...
				// ï¿½Ö¿Ïµï¿½ï¿½ï¿½ ï¿½ï¿½Å³ï¿½ï¿½ Ã£ï¿½Æ¼ï¿½ ï¿½ï¿½ï¿½ï¿½.
				if( rSelSkill.GetType() == CSkill::ST_PET_SKILL_ACTIVE || 
					rSelSkill.GetType() == CSkill::ST_PET_COMMAND )
				{
					// Remove button
	...
	case WM_MOUSEMOVE:
		{
			...
			// Move quick slot
			// [12/11/2012 ï¿½ï¿½ï¿½ï¿½] UIï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ 1ï¿½ï¿½Â° Quickslotï¿½ï¿½ ï¿½Ìµï¿½ï¿½ï¿½ ï¿½Ò°ï¿½
			...
			{
				// [070604: Su-won] 1ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½
				// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Æ° ï¿½ï¿½ï¿½ï¿½Å° Ç¥ï¿½ï¿½
	...
	case WM_LBUTTONDOWN:
		{
			...
			if( IsInside( nX, nY ) )
			{
				...
				// Title bar 1
				// [12/10/2012 ï¿½ï¿½ï¿½ï¿½] UIï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ DragAreaï¿½ï¿½ ï¿½Ê¿ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	...
	case WM_LBUTTONUP:
		{
			...
			if (pUIManager->GetDragIcon() == NULL)
			{
				...
				// [12/10/2012 ï¿½ï¿½ï¿½ï¿½] Add, Delete Button Event Handling
				...
				else if( (wmsgResult = m_btnQuestBook.MouseMessage( pMsg )) != WMSG_FAIL )
				{
					...
					{
						//TODO : NewQuestSystem
						//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Þ¾Æ¾ï¿½ ï¿½Ï³ï¿½?
				...
				else if( (wmsgResult = m_btnCashShop.MouseMessage( pMsg )) != WMSG_FAIL)
				{
					...
					if( wmsgResult == WMSG_COMMAND ) //&& g_uiEngineVersion < 10000)
					{
						if (!pUIManager->GetCashShopEX()->IsVisible())
						{
							...
							{
								pUIManager->GetCashShopEX()->Message(MSGCMD_GIFT_ERROR, _S(372, "Á¡°Ë"), _S(5296, "¾ÆÀÌ¸®½º »óÁ¡ÀÌ ÀÏ½Ã Á¡°Ë ÁßÀÔ´Ï´Ù. Àá½Ã ÈÄ¿¡ ÀÌ¿ëÇØ ÁÖ½Ê½Ã¿À."), UMBS_OK);
							}
							else
							{
				...
				// ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ë¸ï¿½ ï¿½ï¿½Æ° Å¬ï¿½ï¿½	:Su-won
				else if( (wmsgResult = m_btnGiftNotice.MouseMessage( pMsg )) != WMSG_FAIL )
				{
					...
					if( m_bGiftRecv )
					{
						if (!pUIManager->GetCashShopEX()->IsVisible())
						{
							if (pUIManager->GetCashShopEX()->GetCashShopLock())
							{
								pUIManager->GetCashShopEX()->Message(MSGCMD_GIFT_ERROR, _S(372, "ï¿½ï¿½ï¿½ï¿½"), _S(5296, "ï¿½ï¿½ï¿½Ì¸ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ï½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Ô´Ï´ï¿½. ï¿½ï¿½ï¿½ ï¿½Ä¿ï¿½ ï¿½Ì¿ï¿½ï¿½ï¿½ ï¿½Ö½Ê½Ã¿ï¿½."), UMBS_OK);
							}
							else
							{
								_pNetwork->SendCashItemMessage(MSG_EX_CASHITEM_SHOP_OPEN_REQ);
	...
	case UBET_SKILL:
		{
			...
			{
				return;  pwesty quick slot bug skill
			}*/
			...
			if (bDelay == TRUE)
			{
				...
				DOUBLE dReUseTime = DOUBLE(rSkill.GetReUseTime()) / 10.0;
				DOUBLE dElapsedTime = _pTimer->GetHighPrecisionTimer().GetSeconds() - rSkill.Skill_Data.Skill_StartTime;

				if (dElapsedTime <= dReUseTime)
					return;

				MY_INFO()->SetSkillDelay(nSkillIndex, false, m_abtnItems[nCurrentPage][nSlotIndex]->IsSpecial());
				m_abtnItems[nCurrentPage][nSlotIndex]->setCooltime(false);
			}
			...
			else
			{
				...
				{	// ï¿½ï¿½ï¿½ ï¿½ï¿½Å³ï¿½ï¿½ ï¿½ï¿½ï¿½, ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ Ã¼Å©
	...
	case UBET_ACTION:
		{
			...
			{ return; }// 0.5ï¿½ï¿½ ï¿½ï¿½ï¿½Ì¿ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Æ°ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ù¸ï¿½ return;
	...
	case UBET_ITEM:
		{
			...
			{	
				...
				{
					_pNetwork->ClientSystemMessage( _S( 305, "ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ï´ï¿½." ), SYSMSG_ERROR );
					return;
				}				
			}
			...
			// ï¿½ï¿½ï¿½ï¿½Æ® ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ Ã¼Å©
			if (m_abtnItems[nCurrentPage][nSlotIndex]->IsRestritionItem() == true)
			{
				...
				strTitle	=	_S(191,"È®ï¿½ï¿½");
				strMessage1	=	_S( 4428, "ï¿½ï¿½ï¿½â¼­ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ï´ï¿½" ); 
	...
	case UBET_SKILL:
		{
			...
			{
				CTString strMessage = _S(2339,"ï¿½ï¿½È¯ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ ï¿½Ö´ï¿½ ï¿½ï¿½Å³ï¿½Ô´Ï´ï¿½.");
	...
	case UBET_ACTION:
		{
			...
			if (g_iCountry == RUSSIA)
			{
				// [2011/05/18 : Sora] ï¿½ï¿½ï¿½Ã¾ï¿½ï¿½ï¿½ ï¿½ï¿½Ã»ï¿½ï¿½ï¿½ï¿½ P2ï¿½Ý±ï¿½,ï¿½ï¿½ï¿½ï¿½ ï¿½×¼ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ô¿ï¿½ ï¿½ï¿½Ïµï¿½ï¿½ï¿½ ï¿½Ê°ï¿½ Ã³ï¿½ï¿½
				if( nActionIndex == 44 /*P2 ï¿½ï¿½ï¿½ï¿½*/ || nActionIndex == 45 /*P2 ï¿½Ý±ï¿½*/ )
				{
					return;
				}
			}
...
BOOL CUIQuickSlot::StartSkillDelay( int nIndex )
{
	...
	for( int iPage = 0; iPage < QSLOT_PAGE_COUNT; iPage++ )
	{
		for( int iCol = 0; iCol < QSLOT_BTN_COUNT; iCol++ )
		{
			...
			{
				// [2010/10/20 : Sora] ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ô¼ï¿½ï¿½ï¿½ ï¿½ï¿½Ã¼
...
void CUIQuickSlot::AddBtn( int nPage, int nSlotNum, int nSlotType, int nData0, int nData1 )
{
	...
	// CTString debug;
	// debug.PrintF("Quick add btn %d %d", nPage, nSlotNum);
	// _pNetwork->ClientSystemMessage( debug, SYSMSG_ERROR );
	...
	case QUICKSLOT_TYPE_ITEM:
		{
			...
			//[100126 sora] ï¿½ï¿½ï¿½ï¿½ï¿½Ô¿ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½É¼ï¿½ï¿½ï¿½ï¿½ï¿½ Ç¥ï¿½ï¿½
...
//ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ë¸ï¿½ ï¿½ï¿½Æ° ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½		:Su-won
...
// Desc : ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ count update
// ----------------------------------------------------------------------------
...
// Desc : ï¿½ï¿½ï¿½ï¿½ï¿½Ô¿ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ç¾ï¿½ ï¿½Ö´ï¿½ï¿½ï¿½ È®ï¿½ï¿½ï¿½Ñ´ï¿½.
// ----------------------------------------------------------------------------
...
// Desc : È®ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Æ°ï¿½ï¿½ ï¿½ï¿½Û¸ï¿½ ï¿½Ô¼ï¿½
// ----------------------------------------------------------------------------
void CUIQuickSlot::ToggleVisibleEXQuickSlot(BOOL bResultView)
{
	...
	if (bResultView)
	{
		...
		nCurOpenUI = g_bQuickSlotEX1 >= 1 ? (g_bQuickSlotEX2 >= 1 ? (g_bQuickSlotEX3 >= 1 ? -1 : 2) : 1) : 0;
	}
	else
	{
		//nCurOpenUI = g_bQuickSlotEX1 >= 1 ? (g_bQuickSlotEX2 >= 1 ? 1 : 0) : -1;
		nCurOpenUI = g_bQuickSlotEX1 >= 1 ? (g_bQuickSlotEX2 >= 1 ? (g_bQuickSlotEX3 >= 1 ? 2 : 1) : 0) : -1;
	}
	...
	// CTString debug;
	// debug.PrintF("Quick %d", nCurOpenUI);
	// _pNetwork->ClientSystemMessage( debug, SYSMSG_ERROR );
...
// ----------------------------------------------------------------------------
// Name : CheakSlotEXBtn
// Desc : ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ Ã¼Å© ï¿½Ï¿ï¿½ ï¿½ï¿½ï¿½Â¸ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ø´ï¿½. È®ï¿½ï¿½ï¿½Æ°ï¿½ï¿½ ï¿½ï¿½ï¿½Â¸ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ñ´ï¿½ ï¿½Æ½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Æ´ï¿½ï¿½ï¿½
// ----------------------------------------------------------------------------
BOOL CUIQuickSlot::CheckSlotEXBtn(eQSlotEXBtn eBtn) // ï¿½ï¿½ï¿½Ï±ï¿½ ï¿½ï¿½Æ°ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Æ°ï¿½ï¿½ï¿½ï¿½
{
	switch(eBtn)
	{
	case QSLOT_ADD:
		{
			if (g_bQuickSlotEX1 && g_bQuickSlotEX2 && g_bQuickSlotEX3)
				return TRUE;
...
// Desc : ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ Ã¼Å© ï¿½Ï¿ï¿½ ï¿½ï¿½ï¿½Â¸ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ø´ï¿½.
// ----------------------------------------------------------------------------
void CUIQuickSlot::SetDisableCheckSlotEX()
{
	...
	else if (!g_bQuickSlotEX1 && !g_bQuickSlotEX2 && !g_bQuickSlotEX3)
	{
...
void CUIQuickSlot::setQuickSlotItemData( int nPage, int nSlot, int type, int idx, CItems* pItem, bool bWearTab, bool bItemRef /*= true*/ )
{
	...
	// CTString debug;
	// debug.PrintF("Quick add %d %d", nPage, nSlot);
	// _pNetwork->ClientSystemMessage( debug, SYSMSG_ERROR );
