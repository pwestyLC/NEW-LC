...
public:
	...
	void	OnExpressNotice(int newMailsCount = 0);
...
public:
	...
	__int64				m_liArenaEndTime;
	CUIImageArray*		m_pImgArrArenaTime;

	void UpdateArenaTime();
	void ResetArenaTime();
	void SetArenaTime( const INDEX remainTime /*= 0 */ );
