...
//#endif
						...
						else
						{
							...
							// ���Կ� ��� ������ �ִ��� Ȯ���ؼ�,
							// �� �� ������ ���̻� �����Ҽ� ������ ��Ÿ����.
							CUIManager::getSingleton()->SetUIGameState(eSTAGE_CREATECHAR);
				...
				else if( ( wmsgResult = m_btnExit.MouseMessage( pMsg ) ) != WMSG_FAIL )
				{
					if( wmsgResult == WMSG_COMMAND )
					{
						...
						if(g_bAutoLogin)
						{
							...
							_pGameState->SetCameraById(43441, FALSE);

							pUIManager->SetUIGameState( eSTAGE_SELSERVER );						
						}
						else
						{
							...
							pUIManager->SetUIGameState(eSTAGE_LOGIN);
							// ������ ���忡 �ִ� ��ƼƼ�� ������.
							for(int i = 0; i < MAX_SLOT; ++i)
							{
