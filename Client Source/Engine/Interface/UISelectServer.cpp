...
// Date : 2005-05-17(���� 4:54:18), By Lee Ki-hwan
...
#define TEMP_SERVER_LIST // define ������ ��ȣ ������ ����..
// -----wooss 060425------------------------------------------->>
...
CUISelectServer::CUISelectServer()
{
	...
	m_astrServerName[0] = _S( 796, "īŸ��" ); 
	m_astrServerName[1] = _S( 797, "ũ����" ); 
	m_astrServerName[2] = _S( 798, "�ϸ���" ); 
	m_astrServerName[3] = _S( 799, "ĭ�ڸ�" ); 
	m_astrServerName[4] = _S( 800, "���̹�" ); 
	m_astrServerName[5] = _S( 801, "���䵵��" ); 
	m_astrServerName[6] = _S( 802, "�ĳĵ�" ); 
	m_astrServerName[7] = _S( 803, "������" ); 
	m_astrServerName[8] = _S( 804, "ĿƲ����" ); 
	m_astrServerName[9] = _S( 805, "���긣" ); 
	...
	m_astrServerName[30] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[31] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[32] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[33] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[34] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[35] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[36] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[37] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[38] = _S( 246, "�׽�Ʈ ����" );
	m_astrServerName[39] = _S( 246, "�׽�Ʈ ����" );
...
void CUISelectServer::Create( CUIWindow *pParentWnd, int nX, int nY, int nWidth, int nHeight )
{
	...
	// Ok button
	m_btnOK.Create( this, _S( 249, "����" ), 274, 205 + NOTICE_SIZE_Y, 63, 21 );
	...
	// Cancel button
		...
		m_btnCancel.Create( this, _S( 2681, "����" ), 208, 205+ NOTICE_SIZE_Y, 63, 21 );
	#else
		m_btnCancel.Create( this, _S( 286, "����" ), 340, 205+ NOTICE_SIZE_Y, 63, 21 );
	#endif
#else
	#ifdef AUTO_RESTART	// [2012/10/18 : Sora] ����۽� �ڵ� �α���
		m_btnCancel.Create( this, _S( 2681, "����" ), 208, 205+ NOTICE_SIZE_Y, 63, 21 );
	#else
		m_btnCancel.Create( this, _S( 139, "���" ), 340, 205+ NOTICE_SIZE_Y, 63, 21 );
	#endif
#endif
...
#ifdef AUTO_RESTART	// [2012/10/18 : Sora] ����۽� �ڵ� �α���
	m_btnExit.Create( this, _S( 286, "����" ), 340, 205+ NOTICE_SIZE_Y, 63, 21 );
...
#if defined G_KOR
	// ���� ���� ����(�ʺ�����)
	pDrawPort->PutTextEx( _S(4874, "���ʺ����� ������?" ),
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFAAFFFF );
	tv_y+=20;
	pDrawPort->PutTextEx( _S(4875, "��Ʈī������ ó�� �����ϽŴٸ� 3ä��(�ʺ�����) ������ ��õ" ), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(4876, "�� �帳�ϴ�. 3ä�ο� �ִ� '�ʺ� ������'�� ���� ����ġ/���õ�" ),
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(4877, "2��, ����/���� ���ݷ��� 20% ���Ǵ� '�ʺ����� ����'�� ����"), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(4878, "�� �� �ֽ��ϴ�. '�ʺ����� ����'�� ���� 60������ �����˴ϴ�."), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
#else
	pDrawPort->PutTextEx( _S(2618, "����õ ������?" ),
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFAAFFFF );
	tv_y+=20;
	pDrawPort->PutTextEx( _S(2619, "���� ������ ��ü�� �Ǹ�, �ش� �������� �÷��̸� �ϸ� 30����" ), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(2620, "������ ĳ���ʹ� ��ɽ� �ź��� ȿ���� �ִ� ���� �������� ����" ),
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(2621, "�� ������, ��� ������ ���ؼ� 1�ð� �������� ��÷�� ���Ͽ� "), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
	tv_y+=15;
	pDrawPort->PutTextEx( _S(2622, "������ 10���� �帮�� �̺�Ʈ �Դϴ�."), 
					m_nPosX + SELECTSERVER_TITLE_TEXT_OFFSETX, tv_y , 0xFFFFFFFF );
#endif
	// ----------------------------------------------------------------<<
...
//#ifdef AUTO_LOGIN
					...
					if(g_bAutoLogin)
					{
						...
						CUIManager::getSingleton()->SetUIGameState( eSTAGE_NONE );
					}
...
//#endif
	...
	// SERVER LIST �� ���� ���� ��û [20/05/2011 rumist]
#if defined G_KOR
...
void CUISelectServer::Close()
{
	...
	CUIManager::getSingleton()->SetUIGameState( eSTAGE_LOGIN );
}
...
void CUISelectServer::ConnectToServer(CTString strIP, ULONG ulPortNum)
{
	...
	if(_tcpip.Socket == INVALID_SOCKET)
	{
		...
		MsgBoxInfo.SetMsgBoxInfo( _S( 424, "���� ����" ), UMBS_OK, UI_SEL_SERVER, MSGCMD_CONNECT_ERROR );
...
void CUISelectServer::SetRecentServer( int iRecentGroup, int iRecentServer )
{
	...
	else	// [090611: selo] ������ ó�� �����ϴ� �����̸� default ���� �����Ѵ�.
	{
...
void CUISelectServer::SetServerList()
{
	...
	for( int iServer = 0; iServer < m_vectorGroupInfo[iCurSelGroup].vectorServerInfo.size(); iServer++ )
	{
		...
		case 2:
			{
				strServer = CTString("(PvP / Raid / Newbie)");
			}
			break;
		case 3:
			{
		...
		{
			m_lbServer.AddString( 1, _S( 372, "����" ), 0x9400D6FF );
		}
		...
		{
			m_lbServer.AddString( 1, _S( 374, "ȥ��" ), 0xFF9533FF );
		}
		else
		{
			m_lbServer.AddString( 1, _S( 371, "��Ȱ" ), 0xCCCCCCFF );
		}
	}
...
CTString CUISelectServer::GetServerGroupName( int iGroupNo )
{
	...
	if ( g_iCountry != CHINA )  // �߱� Local�� �ƴϸ� ������ ���� ��ƾ~
		return m_astrServerName[iGroupNo];

	if( !_cmiComm.Is2rdLocal() ) // 2��° ������ �ƴϰų�
	{
		return m_astrServerName[iGroupNo];
	}
...
// Explain:  ���ӷ�Ʈ���� rsvr.txt ȭ���� ã��, �ش� ������ �о�ͼ� �����Ѵ�.
// ��õ ���� �̺�Ʈ�� ���� �ӽ� ó��..
