...
CUITargetInfo::CUITargetInfo()
{
	...
	m_colNameColor[12] = 0x00FF00FF;	// [2010/10/20 : Sora] ���� �뺴 ī��
...
// �Ӽ� �ý��� [1/17/2013 Ranma]
	...
	m_rsSyndicateMark.AddRectSurface(UIRect(0, 0, DEF_SYNDICATE_MARK_SIZE,DEF_SYNDICATE_MARK_SIZE),
		UIRectUV(992, 2, 1022, 32, fTexWidth, fTexHeight));	// �÷θ� ����.
}
...
void CUITargetInfo::SetTargetSyndicateTooltip()
{
	...
	m_strSyndicateType = _S(6167, "�Ҽ�:") + strSyndicateType;
	...
	{
		m_strSyndicateGrade = _S(6168, "����:") + strSyndicateGrade;
...
void CUITargetInfo::SetTargetAttrTooltip(UBYTE ubAttr, UBYTE ubAttrLv, int nStringID)
{
	...
	m_nCurInfoLines = 1;
	m_strInfo[0].PrintF( _S( nStringID, "���� or ��� : [%s]�Ӽ� [%d]�ܰ�"), strAtt, ubAttrLv);
	m_colInfo[0] = 0xFFFFFFFF;
	m_bShowInfo = TRUE;				
}
