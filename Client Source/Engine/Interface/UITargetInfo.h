...
#define	TARGETINFO_WIDTH				197		// [2010/09/08 : Sora] 75 + 67 + 55 = 197��
...
protected:
	// Information
#ifdef NEW_CHAO_SYS
	COLOR				m_colNameColor[28];				// Colors of target name
#else
	...
	UBYTE				m_ubAttIdx; // ���� ���ݼӼ� �ε���
	UBYTE				m_ubAttLv; // ���� ���ݼӼ� ����
	UBYTE				m_ubDefIdx; // ���� ���Ӽ� �ε���
	UBYTE				m_ubDefLv; // ���� ���ݼӼ� ����

	CTextureData*		m_ptdAttributeTexture;// �Ӽ� �ý���
