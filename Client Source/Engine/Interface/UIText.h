...
public:
	...
	void	setFonrColorMove(COLOR col) { m_color_move = col; }
	...
	void	setItemToolTip(CItems* item) { m_bItemToolTip = item; }
	CItems* getItemToolTip() { return m_bItemToolTip; }
