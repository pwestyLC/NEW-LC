...
#ifdef CHAR_EX_ROGUE
	#define PLAYER_EX_ROGUE	("Data\\character\\ROGUE\\ro.smc")	// [2012/08/27 : Sora] EX�α� �߰�
#endif
#ifdef CHAR_EX_MAGE
	#define PLAYER_EX_MAGE ("Data\\character\\mage\\ma.smc") // 2013/01/08 jeil EX������ �߰� 
#endif
// ----------------------------------------------------------------------------
// Name : CJobInfo()
// Desc :
...
m_pJobInfo( NULL )
{
	...
	m_pJobInfo[TITAN].aStrAnimationName[ANIM_SIT]			= "ti_sit_01";	// �ɱ�.
	m_pJobInfo[TITAN].aStrAnimationName[ANIM_SIT_CONTINUE]	= "ti_sit_02";	// �ɾ� �ִ� ����.
	m_pJobInfo[TITAN].aStrAnimationName[ANIM_STANDUP]		= "ti_sit_03";	// �Ͼ��.
	...
	m_pJobInfo[TITAN].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_BIGSWORD;		// ��ų ��� ���� ���� Ÿ��
	...
	m_pJobInfo[KNIGHT].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_KNIFE;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[KNIGHT].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_TWOSWORD;
	//-------------------------------------------------------
	m_pJobInfo[HEALER].strName					= "����";
	...
	m_pJobInfo[HEALER].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_BOW;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[HEALER].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_WAND;
	//-------------------------------------------------------
	m_pJobInfo[MAGE].strName					= "������";
	...
	m_pJobInfo[MAGE].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_SSTAFF;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[MAGE].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_STAFF;
	//-------------------------------------------------------
	m_pJobInfo[ROGUE].strName					= "�α�";
	...
	m_pJobInfo[ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_SIT_CONTINUE]	= "pet_dragon03_skill01";			// ��� �ɾ� �ֱ�.
	...
	m_pJobInfo[ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_SIT]	= "pet_dragon03_skill01_1";		// �������� �ϱ�
	m_pJobInfo[ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_STANDUP]	= "pet_dragon03_skill01_2";		// ���������� �ϱ�
	...
	m_pJobInfo[ROGUE].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_DAGGER;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[ROGUE].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_CROSSBOW;
	//-------------------------------------------------------		
	m_pJobInfo[SORCERER].strName					= "�Ҽ���";
	m_pJobInfo[SORCERER].strFileName				= PLAYER_SORCERER;

	// FIXME : �ִϸ��̼� �̸��� ������ ����???
	// FIXME : ���� ��Ģ�� ���� �� �����ֱ� ������ �̸��� �� ������~-_-;;;
	// FIXME : ��ȯ���� ���� ������!!! �ݵ�� SkaStudio���� Ȯ���ϰ�, ���ӿ��� �ѹ� �� Ȯ���Ұ�-_-;;;
	...
	m_pJobInfo[SORCERER].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_POLEARM;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[SORCERER].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_SCYTHE;

	m_pJobInfo[NIGHTSHADOW].strName					= "����Ʈ ������";
	m_pJobInfo[NIGHTSHADOW].strFileName				= PLAYER_NIGHTSHADOW;

	// FIXME : �ִϸ��̼� �̸��� ������ ����???
	// FIXME : ���� ��Ģ�� ���� �� �����ֱ� ������ �̸��� �� ������~-_-;;;
	// FIXME : ��ȯ���� ���� ������!!! �ݵ�� SkaStudio���� Ȯ���ϰ�, ���ӿ��� �ѹ� �� Ȯ���Ұ�-_-;;;
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_WALK_1]			= "ns_walk_00";	// ���Ⱑ ������
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_WALK_2]			= "ns_walk_01";	// ���Ⱑ ������
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_IDLE]			= "ns_ready_00";	
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RUN_1]			= "ns_run_00";	// ���Ⱑ ������
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RUN_2]			= "ns_run_01";		// ���Ⱑ ������
	...
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_0]		= "ns_so01_00";	// �λ�
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_1]		= "ns_so02_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_2]		= "ns_so03_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_3]		= "ns_so04_00";	// �ְ�
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_4]		= "ns_so05_00";	// �ڼ�
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_5]		= "ns_so06_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_6]		= "ns_so07_00";	// ���ڶ�
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_7]		= "ns_so08_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_8]		= "ns_so09_00";	// ȯȣ
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_9]		= "ns_so10_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_10]		= "ns_so11_00";	// ����
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_SOCIAL_11]		= "ns_water"; // ���� �̰�?
	...
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_WALK_1]	= "pet_horse3_walk";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_IDLE_1]	= "pet_horse3_idle_01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_IDLE_2]	= "pet_horse3_idle_01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_RUN_1]	= "pet_horse3_run";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_PICK]		= "pet_horse3_idle_01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_DAMAGE]	= "pet_horse3_dam";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_DIE]		= "pet_horse3_die";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_LEVELUP]	= "pet_horse3_lvup";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SIT_CONTINUE]	= "pet_horse3_skill01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SKILL_1]	= "pet_horse3_skill02";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SKILL_2]	= "pet_horse3_skill03";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SKILL_3]	= "pet_horse3_skill03";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SKILL_4]	= "pet_horse3_skill04";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_SIT]	= "pet_horse3_skill01_1";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_HORSE_STANDUP]	= "pet_horse3_skill01_2";

	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_WALK_1]	= "pet_dragon03_walk";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_IDLE_1]	= "pet_dragon03_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_IDLE_2]	= "pet_dragon03_idle02";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_RUN_1]	= "pet_dragon03_run";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_PICK]		= "pet_dragon03_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_DAMAGE]	= "pet_dragon03_dam";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_DIE]		= "pet_dragon03_die";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_LEVELUP]	= "pet_dragon03_lvup";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SIT_CONTINUE]	= "pet_dragon03_skill01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SKILL_1]	= "pet_dragon03_skill02";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SKILL_2]	= "pet_dragon03_skill03";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SKILL_3]	= "pet_dragon03_skill03";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SKILL_4]	= "pet_dragon03_skill04";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_SIT]	= "pet_dragon03_skill01_1";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DRAGON_STANDUP]	= "pet_dragon03_skill01_2";

	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_WALK_1]	= "pet_demonbat_walk";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_IDLE_1]	= "pet_demonbat_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_IDLE_2]	= "pet_demonbat_idle02";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_RUN_1]		= "pet_demonbat_run";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_PICK]		= "pet_demonbat_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_DAMAGE]	= "pet_demonbat_dam";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_DIE]		= "pet_demonbat_die";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_LEVELUP]	= "pet_demonbat_hungry";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SIT_CONTINUE]	= "pet_demonbat_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SKILL_1]	= "pet_demonbat_skill01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SKILL_2]	= "pet_demonbat_skill02";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SKILL_3]	= "pet_demonbat_skill03";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SKILL_4]	= "pet_demonbat_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_SIT]	= "pet_demonbat_idle01";
	m_pJobInfo[NIGHTSHADOW].aStrAnimationName[ANIM_RIDE_DEMONBAT_STANDUP]	= "pet_demonbat_idle01";
	...
	m_pJobInfo[NIGHTSHADOW].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_SOUL;		// ��ų ��� ���� ���� Ÿ��
	...
	m_pJobInfo[EX_ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_SIT_CONTINUE]	= "pet_dragon03_skill01";			// ��� �ɾ� �ֱ�.
	...
	m_pJobInfo[EX_ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_SIT]	= "pet_dragon03_skill01_1";		// �������� �ϱ�
	m_pJobInfo[EX_ROGUE].aStrAnimationName[ANIM_RIDE_DRAGON_STANDUP]	= "pet_dragon03_skill01_2";		// ���������� �ϱ�
	...
	m_pJobInfo[EX_ROGUE].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_DAGGER;		// ��ų ��� ���� ���� Ÿ��
	m_pJobInfo[EX_ROGUE].iSkillWeaponType[1]			= CItemData::ITEM_WEAPON_CROSSBOW;
	//-------------------------------------------------------		
#endif
#ifdef CHAR_EX_MAGE	//2013/01/08 jeil �ӽ÷� �ϴ� �������� �����ؼ� �߰� ���߿� ���ҽ� ������ ���� �ʿ�
					//2013/01/10 jeil EX������ �߰� �߰��� �ִϸ��̼� ������ ���� ������ ���� �������� ���� 
	...
	m_pJobInfo[EX_MAGE].iSkillWeaponType[0]			= CItemData::ITEM_WEAPON_SSTAFF;		// ��ų ��� ���� ���� Ÿ��
