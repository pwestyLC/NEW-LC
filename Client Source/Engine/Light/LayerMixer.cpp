...
#if (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (!defined ENABLE_X86_ASM) || (defined(__x86_64__) && defined(__GNUC__)) || (defined(PLATFORM_64BIT) && defined(_MSC_VER)) \
  && !PLATFORM_NOT_X86
#include <xmmintrin.h>
#endif
...
#elif (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT) && (!defined ENABLE_X86_ASM) || (defined(__x86_64__) && defined(__GNUC__)) || (defined(PLATFORM_64BIT) && defined(_MSC_VER)) \
  && !PLATFORM_NOT_X86
  // prepare color
  __m64 tmp_mm7;
...
void CLayerMixer::MixOneMipmap(CBrushShadowMap *pbsm, INDEX iMipmap)
{
  ...
  COLOR colAmbient = lm_pbpoPolygon->bpo_pbscSector->bsc_colAmbient;
  if (bDynamicOnly) colAmbient = 0x80808000UL; // overide ambient light color for dynamic lights only
