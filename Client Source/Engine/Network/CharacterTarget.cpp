...
CCharacterTarget::~CCharacterTarget(void) 
{
	...
	cha_itemEffect.DelAccessoryEffect();	// ������ ����Ʈ ��, �Ǽ��縮 ����Ʈ ����
	((CPlayerEntity*)CEntity::GetPlayerEntity(0))->ClearTargetInfo(m_pEntity);
	cha_itemEffect.DeleteNickEffect();	// ȣĪ ����Ʈ ����
	cha_itemEffect.DeletePetStashEffect(); // ��â�� ����Ʈ ����
...
CCharacterTarget::CCharacterTarget(const CCharacterTarget &other)
{
	...
	cha_reborn = other.cha_reborn;
	cha_color_name = other.cha_color_name;

	//Hardcoding, status�� item effect�� vtable�� �߰��ǰų� ����� �Ǵ� ��� ���� ����.
	...
	cha_statusEffect.SetType(CStatusEffect::T_CHARACTER);
	cha_Label = other.cha_Label; // [sora] Ÿ�� ǥ��
	cha_NickType = other.cha_NickType;
#ifdef REZABOT
	cha_botting = other.cha_botting;
#endif
	int i;
...
void CCharacterTarget::SetData( INDEX index, INDEX type, CTString &name, CEntity *pEntity, SBYTE sbyLayer,  UWORD state, SLONG pkstate, INDEX wins, INDEX loses, INDEX reborn, INDEX colorName)
{	
	m_nIdxServer = index;
	m_nType = type;         
	m_strName = name;
