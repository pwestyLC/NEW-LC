...
public:
	...
	// Date : 2005-05-02(���� 10:11:01), By Lee Ki-hwan
	BOOL	m_b2stLocal;				// 2��° �������� Ȯ�� (�߱� Local )
...
//������ ���� �� �ý��� ���콺 �۾�		09.09
	...
	BOOL Is2rdLocal(); // Date : 2005-05-02(���� 10:11:01), By Lee Ki-hwan	// 2��° �������� Ȯ�� (�߱� Local )
	
	void attachCRC(CPacket* packet);

	BOOL GetMAC(char * mac_addr);
	BOOL GetHWID(char* hwid);
