...
public:
	...
	//ULONG_PTR (WINAPI *EmbedBrowserObject)(HWND hwnd); // Browser Object Embed.
	//void (WINAPI *UnEmbedBrowserObject)(HWND hwnd); // Browser Object UnEmbed.
	//ULONG_PTR (WINAPI *DisplayHTMLPage)(HWND hwnd, const char *webPageName); // Page Move
...
typedef HRESULT(WINAPI* PFN_EmbedBrowserObject)(HWND hwnd);
typedef HRESULT(WINAPI* PFN_UnEmbedBrowserObject)(HWND hwnd);
typedef HRESULT(WINAPI* PFN_DisplayHTMLPage)(HWND hwnd, const char* webPageName);

extern PFN_EmbedBrowserObject EmbedBrowserObject;
extern PFN_UnEmbedBrowserObject UnEmbedBrowserObject;
extern PFN_DisplayHTMLPage DisplayHTMLPage;
