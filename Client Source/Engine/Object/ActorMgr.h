...
#include <Common/CommonDef.h> //new2022
struct ObjectBase;
class CMobTarget;
...
public:
	...
	int GetObjectCount(eOBJ_TYPE eType); //REZABOT
	...
	ObjectBase* GetXObjectByDistance(FLOAT3D vPos,int X);
