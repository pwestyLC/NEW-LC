...
m_pPetInfo( NULL )
{
	...
	m_pPetInfo[HORSE_CHILD].aStrAnimationName[PET_ANIM_SKILL_0]		= "Pet_Horse01_skill01";	// ���� ����
	m_pPetInfo[HORSE_CHILD].aStrAnimationName[PET_ANIM_SKILL_1]		= "Pet_Horse01_skill02";	// �޹߱�
	m_pPetInfo[HORSE_CHILD].aStrAnimationName[PET_ANIM_SKILL_2]		= "Pet_Horse01_skill03";	// �� ����.
	...
	m_pPetInfo[HORSE_CHILD].aStrAnimationName[PET_ANIM_SKILL_0_01]		= "Pet_Horse01_skill01_01";	// ���� ����
	m_pPetInfo[HORSE_CHILD].aStrAnimationName[PET_ANIM_SKILL_0_02]		= "Pet_Horse01_skill01_02";	// ���� ����
	m_pPetInfo[HORSE_CHILD].bRide									= FALSE;
	m_pPetInfo[HORSE_CHILD].fWalkSpeed								= 5.0f;
	m_pPetInfo[HORSE_CHILD].fRunSpeed								= 15.0f;
	...
	m_pPetInfo[HORSE_BOY].aStrAnimationName[PET_ANIM_SKILL_0]		= "Pet_Horse02_skill01";	// ���� ����
	m_pPetInfo[HORSE_BOY].aStrAnimationName[PET_ANIM_SKILL_1]		= "Pet_Horse02_skill02";	// �޹߱�
	m_pPetInfo[HORSE_BOY].aStrAnimationName[PET_ANIM_SKILL_2]		= "Pet_Horse02_skill03";	// �� ����.
	...
	m_pPetInfo[HORSE_BOY].aStrAnimationName[PET_ANIM_SKILL_0_01]		= "Pet_Horse02_skill01_01";	// ���� ����
	m_pPetInfo[HORSE_BOY].aStrAnimationName[PET_ANIM_SKILL_0_02]		= "Pet_Horse02_skill01_02";	// ���� ����
	m_pPetInfo[HORSE_BOY].bRide										= FALSE;
	m_pPetInfo[HORSE_BOY].fWalkSpeed								= 5.0f;
	m_pPetInfo[HORSE_BOY].fRunSpeed									= 15.0f;
	...
	m_pPetInfo[HORSE_ADULT].aStrAnimationName[PET_ANIM_SKILL_0]		= "Pet_Horse3_skill01";	// �ɱ�
	...
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_0]	= "Pet_Dragon01_skill01";	// �ξ�
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_1]	= "Pet_Dragon01_skill02";	// ������
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_2]	= "Pet_Dragon01_skill03";	// �ֱ�
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_3]	= "Pet_Dragon01_skill04";	// ����
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_4]	= "Pet_Dragon01_skill05";	// �һձ�
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_0_01]	= "Pet_Dragon01_skill01_01";	// �ξ�
	m_pPetInfo[DRAGON_CHILD].aStrAnimationName[PET_ANIM_SKILL_0_02]	= "Pet_Dragon01_skill01_02";	// �ξ�
	...
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_0]		= "Pet_Dragon02_skill01";	// �ξ�
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_1]		= "Pet_Dragon02_skill02";	// ������
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_2]		= "Pet_Dragon02_skill03";	// �ֱ�
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_3]		= "Pet_Dragon02_skill04";	// ����
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_4]		= "Pet_Dragon02_skill05";	// �һձ�
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_0_01]		= "Pet_Dragon02_skill01_01";	// �ξ�
	m_pPetInfo[DRAGON_BOY].aStrAnimationName[PET_ANIM_SKILL_0_02]		= "Pet_Dragon02_skill01_02";	// �ξ�
	...
	m_pPetInfo[DRAGON_ADULT].aStrAnimationName[PET_ANIM_SKILL_0]	= "Pet_Dragon03_skill01";	// �ɱ�
