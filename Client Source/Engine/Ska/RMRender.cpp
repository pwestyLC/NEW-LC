...
//������ ���� ����
//__forceinline static void TransformVertex( GFXVertex &v, const Matrix12 &m)		// ����
...
//������ ���� ���� Water ����		04.21
				gfxEnableClipPlane();		// ����.
				// NOTE :  Mirror�� ���ؼ� ClipPlane()�� Enable�� ���,
				// NOTE : ������ �߻���.
				// NOTE : Disable�ص� Mirror�� �̹����� ����� ������ �ʴ� ������ ����.
				// NOTE : ���, ClipPlane�� �����ϴ� �κ��� ������ �ǹǷ�, 
				// NOTE : ClipPlane�� ����ϴ� �κ��� �����ϵ��� �Ұ�.
				// NOTE : ��, �ٸ� �Ѱ��� �������� Ŭ���νÿ� ������Ʈ�� �ٿ�� �ڽ��� ������ �ϴµ�,
				// NOTE : �ݻ� ����� �ٿ�� �ڽ��� �߰��� ���� ��찡 ������ �ȴ�.
				// NOTE : �� ��쿡�� ���� ó���� ����� �ҵ�.
				// NOTE : �ñ�����, �� BSP ����� ��ü�鿡 ���ؼ��� �� ������ �ִ� ���ϱ�?
				// NOTE : ���� ������ �ذ��ϱ� �������� Disable Clip��.
				//gfxDisableClipPlane();
//������ ���� �� Water ����			04.21
				gfxFrontFace( GFX_CW);
			}
...
/*
// NOTE : RenderModelShadow �� CreateShadowMatrix, RenderOneSkaModelToTexture��� �ߺ��Ǵ� �ڵ尡 ����.
// NOTE : �� �����Ӹ��� ����ؾ� �ϴ� �κ�.  ������ ��ġ�� ���� ��ġ, ����� ��ġ���� ����� �� �ִ�.
...
extern void CreateShadowMatrix(CModelInstance *pMI, const CPlacement3D& plModel, Matrix16& matShadowUV, 
							   const Matrix12& matWorldToLight,		// �������� ������ �ٶ�...
							   const Matrix16& matShadowProj,		// �������� ������ ���.
							   const FLOAT fTextureSize, 
							   const CPlacement3D& plViewer)		// ī�޶��� ��ġ.
//������ ���� ��		04.13
{
	gfxSetViewMatrix(NULL);
...
// �Ʒ� �Լ��� Shadow Matrix�� ���ϱ� ���ؼ��� ����ؾ� �մϴ�.
// NOTE : ���߿� CPerspectiveProjection3D���� ���� ������İ��� �������� ó���Ұ�.
extern void GetViewMatrix(const CPlacement3D &plEye, Matrix12& matAbsToEye)
{
	// Eye���� Abs�� �ٶ󺸵��� ����.
	CPerspectiveProjection3D prEyeToAbs;	// Eye -> World	

	// �Ʒ��κ��� ���� View Matrix�� ��� ���� �κ��Դϴ�
	// NOTE : �Ʒ��κп��� ViewerPlacement�� �����ϰ�� ���� ����Ʈ ���̹Ƿ� �������� �ʿ䰡 ������ ���⵵ �ϱ�...
...
extern void FindBestFOV(const FLOATaabbox3D& aabbBox, const Matrix12& matLocalToLight, FLOAT& fX, FLOAT& fY)
{
	...
	float fXMax = 0.0f;		//�ִ밪�� ���Ұ��̹Ƿ� 0���� �����ϸ� �ȴ�.
	float fYMax = 0.0f;
	FLOAT3D vOut;
...
void SetSkaTagInfo(CSkaTag *ptrTag, INDEX ctrb, RenModel &rm, MeshLOD &mlod)
{
	...
	else
	{
		...
		default: ASSERTALWAYS("����� ������ �ȵ�. ���� ���� �̻�"); break;
		}
	}
}
...
//������ ���� ����	//(Effect Add & Modify for Close Beta)(0.1)
					...
					if(iNextAnimFrame>=ctAnimFrames)	//���� ani��ġ�� �ѹ� wrap�� ������.
					{
...
//������ ���� ��
		...
		MeshVertex *pavFinalVertices;
		MeshNormal *panFinalNormals;
//������ ���� ����	//(Add Tagent-space Normal Map)(0.2)
...
#pragma message(">> Uncomment & optimize callback function params transfer")
			...
			*/
			...
			extern CRenderTexture*	re_prtReflection;		// Reflection���� ����� �ؽ���.
			if((RM_GetFlags() & RMF_SHOWNICEWATER) && re_prtReflection && _bUseHardwareShaders)
			{
				_patoTextures.Push(3);			// �ؽ��� 3��.
...
//������ ���� ���� Water ����		04.21
				//_patoTextures[1] = &_pWaterInformation->m_texBump2;		// Bump	Texture(�̻��)
//������ ���� �� Water ����			04.21
...
//������ ���� ��	//(Add Tagent-space Normal Map)(0.1)
			...
			if(bBlendVertices) 
			{
				...
				{
					// Set vertex weights
					shaSetWeightBufferID(mlod.mlod_iWeightBufferID, iFirstVertex, ctVertices);
...
//������ ���� ����	//(Add Sun Moon Entity and etc)(0.1)
			//���� ����, RenderMesh�� colCurrent��� �κп��� mi_colModelColor�� �ι� ������.
			//COLOR colCurrent = MulColors( _colModel, rm.rm_pmiModel->mi_colModelColor);//����
...
//������ ���� ��	//(Add Sun Moon Entity and etc)(0.1)
			...
			if((RM_GetFlags() & RMF_SHOWNICEWATER) && re_prtReflection && _bUseHardwareShaders)
			{					
				shaSetSurfaceTextures(&_patoTextures[0], 3);		// ����.
			}
			else
			{			
				if(ctTextures>0) 
...
void RM_RenderSKA( CModelInstance &mi, BOOL bRenderToScreen )
{
	...
	const ULONG ulQueryID = _ulDrawPortID ^ ((ULONG64)&mi);
...
//������ ���� ����	//(Add & Modify SSSE Effect)(0.1)
	...
	//static value = FALSE;
	//ska_bShowSkaTag = value;		//�ӽ÷� ���� �κ�, �����δ� SkaStudio������ TRUE�� ���� ������.
