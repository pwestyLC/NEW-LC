...
#else
  memset(pswMixerBuffer, 0, slMixerBufferSize * 8/2);
#endif
}
...
#else
  memcpy((void*)pDstBuffer, ((const char *)pswMixerBuffer) + slSrcOffset, slBytes);
#endif
}
...
loopEnd:
  ...
  SWORD *pslDstBuffer = (SWORD*)pswMixerBuffer;
...
loopEnd:
 ...
 // initialize some local vars
  SLONG slLeftSample, slRightSample, slNextSample;
  SWORD *pslDstBuffer = pswMixerBuffer;
  fixLeftOfs   = (__int64)(fLeftOfs   * 65536.0);
  fixRightOfs  = (__int64)(fRightOfs  * 65536.0);
  __int64 fixLeftStep  = (__int64)(fLeftStep  * 65536.0);
  __int64 fixRightStep = (__int64)(fRightStep * 65536.0);
