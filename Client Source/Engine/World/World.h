...
#include <Engine/Entities/MissionCase.h> // ttos : �̼� ���̽�
#include <Engine/Entities/WildPetData.h>	// ttos_080725: �ű� �� ������
...
#define MAX_ZONE_COUNT	60  //pwesty max zone
...
extern ENGINE_API BOOL g_bFirstIntoWorld; // �̱�ȯ �߰� ( 12. 10 )
...
class ENGINE_API CZoneInfo : public CSingletonBase<CZoneInfo>
{
	typedef struct _tagZoneInfo
	{
		...
		DWORD		dwAccessJob;		// ���� ���� ����.
		eZone		eZoneType;			// ���� ����.
		//UINT		uiTotalEnemies;		// �� ���� ��ü ���ʹ� ��(�̱� ���������� ����)
		BOOL		bRaidDungeon;		// ���̵� �����ΰ���?
				
		CTString	strZoneName;		// ���̸� �ѱ� 8��, ���� 16�� ����
		CTString	strZoneWldFile;		// ���� ȭ�ϸ�.
...
//������ ���� ���� �ý��� �̱۴��� ����	10.07
	std::vector<CEntity *> m_vectorTargetNPC;			// �÷��̾�ܿ� Ÿ���� �Ǵ� NPC��.
...
//������ ���� �� �̱۴��� ����		10.07
	...
	bool _bPendingEffectInit = false;
	BOOL _bLoadingEffectData = false;
	...
	void LoadStringNPCName();		// ������ �о�� ��.
	void loadTradeItem();			// Ÿ�̸� �̺�Ʈ.
private:
	void loadMob();
	void loadShop();
	void loadSkill();
	...
	void LoadCraft(); //Craft system
#ifdef PASSIVE_SYSTEM
	void LoadPassiveSystem();
#endif
	void LoadStringItem();
