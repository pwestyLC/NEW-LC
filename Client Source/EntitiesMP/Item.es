...
properties:
 ...
 41 INDEX m_itemGrade = 0,                    // item rarity grade for loot filter colors
 ...
 ************************************************************/
  ...
  // Get color based on item grade for rarity display
  COLOR GetGradeColor()
  {
    unsigned char r = 255, g = 255, b = 255;  // Default white

    if (m_itemGrade == 0) {  // Rare/Blue (RareOptionEditor grade 0)
      r = 0; g = 165; b = 255;   // Blue
    } else if (m_itemGrade == 1) {   // Rare/Green (RareOptionEditor grade 1)
      r = 0; g = 255; b = 0;     // Green
    } else if (m_itemGrade == 2) {   // Rare/Yellow (RareOptionEditor grade 2)
      r = 255; g = 215; b = 0;   // Yellow
    } else if (m_itemGrade == 3) {   // Rare/White Bonus (RareOptionEditor grade 3)
      r = 0; g = 255; b = 255;   // Cyan (White bonus)
    } else if (m_itemGrade == 4) {   // Rare/White (RareOptionEditor grade 4)
      r = 255; g = 255; b = 255; // White
    } else if (m_itemGrade == 5) {   // Rare/Magic tier 6 (Orange-Red)
      r = 255; g = 100; b = 0;
    } else if (m_itemGrade == 6) {   // Origin (Gold)
      r = 255; g = 215; b = 0;
    } else if (m_itemGrade == 7) {   // Not Open (Teal)
      r = 0; g = 128; b = 128;
    }

    return RGBToColor(r, g, b) | CT_OPAQUE;
  };
