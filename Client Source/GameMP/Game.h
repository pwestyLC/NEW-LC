...
//강동민 수정 시작 클로즈 준비 작업	08.10
	virtual void GameRedrawView( CDrawPort *pdpDrawport, ULONG64 ulFlags, CEntity* pViewer = NULL );
//강동민 수정 끝 클로즈 준비 작업		08.10
...
//강동민 수정 끝 클로즈 준비 작업		08.10
	...
	virtual void GameRedrawCursor(CDrawPort *pdpDrawPort, ULONG64 ulFlags);
