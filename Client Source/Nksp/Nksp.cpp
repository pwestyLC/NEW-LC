...
//extern BOOL _bDefiningKey;		// ï¿½ï¿½ï¿½ï¿½.
...
static INDEX sam_bPauseOnMinimize = FALSE; // auto-pause when window has been minimized
...
/***********************************************************************************************
* IsRunning()
* ï¿½ßºï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ô¼ï¿½
* ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Î¼ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ë»ï¿½ï¿½Ï¿ï¿½ Nksp.exeï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½Ç¾ï¿½ ï¿½Ö´ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ö´ï¿½ï¿½ï¿½ È®ï¿½ï¿½ï¿½Ï¿ï¿½ TRUE, FALSEï¿½ï¿½
* ï¿½ï¿½ï¿½ï¿½ ï¿½Ñ´ï¿½.
*************************************************************************************************/
BOOL IsRunning(void)
{
	...
	// ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Î¼ï¿½ï¿½ï¿½ ï¿½Úµï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ñ´ï¿½.
	HANDLE hSnapShot = CreateToolhelp32Snapshot(TH32CS_SNAPPROCESS, 0);

	if (hSnapShot == INVALID_HANDLE_VALUE)
	{
		if (g_iCountry == RUSSIA)
			MessageBox(NULL, "ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ LastChaos!", "LastChaos Run", MB_OK);
		else
	...
	Process32First(hSnapShot, &peNext); // Ã¹ï¿½ï¿½Â° ï¿½ï¿½ï¿½Î¼ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Â´ï¿½.

	while (Process32Next(hSnapShot, &peNext)) // ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Î¼ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ë»ï¿½ï¿½Ñ´ï¿½.
	{
...
//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½	//(DevPartner Bug Fix)(2005-01-14)
HMODULE g_hGame = NULL;
//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½	//(DevPartner Bug Fix)(2005-01-14)
...
//#endif
	...
	// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ init [3/2/2011 rumist]
...
BOOL Init(HINSTANCE hInstance, int nCmdShow, CTString strCmdLine)
{
	...
	{
		// WSS_NPROTECT 070405 ------------------>><<	
		// È«ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ nProtectï¿½ï¿½ ï¿½ßºï¿½ ï¿½ï¿½ï¿½ï¿½
//#ifdef NO_GAMEGUARD
#ifndef MULTI_CLIENT
		...
		{
			if (g_iCountry == RUSSIA)
				MessageBox(NULL, "ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ LastChaos ï¿½ï¿½?ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½?", "LastChaos", MB_OK);
			else
...
///	if (!CheckMultClient())
	...
	//	ï¿½è¿µÈ¯ : Å¬ï¿½ï¿½ï¿½Ì¾ï¿½Æ®ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½DLL ï¿½ï¿½ï¿½
	_bClientApp = TRUE;
	InitializeGame();
...
GetGfxAPIFromTxt(); // ###
   ...
   if ( sam_iGfxAPI == GAT_VK ){ // ### Vulkan
		StartNewMode( GAT_VK, sam_iDisplayAdapter, sam_iScreenSizeI, sam_iScreenSizeJ,
							(enum DisplayDepth)sam_iDisplayDepth, IsFullScreen( sam_bFullScreenActive), sam_bBorderlessActive );
	}
...
#else
	// FIXME : Engineï¿½ï¿½ Resourceï¿½ï¿½ *.cur È­ï¿½ï¿½ï¿½ï¿½ ï¿½Ö¾ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½, ï¿½Ø´ï¿½ Ä¿ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Ø¼ï¿½ ï¿½Ì·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ Ã³ï¿½ï¿½ï¿½ï¿½.	
...
void End(void)
{
	SaveWindowSizeToTxt();	// Á¾·á ÇÒ¶§ Å¬¶óÀÌ¾ðÆ® »çÀÌÁî ÀúÀå.
	SaveGfxAPISizeToTxt();  // ###
...
void PrintDisplayModeInfo(void)
{
	...
	//pdp->PutText( strRes, slDPWidth*fPosMul, slDPHeight*0.85f, LCDGetColor(C_GREEN|255, "display mode"));		// ï¿½ï¿½ï¿½ï¿½.
...
void DoGame(void)
{
	...
	if (!_pGame->gm_bGameOn) {
		//_gmRunningGameMode = GM_NONE;		// ï¿½ï¿½ï¿½ï¿½.		
	...
	if (_pGameState->GetGameMode() != CGameState::GM_NONE)		// ï¿½ï¿½ï¿½ï¿½.
	{
		_pGame->GameMainLoop();
	...
	// redraw the view  //memory leak fix?
...
// ï¿½ï¿½ï¿½ï¿½ï¿½ Credit ï¿½ï¿½ï¿½ï¿½ï¿½Ö´ï¿½ ï¿½Îºï¿½.
...
/*
#ifndef	MULTI_CLIENT
				if (SE_GetEngineDllRefCnt() > 1  || IsRunning() )// ¸ÖÆ¼ Å¬¶óÀÌ¾ðÆ® ¸·±â. [2/4/2010 rumist]
				{
					SendEventInfo.EventID = -1;
					SendEventInfo.DestProcessID = 0;
					SendEventInfo.ulParameter1 = 0;
...
#ifndef		KALYDO
	{
		// ÇöÀç ½ÇÇàµÈ ÇÁ·Î±×·¥ÀÇ °æ·Î¸¦ ÀúÀåÇÒ º¯¼öÀÌ´Ù.
		char temp_path[MAX_PATH] = {0,};

		// ÇöÀç ½ÇÇàµÈ ÇÁ·Î±×·¥ÀÇ °æ·Î¸¦ ¾ò´Â´Ù.
		GetModuleFileName(NULL, temp_path, sizeof(temp_path));


		// ¹öÀü Á¤º¸¸¦ ¾ò±â À§ÇØ »ç¿ëÇÒ ÇÚµé°ªÀ» ÀúÀåÇÏ´Â º¯¼öÀÌ´Ù.
		DWORD h_version_handle;
		// ¹öÀüÁ¤º¸´Â Ç×¸ñÀ» »ç¿ëÀÚ°¡ Ãß°¡/»èÁ¦ ÇÒ¼ö ÀÖ±â ¶§¹®¿¡ °íÁ¤µÈ Å©±â°¡ ¾Æ´Ï´Ù.
		// µû¶ó¼­ ÇöÀç ÇÁ·Î±×·¥ÀÇ ¹öÀüÁ¤º¸¿¡ ´ëÇÑ Å©±â¸¦ ¾ò¾î¼­ ±× Å©±â¿¡ ¸Â´Â ¸Þ¸ð¸®¸¦ ÇÒ´çÇÏ°í ÀÛ¾÷ÇØ¾ßÇÑ´Ù.
		DWORD version_info_size = GetFileVersionInfoSize(temp_path, &h_version_handle);

		// ¹öÀüÁ¤º¸¸¦ ÀúÀåÇÏ±â À§ÇÑ ½Ã½ºÅÛ ¸Þ¸ð¸®¸¦ »ý¼ºÇÑ´Ù. ( ÇÚµé Çü½ÄÀ¸·Î »ý¼º )
		HANDLE h_memory = GlobalAlloc(GMEM_MOVEABLE, version_info_size); 
		// ÇÚµé Çü½ÄÀÇ ¸Þ¸ð¸®¸¦ »ç¿ëÇÏ±â À§ÇØ¼­ ÇØ´ç ÇÚµé¿¡ Á¢±ÙÇÒ¼ö ÀÖ´Â ÁÖ¼Ò¸¦ ¾ò´Â´Ù.
		LPVOID p_info_memory = GlobalLock(h_memory);

		// ÇöÀç ÇÁ·Î±×·¥ÀÇ ¹öÀü Á¤º¸¸¦ °¡Á®¿Â´Ù.
		GetFileVersionInfo(temp_path, h_version_handle, version_info_size, p_info_memory);


		// ¹öÀü Á¤º¸¿¡ Æ÷ÇÔµÈ °¢ Ç×¸ñº° Á¤º¸ À§Ä¡¸¦ ÀúÀåÇÒ º¯¼öÀÌ´Ù. ÀÌ Æ÷ÀÎÅÍ¿¡ Àü´ÞµÈ ÁÖ¼Ò´Â
		// p_info_memory ÀÇ ³»ºÎ À§Ä¡ÀÌ±â ¶§¹®¿¡ ÇØÁ¦ÇÏ¸é ¾ÈµË´Ï´Ù.
		// ( p_info_memory ¸¦ ÂüÁ¶ÇÏ´Â Çü½ÄÀÇ Æ÷ÀÎÅÍ ÀÔ´Ï´Ù. )
		char *p_data = NULL;
		// ½ÇÁ¦·Î ÀÐÀº Á¤º¸ÀÇ Å©±â¸¦ ÀúÀåÇÒ º¯¼öÀÌ´Ù.
		UINT data_size = 0;

		// ¹öÀüÁ¤º¸¿¡ Æ÷ÇÔµÈ FileVersion Á¤º¸¸¦ ¾ò¾î¼­ Ãâ·ÂÇÑ´Ù.
		...
		// ¹öÀü Á¤º¸¸¦ ÀúÀåÇÏ±â À§ÇØ »ç¿ëÇß´ø ¸Þ¸ð¸®¸¦ ÇØÁ¦ÇÑ´Ù.
...
//#define AUTO_LOGIN
	...
	// ï¿½Ì±ï¿½È¯ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ (11. 15) : IME ï¿½ï¿½ï¿½ï¿½ Ã¢ ï¿½ï¿½ï¿½ï¿½ 
...
//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½	//(5th Closed beta)(0.2)
	...
	while (_pGameState->Running() && _fnmModToLoad == "")
	{
		...
		while (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE))
		{
			...
			// UI message
			SE_Get_UIManagerPtr()->MsgProc(&msg, &_bIMEProc);	// yjpark // ï¿½Ì±ï¿½È¯ ï¿½ï¿½ï¿½ï¿½ 11.12 : IME Ã³ï¿½ï¿½ ï¿½ß°ï¿½
			...
			if (bConsoleKey && !_bDefiningKey)
			{
				...
				// ï¿½Ü¼ï¿½Ã¢ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ò¶ï¿½...
				// ï¿½ï¿½, ï¿½Ü¼ï¿½Ã¢ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Â¿ï¿½ï¿½ï¿½....
		...
		if (!bForDebug)
		{
			if (g_fFramePerSecond == FLT_MAX || (tmNow - tmPrev) >= 1.0f)	//1ï¿½Ê¿ï¿½ ï¿½Ñ¹ï¿½ Ã³ï¿½ï¿½.
			{
...
//	_CrtSetBreakAlloc(106262);
	...
	{
		if (GetSystemDefaultLangID() == 0x0804) // ï¿½ß±ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½
		{
			MessageBox(NULL, "ï¿½ï¿½ï¿½ï¿½È·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ê¡£", "ï¿½ï¿½ï¿½ï¿½", MB_OK);
		}
		else
		{
			// ITS #0005892 : russia ï¿½ï¿½Ã»ï¿½ï¿½ï¿½ï¿½. [1/13/2012 rumist]
			if (g_iCountry == RUSSIA)
				MessageBoxW(NULL, L"ï¿½ï¿½ï¿½Ö¬ï¿½Ö¬Ù¬Ñ¬ï¿½ï¿½ï¿½ï¿½Ú¬ï¿½ï¿½ ï¿½Ú¬Ô¬ï¿½ï¿½.", L"ï¿½ï¿½ï¿½Ò¬ß¬ï¿½Ó¬Ý¬Ö¬ß¬Ú¬ï¿½ ï¿½Ù¬Ñ¬Ó¬Ö¬ï¿½ï¿½Ö¬ß¬ï¿½", MB_OK);
			else
													...
													enum DisplayDepth eColorDepth, BOOL bFullScreenMode, BOOL bBorderLessMode,bool bCenter)
{
	...
	BOOL bSuccess;
 //	ï¿½è¿µÈ¯ : ï¿½Ô¼ï¿½ ï¿½Ä¶ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½.
	if (eGfxAPI == GAT_D3D || eGfxAPI == GAT_VK) OpenMainWindowNormal(pixSizeI, pixSizeJ, bCenter);
	bSuccess = _pGfx->ResetDisplayMode(eGfxAPI);
	if (bSuccess && eGfxAPI == GAT_OGL) OpenMainWindowNormal(pixSizeI, pixSizeJ);
	//	ï¿½è¿µÈ¯ : ï¿½ï¿½ï¿½ï¿½ OpenMainWindowNormal() Ã³ï¿½ï¿½ï¿½ï¿½.
	...
	if (bSuccess) {
		...
		if (_pdpMain != NULL && _pdpMain->Lock())
		{
			//pdp->Fill( LCDGetColor( C_dGREEN|CT_OPAQUE, "bcg fill"));		// ï¿½ï¿½ï¿½ï¿½.
			_pdpMain->Fill(C_BLACK | CT_OPAQUE);				// maybe ï¿½ï¿½ï¿½ï¿½
			_pdpMain->Unlock();
			_pvpViewPortMain->SwapBuffers();
			bSuccess = TRUE;
		}
...
//	ï¿½è¿µÈ¯ : ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ Å©ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½
