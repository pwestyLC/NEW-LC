...
//강동민 수정 시작 테스트 클라이언트 작업	06.27
			...
			// Get Stage State
			hr = _pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_ALPHAARG1, &dwAlphaArg);
			hr = _pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_ALPHAOP,	&dwAlphaOP);
			hr = _pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLORARG1, &dwColorArg);
			hr = _pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLOROP,	&dwColorOp);

			hr = _pGfx->gl_pd3d9Device->SetRenderState( D3DRS_TEXTUREFACTOR, D3DCOLOR_ARGB(128, 15, 15, 15) );
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState( 0, D3DTSS_ALPHAARG1, D3DTA_TFACTOR );
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState( 0, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1 );
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState( 0, D3DTSS_COLORARG1, D3DTA_TFACTOR);
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState( 0, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
...
//강동민 수정 시작 테스트 클라이언트 작업	06.27
			// Restore Stage State
			hr = _pGfx->gl_pd3d9Device->SetRenderState( D3DRS_TEXTUREFACTOR, 0xFFFFFFFF);
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_ALPHAARG1, dwAlphaArg);
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_ALPHAOP,	dwAlphaOP);
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG1, dwColorArg);
			hr = _pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLOROP,	dwColorOp);
//강동민 수정 끝 테스트 클라이언트 작업		06.27
