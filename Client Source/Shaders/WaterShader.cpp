...
//강동민 수정 시작 Water 구현		04.26
	...
	_pGfx->gl_pd3d9Device->SetTextureStageState( 1, D3DTSS_TEXTURETRANSFORMFLAGS, D3DTTFF_PROJECTED );
...
//강동민 수정 끝 접속 시퀀스 작업	05.23
		...
		Render();
		_pGfx->gl_pd3d9Device->SetTextureStageState( 1, D3DTSS_TEXTURETRANSFORMFLAGS, 0);		
		shaDisableBlend();
	}
