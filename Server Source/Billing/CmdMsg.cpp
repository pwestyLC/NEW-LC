...
void CashBalanceRepMsg(CNetMsg& msg, BILL_ERROR_MESSAGE_TYPE errcode, const char* UserName, int userindex, int cpID, int balance, int bonuspoint)
{
	CLCString id(48);
	id.Format("%s", UserName);
...
void CanBuyRepMsg(CNetMsg& msg, BILL_ERROR_MESSAGE_TYPE errcode, int userindex, int cpID, const char* UserName, char count, const int itemID[], int balance, int bonuspoint)
{
	CLCString id(48);
	id.Format("%s", UserName);
...
void BuyRepMsg(CNetMsg& msg, BILL_ERROR_MESSAGE_TYPE errcode, int serial, int userindex, int cpID, const char* UserName, char count, const int itemID[], int balance, int bonuspoint)
{
	CLCString id(48);
	id.Format("%s", UserName);
...
void Pingback(CNetMsg& msg)
{
	msg.Init(MSG_BILLITEM_SERVERLIVE);
	msg << (short)0 << (int)0; 	
}
