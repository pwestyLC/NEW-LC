...
{
#define SAFEDIV(a, b)		{ if ((b) < 1) a /= 1; else a /= (b); }		// a = a / b, b�� 0�̸� 1�� ����
	...
	// �� Ÿ�Ժ� Ȯ�� : �̽�, ����� �����ϰ� ������� [0��ũ 1��Ʈ�� 2�ϵ� 3ũ��Ƽ�� 4���鸮]
	// pc attack ����
...
// 050401 : bs : plus�� ���� �߰� ȿ��
// �� Ÿ�Ժ� Ȯ�� : �̽�, ����� �����ϰ� ������� [��ũ ��Ʈ�� �ϵ� ũ��Ƽ�� ���鸮]
	if (IS_PC(df))
	{
		CPC* pc = TO_PC(df);
		prob_t[0] += pc->m_plusWeak;		// ����� ��ũ ����
	}
	if (IS_PC(of))
	{
		CPC* pc = TO_PC(of);
		prob_t[1] += pc->m_plusStrong;		// ������ ���� ����
		prob_t[2] += pc->m_plusHard;		// ������ �Ű��� ����
		// ũ��Ƽ�� Ȯ�� ����
...
//#endif
	...
	if ((of->m_assist.m_avAddition.hcAttackBerserker || of->m_assist.m_avAddition.hcAttackBerserkerPrem) && IS_PC(of) && IS_NPC(df))	// 10% Ȯ���� 2���� ������
	{
		int rate = GetRandom(1,1000);
		if (of->m_assist.m_avAddition.hcAttackBerserker)
		{
 			if( rate <= 100 )
			{
				ret *= 2;
		...
		if( of->m_assist.m_avAddition.hcAttackBerserkerPrem)
		{
			if( rate <= 150 )
			{
				ret *= 2;
	...
	if( IS_PC(of) )
	{
		...
		{
			CSkill* nocturnal = ns->m_passiveSkillList.Find(870);		// ����Ʈ ������ ���༺
