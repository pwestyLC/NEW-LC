...
//N1InPersonalDungeon : bw
	...
	// ĸ�� ��ȯ ����
	Add(MSG_CASHEXCHANGE, do_CashExchange, 0, false, false);
	...
	Add(MSG_CRAFT, do_CraftSystem, 0, false, false); //Craft system
	...
	Add(MSG_REZA, do_Reza,0,false,false);
	...
	Add(MSG_PRESTIGE, do_Prestige, 0, false, false);
#endif
	...
	Add(MSG_REBORN, do_Reborn, 0, false, false);
	Add(MSG_MAIL_BOX, do_mailBoxSystem, 0, false, false);

	//PASSIVE_SYSTEM
	Add(MSG_PASSIVE_SYSTEM, do_PassiveSystem, 0, false, false); //new 16-08-2022
...
void CCmdList::AddExMessage()
{
	...
	Add(MSG_EX_INVENTORY_OPTION, do_ExInventoryOption, 0, false, false);

	Add(MSG_EX_SETTINGS, do_SaveSettings, 0, false, false);

	Add(MSG_EX_GET_DONATION_TIER_INFO, do_ExGiveDonationTierInfo, 0, false, false);

	Add(MSG_EX_BATTLE_WARFARE_REQ, do_BattleWarfareMove, 0, false, false);
#ifdef CLOUD_AUTO_QUEST_DELIVERY
	Add(MSG_EX_CLOUD_AUTO_QUEST, do_cloud_auto_quest, 0, false, false);//Cloud auto quest
#endif
#ifdef QUICK_PANEL
	Add(MSG_EX_CLOUD_SKILLS_USE, do_Cloud_Usebuff, 0, true, true);
	Add(MSG_EX_CLOUD_SAVE_QUICKPANEL, do_Cloud_SaveItens, 0, true, true);
#endif
	//Add(MSG_EX_PREMIUM, do_ExPremium, 0, false, false);
	Add(MSG_EX_PROMO_KEY, do_ExPromoKey, 0, false, false);
#ifdef PET_BUFF_ALL_SYSTEM
	Add(MSG_EX_PET_USE_ALL_BUFF, do_PetUseAllBuff, 0, false, false);
#endif
}
