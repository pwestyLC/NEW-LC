...
void DisappearAllMsg(CNetMsg::SP& msg);		//�� �ֺ��� �ִ� �͵��� ������
void TargetClearMsg(CNetMsg::SP& msg, int targetIndex);
void StatusMsg(CNetMsg::SP& msg, CPC* ch);
void AtMsg(CNetMsg::SP& msg, CPC* ch);
void AtMsgOffline(CNetMsg::SP& msg, CPC* ch);  // Variant for offline vendors with no descriptor
...
void QuestNPCListMsg(CNetMsg::SP& msg, int total, int* flag, int* index, int npcIndex = 0);
...
void MsgCraftResult(CNetMsg::SP& msg,MSG_Craft_TYPE typeError);  //Craft system
...
//PASSIVE_SYSTEM
void PassiveSystemListMsg(CNetMsg::SP& msg, CPC* ch); //new 16-08-2022
void PassiveSystemSlotListMsg(CNetMsg::SP& msg, CPC* ch); //new 16-08-2022
...
void DungeonTimeNoticeMsg(CNetMsg::SP& msg, MSG_EX_DUNGEONTIME_TYPE type, int start, int end, int exp);	// ����Ÿ��.
...
void SysMsgFlagDead(CNetMsg::SP& msg, CLCString df, int posX, int posZ);
void SysMsgFlagPickup(CNetMsg::SP& msg, CLCString of, int posX, int posZ);
...
void SubHelperUpdateDonationEventStatus(CNetMsg::SP& msg, bool isActive, time_t startTime = 0, time_t endTime = 0);
