...
bool CDropManager::doDropRandom(CPC* _pPC, CNPC* _pNPC , CDropInfo* _pDrop, bool _bPreferenceIndex)
{
	...
	if (_pPC->m_level != -1 && (_pPC->m_level - _pNPC->m_level) <= 5 && (_pPC->m_level - _pNPC->m_level) >= -5)
	{
		int i=0;
