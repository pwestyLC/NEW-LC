...
public:
	InventoryOptions()
	{
		m_options.insert(std::pair<int32_t, bool>(INVENTORY_OPTION_INVENTORY_OPTION, false));
	}
	~InventoryOptions()
	{
		m_options.clear();
	...
	template<typename T>
	void SetOption(int32_t optionId, T value)
	{
		m_options[optionId] = value;
	}
	template<typename T>
	T GetOptionValue(int32_t optionId)
	{
		return boost::any_cast<T>(m_options[optionId]);
	}
private:
	boost::unordered_map<int32_t, boost::any> m_options;
};
//////////////////////////////////////////////////////////////////////////
...
public:
	...
	~InventoryManager();
public:
	InventoryOptions m_inventoryOptions;
