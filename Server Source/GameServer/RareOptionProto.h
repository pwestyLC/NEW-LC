...
public:
	...
	// Return database grade directly (0-4) - no conversion needed
	// Database grades match client grades exactly:
	// 0 = Blue, 1 = Green, 2 = Yellow, 3 = White Bonus, 4 = White
	int GetClientGrade() const
	{
		return m_nGrade;  // Pass through directly
	}
