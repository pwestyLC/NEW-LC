...
typedef struct __tagSyndicateData  //pwesty fix
{
	int syndicateType = 0;
	LONGLONG syndicate_point_k = 0;
	LONGLONG syndicate_point_d = 0;
	int syndicate_join_bit = 0;
	int syndicate_grade_k = 0;
	int syndicate_grade_d = 0;
} SYNDICATE_DATA;
