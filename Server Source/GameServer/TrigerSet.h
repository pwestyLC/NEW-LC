...
public:
	...
	int m_PARTYDG0_IsStarted;
	int m_nNPCDG0_KilledCount;
	int m_nNPCDG0_KilledCount2;
	int m_nBOSS1DG0_Killed;
	int m_nBOSS2DG0_Killed;
	int m_nBOSS1DG0_IsDead;
	int m_nBOSS2DG0_IsDead;

	int m_PARTYDG1_IsStarted;
	int m_nNPCDG1_KilledCount;
	int m_nNPCDG1_KilledCount2;
	int m_nBOSS1DG1_Killed;
	int m_nBOSS2DG1_Killed;
	int m_nBOSS1DG1_IsDead;
	int m_nBOSS2DG1_IsDead;

	int m_PARTYDG2_IsStarted;
	int m_nNPCDG2_KilledCount;
	int m_nNPCDG2_KilledCount2;
	int m_nBOSS1DG2_Killed;
	int m_nBOSS2DG2_Killed;
	int m_nBOSS1DG2_IsDead;
	int m_nBOSS2DG2_IsDead;

	int m_PARTYDG3_IsStarted;
	int m_nNPCDG3_KilledCount;
	int m_nNPCDG3_KilledCount2;
	int m_nBOSS1DG3_Killed;
	int m_nBOSS2DG3_Killed;
	int m_nBOSS1DG3_IsDead;
	int m_nBOSS2DG3_IsDead;

	int m_PARTYDG4_IsStarted;
	int m_nNPCDG4_KilledCount;
	int m_nNPCDG4_KilledCount2;
	int m_nBOSS1DG4_Killed;
	int m_nBOSS2DG4_Killed;
	int m_nBOSS1DG4_IsDead;
	int m_nBOSS2DG4_IsDead;

	long m_PcDeadPenaltyTime;
