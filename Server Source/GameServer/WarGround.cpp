...
CWGPlayer::CWGPlayer(int wartype, int charindex, int leveltype, int select)
{
	...
	m_nSelected = select;		//0:�̺з�, 1:����, 2:Ż��, 3:������
	m_next = NULL;
}
CWGPlayer::~CWGPlayer()
{
...
bool CWGPlayerList::Select()
{
	...
	int allselect[3] = {PLAYER_GREATER_THEN_MAX, }; // 0: 40������ ũ��, 1: 10������ �۴�, 2: 41�� ���� �۴�
	...
	while(temp)
	{
		if(allselect[LEVEL_TYPE_ROOKIE] == PLAYER_SMALLER_THEN_MIN && temp->GetLevelType() == LEVEL_TYPE_ROOKIE)				// 10������ ������
			temp->SetSelected(PLAYER_DRAW);																					// select = draw

		else if(allselect[LEVEL_TYPE_ROOKIE] == PLAYER_BETWEEN_MIN_AND_MAX && temp->GetLevelType() == LEVEL_TYPE_ROOKIE)		// 10~40���̸�
			temp->SetSelected(PLAYER_SELECTED);																				// select = ����

		else if(allselect[LEVEL_TYPE_ROOKIE] == PLAYER_GREATER_THEN_MAX && temp->GetLevelType() == LEVEL_TYPE_ROOKIE)		// 40������ ũ��
			temp->SetSelected(PLAYER_DROP);																					// select = �ϴ� Ż��
...
void CRoyalRumble::CheckRoyalRumble()
{
	...
	if(GetRoyalRumbleTime() == 0)
	{
		...
		//if(!b)
		//	return ;
		if(gserver->m_tRealSystemTime.tm_hour == getStartHour() && gserver->m_tRealSystemTime.tm_min == getStartMinute())
		{
			m_bCondition = true;
		}
			...
			case 4:
				{
					...
					{
						// rookie, senior, master ��� ��Ⱑ draw�Ǿ���. �����ܰ踦 ������ �ʿ䰡 ����.
						// �ξⷳ�� ���� �ð��� �ʱ�ȭ �ϰ�, �ܰ踦 �ʱ�ȭ �Ѵ�.
						// ���μ����� ���⼭ ������.
...
{
	// m_WGPlayerList���� ���ߵ� ������ m_WaitPlayerList�̵� ��Ų��.
...
void CRoyalRumble::CheckRoyalRumbleArea()
{
	...
	if(GetRookiePlaying())
	{
		...
		else if(tGap <= 0)
		{
			...
			else if(GetRookiePlaying())	// �ٵ���. 20�е� ������. ��⸦ �������̴�. ������� ����
			{
				//�����
	...
	if(GetSeniorPlaying())
	{
		...
		else if(tGap <= 0)
		{
			...
			else if(GetSeniorPlaying())	// �ٵ���. 20�е� ������. ������� ����
			{
				// �����
	...
	if(GetMasterPlaying())
	{
		...
		else if(tGap <= 0)
		{
			...
			else if(GetMasterPlaying())	// �ٵ���. 20�е� ������. ������� ����
			{
				// �����
...
void CRoyalRumble::setStartMinute(const int val)
{
	m_nStartMinute = val;
}
...
int CRoyalRumble::getStartMinute() const
{
...
void CRoyalRumble::loadRoyalRumbleSetting()
{
	...
	int min = 0, max = 0, startHour = 0, startMinute = 0;

	cmd.GetRec("a_minPlayer", min);
	cmd.GetRec("a_maxPlayer", max);
	cmd.GetRec("a_startHour", startHour);
	cmd.GetRec("a_startMinute", startMinute);
	if(CRoyalRumble::checkSettingValue(min, max, startHour, startMinute) != kValueIsValid)
	{
...
int CRoyalRumble::checkSettingValue(const int &min, const int &max, const int &startHour, const int &startMinute)
{
	/*
	* ���� 1. min�� 10���� ũ�� 50������ ����̾�� �Ѵ�.
	* ���� 2. max�� min ���� ũ�ų� ���� 50������ ����̾�� �Ѵ�.
	* ���� 3. startHour�� 0 ~ 23�� ����̾�� �Ѵ�.
	*/
