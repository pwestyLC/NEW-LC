...
private:
	...
	int				m_nCharIndex;
	int				m_nLevelType;
	int				m_nSelected;					// 0: �ƹ��͵� �ƴ� ����, 1: ����, 2: Ż��, 3: ��� draw
	CWGPlayer*		m_next;
public:
	CWGPlayer();
...
private:
	...
	int				m_nWinnerIsRewarded;		// (1+2+4) 1:rookie�������, 2:senior �������, 4:master �������, 3:rookie senior �������, 6:senior master �������
...
//	CPC*			m_CheckInMasterPlayer[MAX_ROYAL_RUMBLE_PLAYER];
	...
	void			Init();
	void			CheckRoyalRumble();				// ������ �� Ÿ�Ӷ��� ��Ʈ��
	void			CheckRoyalRumbleArea();			// ������ �� Ÿ�Ӷ��� ��Ʈ��
	...
	void			setStartMinute(const int val);
	int				getMinPlayerCount() const;
	int				getMaxPlayerCount() const;
	int				getStartHour() const;
	int				getStartMinute() const;
	static int checkSettingValue(const int &min, const int &max, const int &startHour, const int &startMinute);
	enum
	{
		kValueIsValid = 0,
