...
void do_ExSocketUpgradeJewelReq(CPC* ch, CNetMsg::SP& msg)
{
	...
	{
		int makeChaosRand = jewelData->getComposeNormalToChaosProb() * (gserver->m_jewelDataList.m_jewelData->getEventCreateChaosProb() + gserver->m_jewelDataList.m_chaosCreateProb) / 100;
...

	{
		...
		{
			if(isChaos)
				maxrand = jewelData->getChaosComposeProb() * (100 + item4->m_itemProto->getItemNum3() * packet->itemCount) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventComposeProb() + gserver->m_jewelDataList.m_composeProb) / 100;
			else
				maxrand = jewelData->getNormalComposeProb() * (100 + item4->m_itemProto->getItemNum3() * packet->itemCount) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventComposeProb() + gserver->m_jewelDataList.m_composeProb) / 100;
		}
		else
		{
			if(isChaos)
				maxrand = jewelData->getChaosComposeProb() * (gserver->m_jewelDataList.m_jewelData->getEventComposeProb() + gserver->m_jewelDataList.m_composeProb) / 100;
			else
				maxrand = jewelData->getNormalComposeProb() * (gserver->m_jewelDataList.m_jewelData->getEventComposeProb() + gserver->m_jewelDataList.m_composeProb) / 100;
		}
		//isChaos = true;
		if(rand < maxrand)		//���� �ռ� ���� ��
		{
			...
			if(isChaos)
			{
				if (packet->itemCount > 0)
				{
					plus2 = jewelData->getChaosPlus2Prob() * (100 + (item4->m_itemProto->getItemNum3() * packet->itemCount)) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
					plus3 = jewelData->getChaosPlus3Prob() * (100 + (item4->m_itemProto->getItemNum3() * packet->itemCount)) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
				}
				else
				{
					plus2 = jewelData->getChaosPlus2Prob() * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
					plus3 = jewelData->getChaosPlus3Prob() * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
				}
			}
			else
			{
				if (packet->itemCount > 0)
				{
					plus2 = jewelData->getNormalPlus2Prob() * (100 + (item4->m_itemProto->getItemNum3() * packet->itemCount)) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
					plus3 = jewelData->getNormalPlus3Prob() * (100 + (item4->m_itemProto->getItemNum3() * packet->itemCount)) / 100 * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
				}
				else
				{
					plus2 = jewelData->getNormalPlus2Prob() * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
					plus3 = jewelData->getNormalPlus3Prob() * (gserver->m_jewelDataList.m_jewelData->getEventUpgradeProb() + gserver->m_jewelDataList.m_upgradeProb) / 100;
				}
			}
...
void do_ExSocketCombineJewelReq(CPC* ch, CNetMsg::SP& msg)
{
	...
	int eventValue = gserver->m_jewelDataList.m_jewelData->getEventCombineProb() + gserver->m_jewelDataList.m_combineProb;
