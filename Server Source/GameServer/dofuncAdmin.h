...
void do_GMReloadNPCDropList(CPC* ch, const char* arg, std::vector<std::string>& vec);
...
void do_WATCH(CPC* ch, const char* arg, std::vector<std::string>& vec);  //SKILL USE LOG
//pwesty shit
