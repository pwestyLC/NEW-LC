...
void HelperWhisperRepMsg(CNetMsg::SP& msg, int seq, int server, int subno, int zone, int sidx, const char* sname, const char* rname, const char* chat, int isItem)
{
	msg->Init(MSG_HELPER_REP);
	RefMsg(msg)	<< seq
		<< server
...
void HelperNewGuildSkillListRepMsg( CNetMsg::SP& msg, int charindex, int guildindex, MSG_GUILD_ERROR_TYPE errcode, int Activeskillcount, int* Activeskillindex, int* ActiveskillLevel, int Passiveskillcount, int* Passiveskillindex, int* PassiveskillLevel, int Etcskillcount, int* Etcskillindex, int* EtcskillLevel )
{
	...
	int i;
	RefMsg(msg) << GUILD_ACTIVE_SKILL_START					// Active Skill ����
		<< Activeskillcount;
	...
	RefMsg(msg) << GUILD_PASSIVE_SKILL_START				// PassiveSkill ����
		<< Passiveskillcount;
	...
	RefMsg(msg) << GUILD_ETC_SKILL_START					// EtcSkill ����
		<< Etcskillcount;
...
#ifdef DEMIGOD
void HelperEventDemiGodMsg(CNetMsg::SP& msg, MSG_HELPER_EVENT_DEMIGOD_ERROR_TYPE nError, int nCharIdx)
{
	msg->Init(MSG_HELPER_COMMAND);
