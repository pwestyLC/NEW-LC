...
bool CServer::LoadSettingFile()
{
	...
	strTemp.Format("%s%s", m_serverpath, "Login.txt");
...
{
	unsigned int		nIP[8];							// ip 4�ڸ� + ����ݸ���ũ 4�ڸ�
	const char*			pData				= strData;
	unsigned int		nData;
	char				strBuf[256];
	char*				pBuf;
	int					nState				= 0;		// state	: 0 - ������ �б� ����
	//			: 1 - ������ ��° �ڸ�
	//			: 2 - ������ ��° �ڸ�
	//			: 3 - ������ ��° �ڸ�
	//			: 4 - ����� �б� ����
	...
	// ������� ���� 111.222.123.234/255.255.254.0�̸�
	// nIP �� {111, 222, 123, 234, 255, 255, 254, 0} �� �ȴ�
...
void CServer::ProcConnector(CNetMsg::SP& msg)
{
	...
	// MSG_CONN_PLAYER_REP,		// �������� ������ ����	: serverno(n) serversubno(n) usercount(n)
	char subtype;
...
#ifdef SETTING_IF_INNER_IP // �ܺ� �����ǿ� ���� �����ǰ� ������ ��� ...yhj
