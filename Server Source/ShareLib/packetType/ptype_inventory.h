...
enum
{
	...
	ITEM_COUNT_IN_INVENTORY_STASH_NORMAL = 220,

	MAX_STASH_KEEP = 40,
	MAX_STASH_TAKE = 40,
};

// ���ο� ������ ������ INVENTORY_TAB_STASH ���� ���� �۰� ����� ��
enum
{
...
enum
{
	NAS_DESC_REASON_GUILD_KEEP,				// ���â���� �ñ涧
	NAS_DESC_REASON_STASH_KEEP,				// ����â���� �ñ涧
};
...
struct moneyDescReason : public pTypeBase	// NAS ���� ������ Ŭ���̾�Ʈ���� ����
{
	short		reason;
	LONGLONG	nas;
};
