...
{
	unsigned int		wearPos;			// ���׷��̵� ������ / �������� ������
	unsigned int		vIndex;
	unsigned short		tab_2;			// ���ü� ������
	unsigned short		invenIndex_2;
	unsigned short		tab_3;			// ���� ��ȣ ������
...
struct doItemSealCompose : public pTypeBase
{
	unsigned short		tab;
	unsigned short		invenIndex;
	int					count;
...
struct doItemTransmogrify : public pTypeBase
{
	unsigned short		tab;
	unsigned short		invenIndex;
};

struct doItemExtendMenu : public pTypeBase
{
	unsigned short		tab;
	unsigned short		invenIndex;
	unsigned int		days;
...
{
	int matItem_Index;			//	��� �ε���
	slotItemInfo matInfo[MAX_COMPOSE_SLOT_COUNT];	//	��� ������ ����
};

struct doItemUpgradePet : public pTypeBase
{
	unsigned int		wearPos;			// �������� �� ��� ������ġ ����
	unsigned short		tab;				// ���ü� ������ tab
	unsigned short		inven_index;		// ���ü� ������ inven_index
};
...
{
	WEAR_ERR_OK,
	WEAR_ERR_INVALID_POS,		//������ġ�� �߸� �Ǿ����ϴ�.
	WEAR_ERR_CANNOT_TAKEOFF,	//�������� ���� �� �����ϴ�.
	WEAR_ERR_CANNOT_WEAR,		//�������� ������ �� �����ϴ�.
	WEAR_ERR_NOT_ENOUGH_INVEN,	//�κ� ���� ����
	WEAR_ERR_INVALID_ITEM_INFO, //�ùٸ� �������� �ƴմϴ�.
	WEAR_ERR_ITEM_SEAL,			//���ε� ������ �Դϴ�.
	WEAR_ERR_CANNOT_SWAP_ITEM_CASH_INVEN,	//ĳ�� �κ��丮�� �Ⱓ�� ����Ǿ� ���� �������� ���� �� �����ϴ�.
	//������ ��ȯ
	EXCHANGE_ERR_WRONG_ITEM_INFO,	//�߸��� ������ ����
	EXCHANGE_ERR_NOT_ENOUGH_MONEY,	//�� ����
	EXCHANGE_ERR_INVENTORY_FULL,	//�κ��丮 ���� ����
	EXCHANGE_ERR_OK,				//��ȯ ����

	//�� ��� ��ȭ
	PET_ITEM_UPGRADE_PLUS,			//��ȭ ����
	PET_ITEM_UPGRADE_MINUS,			//��ȭ ���� 1���̳ʽ�
	PET_ITEM_UPGRADE_NO_CHANGE,		//��ȭ ���� ��ȭ ����
	PET_ITEM_UPGRADE_BROKE,			//��ȭ ���� ��� �ı�
};
struct doItemUse : public pTypeBase
{
	unsigned short	tab;
...
inline void ItemUseAutoMsg(CNetMsg::SP& msg, unsigned short tab, unsigned short invenIndex, int index, int extra)
{
    doItemUse* packet = reinterpret_cast<doItemUse*>(msg->m_buf);
    packet->type = MSG_ITEM;
    packet->subType = MSG_ITEM_AUTO_USE;
    packet->tab = tab;
    packet->invenIndex = invenIndex;
    packet->index = index;
    packet->extral = extra;
...
{
struct doItemWear : public pTypeBase	// ������ RequestClient::doItemWear�� ����� ���ƾ���
{
	itemInfo	info;
};

struct doItemWearChangeInfo : public pTypeBase	// ������ RequestClient::doItemWear�� ����� ���ƾ���
{
	itemInfo	info;
};

struct doItemWearTakeOff : public pTypeBase	// ������ RequestClient::doItemWear�� ����� ���ƾ���
{
	char		wearPos;
};
