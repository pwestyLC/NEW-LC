...
protected:
	...
	void							Init();
	void							notusedSetReadWaitTimer();
	void							notusedSetWriteWaitTimer();
...
private:
	...
	bool							is_call_close_function_;		// close  עק    ?    ?   ?  true
	...
	boost::asio::io_context::strand				boost_strand_; //boost 1.70
	//boost::asio::strand				boost_strand_;  //boost 1.65 <
};
