...
// Type: LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare
...
#nullable disable
namespace LcDevPack_TeamDamonA.ClientStringCompare
{
  public class ClientStringCompare : Form
  {
    public static Connection connection = new Connection();
        private string Host => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.SqlHost;
        private string User => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.SqlUser;
        private string Password => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.SqlPassword;
        private string Database => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.SqlDatabase;
        private DatabaseHandle databaseHandle = new DatabaseHandle();
        public string _ClientPath => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.ClientPath;
    ...
    public static string namee;
        private string language => LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.connection.Settings.Language;
    ...
    private string StringFromLanguage()
    {
      ...
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_ger";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "POL")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_pld";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "BRA")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_brz";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "RUS")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_rus";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "FRA")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_frc";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "ESP")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_spn";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "MEX")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_mex";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "THA")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_thai";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (this.language == "ITA")
      {
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_ita";
        return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
      }
      if (!(this.language == "USA"))
        return (string) null;
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = "a_string_usa";
      return LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee;
    }

    public void SearchList(string searchString)
    {
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      string Query = "select a_index, " + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + " from t_string WHERE " + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + " LIKE '%" + searchString + "%' ORDER BY a_index;";
      if (this.language == "GER")
    ...
    private void LoadListBox()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      string Query = "SELECT a_index, " + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + " FROM t_string ORDER BY a_index;";
      if (this.language == "GER")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, Query);
      else if (this.language == "BRA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, Query);
    ...
    private void LoadListBox2()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayUSA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_string_usa FROM t_string ORDER BY a_index;");
    ...
    private void LoadListBoxTHAI()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayTHA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_string_thai FROM t_string ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxGER()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_string_ger FROM t_string ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxESP()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayESP, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_string_spn FROM t_string ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxBRA()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_string_brz FROM t_string ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      string Query = "select a_index, " + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + " FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
      string[] rows = new string[2]
      {
        "a_index",
        LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee
      };
    ...
    private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (this.comboBox1.SelectedIndex == 0)
      {
        string Query = "select a_index, a_string_thai FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_string_thai"
      ...
      {
        string Query = "select a_index, a_string_usa FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_string_usa"
      ...
      {
        string Query = "select a_index, a_string_ger FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_string_ger"
      ...
      {
        string Query = "select a_index, a_string_spn FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_string_spn"
      ...
      {
        string Query = "select a_index, a_string_brz FROM t_string WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_string_brz"
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET " + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + "  = '" + str + "' WHERE a_index = '" + this.textBox6.Text + "'");
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "INSERT INTO t_string (" + LcDevPack_TeamDamonA.ClientStringCompare.ClientStringCompare.namee + ") VALUES ('New String')");
      this.LoadListBox();
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBox1.Size = new Size(637, 143);
      ...
      this.button2.Location = new Point(15, 90);
      this.button2.Margin = new Padding(4);
      this.button2.Name = "button2";
      this.button2.Size = new Size(103, 33);
      ...
      this.button4.Location = new Point(473, 90);
      this.button4.Margin = new Padding(4);
      this.button4.Name = "button4";
      this.button4.Size = new Size(103, 33);
      ...
      this.button3.Location = new Point(125, 90);
      this.button3.Margin = new Padding(4);
      this.button3.Name = "button3";
      this.button3.Size = new Size(116, 33);
      ...
      this.button1.Location = new Point(249, 90);
      ...
      this.groupBox4.Size = new Size(637, 143);
      ...
      this.button8.Location = new Point(517, 90);
      ...
      this.ClientSize = new Size(1320, 532);
      ...
      this.Name = nameof (ClientStringCompare);
      this.Text = "LastChaos Client String Compare";
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      if (this.comboBox1.SelectedIndex == 0)
      {
        ...
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET a_string_thai = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 1)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET a_string_usa = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 2)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET a_string_ger = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 3)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET a_string_spn = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 4)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_string SET a_string_brz = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      else
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
