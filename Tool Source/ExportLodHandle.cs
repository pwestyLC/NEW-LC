...
namespace LcDevPack_TeamDamonA
{
  ...
  {
        private string Host => ExportLodHandle.connection.Settings.SqlHost;
        private string User => ExportLodHandle.connection.Settings.SqlUser;
        private string Password => ExportLodHandle.connection.Settings.SqlPassword;
        private string Database => ExportLodHandle.connection.Settings.SqlDatabase;
    ...
    public void ExportMoonstoneLOD_V2()
    {
      ...
      int num1 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, Query1);
      int num2 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, Query2);
      int num3 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, Query3);
      int num4 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, Query4);
      int num5 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, Query5);
      int num6 = 0;
      string str6 = "";
    ...
    public void ExportItemAll_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_item");
      string str1 = "SELECT * FROM t_item WHERE a_enable = 1 ORDER by a_index";
    ...
    public void ExportMobAll_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_npc");
      ...
      while (mySqlDataReader.Read())
      {
        ...
        binaryWriter.Write(long.Parse(s7));
    ...
    public void ExportDropMobNpc_V4()
    {
      SaveFileDialog saveFileDialog = new SaveFileDialog();
      saveFileDialog.Filter = "File dropNpc.lod|dropNpc.lod";
      saveFileDialog.FileName = "dropNpc.lod";
      saveFileDialog.Title = "Save dropNpc.lod file";
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_npc");
      string str = "SELECT * FROM t_npc WHERE a_enable = 1 ORDER BY a_index";
      MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
      MySqlCommand command = mySqlConnection.CreateCommand();
      ...
      while (mySqlDataReader.Read())
      {
        ...
        string s1 = mySqlDataReader.GetString(ordinal1);
        binaryWriter.Write(int.Parse(s1));
        int ordinal2 = mySqlDataReader.GetOrdinal("a_item_0");
        string s2 = mySqlDataReader.GetString(ordinal2);
        binaryWriter.Write(int.Parse(s2));
        int ordinal3 = mySqlDataReader.GetOrdinal("a_item_1");
        string s3 = mySqlDataReader.GetString(ordinal3);
        binaryWriter.Write(int.Parse(s3));
        int ordinal4 = mySqlDataReader.GetOrdinal("a_item_2");
        string s4 = mySqlDataReader.GetString(ordinal4);
        binaryWriter.Write(int.Parse(s4));
        int ordinal5 = mySqlDataReader.GetOrdinal("a_item_3");
        string s5 = mySqlDataReader.GetString(ordinal5);
        binaryWriter.Write(int.Parse(s5));
        int ordinal6 = mySqlDataReader.GetOrdinal("a_item_4");
        string s6 = mySqlDataReader.GetString(ordinal6);
        binaryWriter.Write(int.Parse(s6));
        int ordinal7 = mySqlDataReader.GetOrdinal("a_item_5");
        string s7 = mySqlDataReader.GetString(ordinal7);
        binaryWriter.Write(int.Parse(s7));
        int ordinal8 = mySqlDataReader.GetOrdinal("a_item_6");
        string s8 = mySqlDataReader.GetString(ordinal8);
        binaryWriter.Write(int.Parse(s8));
        int ordinal9 = mySqlDataReader.GetOrdinal("a_item_7");
        string s9 = mySqlDataReader.GetString(ordinal9);
        binaryWriter.Write(int.Parse(s9));
        int ordinal10 = mySqlDataReader.GetOrdinal("a_item_8");
        string s10 = mySqlDataReader.GetString(ordinal10);
        binaryWriter.Write(int.Parse(s10));
        int ordinal11 = mySqlDataReader.GetOrdinal("a_item_9");
        string s11 = mySqlDataReader.GetString(ordinal11);
        binaryWriter.Write(int.Parse(s11));
        mySqlDataReader.GetOrdinal("a_item_10");
        string s12 = mySqlDataReader.GetString(ordinal10);
        binaryWriter.Write(int.Parse(s12));
        int ordinal12 = mySqlDataReader.GetOrdinal("a_item_11");
        string s13 = mySqlDataReader.GetString(ordinal12);
        binaryWriter.Write(int.Parse(s13));
        int ordinal13 = mySqlDataReader.GetOrdinal("a_item_12");
        string s14 = mySqlDataReader.GetString(ordinal13);
        binaryWriter.Write(int.Parse(s14));
        int ordinal14 = mySqlDataReader.GetOrdinal("a_item_13");
        string s15 = mySqlDataReader.GetString(ordinal14);
        binaryWriter.Write(int.Parse(s15));
        int ordinal15 = mySqlDataReader.GetOrdinal("a_item_14");
        string s16 = mySqlDataReader.GetString(ordinal15);
        binaryWriter.Write(int.Parse(s16));
        int ordinal16 = mySqlDataReader.GetOrdinal("a_item_15");
        string s17 = mySqlDataReader.GetString(ordinal16);
        binaryWriter.Write(int.Parse(s17));
        int ordinal17 = mySqlDataReader.GetOrdinal("a_item_16");
        string s18 = mySqlDataReader.GetString(ordinal17);
        binaryWriter.Write(int.Parse(s18));
        int ordinal18 = mySqlDataReader.GetOrdinal("a_item_17");
        string s19 = mySqlDataReader.GetString(ordinal18);
        binaryWriter.Write(int.Parse(s19));
        int ordinal19 = mySqlDataReader.GetOrdinal("a_item_18");
        string s20 = mySqlDataReader.GetString(ordinal19);
        binaryWriter.Write(int.Parse(s20));
        int ordinal20 = mySqlDataReader.GetOrdinal("a_item_19");
        string s21 = mySqlDataReader.GetString(ordinal20);
        binaryWriter.Write(int.Parse(s21));
      }
      mySqlConnection.Close();
      binaryWriter.Close();
...
public void ExportSkillAll_V4()
    {
        ...
        {
            Filter = "File skills.lod|skills*.lod",
            FileName = "skills.lod",
            Title = "Save skills.lod file"
        };
        if (saveFileDialog.ShowDialog() != DialogResult.OK)
            return;

        string logPath = @"C:\Users\westy\Desktop\exports\export_log.txt";
        ...
        var skillLevelsByIndex = new Dictionary<int, List<Dictionary<string, object>>>();
        ...
        try
        {
            ...
            {
                connection.Open();
                Log("Connected to MySQL in: " + stopwatch.Elapsed);

                // ---- Load t_skill ----
                using (var cmd = new MySqlCommand("SELECT * FROM t_skill WHERE a_job>=0 ORDER BY a_index", connection))
                ...
                Log($"Loaded t_skill ({skills.Count} rows) in: {stopwatch.Elapsed}");

                // ---- Load t_skillLevel ----
                using (var cmd2 = new MySqlCommand("SELECT * FROM t_skillLevel ORDER BY a_index, a_level", connection))
                using (var reader2 = cmd2.ExecuteReader())
                {
                    while (reader2.Read())
                    {
                        int index = Convert.ToInt32(reader2["a_index"]);
                        if (!skillLevelsByIndex.TryGetValue(index, out var list))
                        {
                            list = new List<Dictionary<string, object>>();
                            skillLevelsByIndex[index] = list;
                        }
                ...
                Log($"Loaded t_skillLevel ({skillLevelsByIndex.Count} groups) in: {stopwatch.Elapsed}");
            }

            // ---- Start writing file ----
            Log("Starting file write...");
            using (var fs = new BufferedStream(File.Create(saveFileDialog.FileName), 65536))
            using (var bw = new BinaryWriter(fs))
            {
                ...
                {
                    // only minimal for speed testing
                    bw.Write(Convert.ToInt32(skill["a_index"]));
                    bw.Write(Convert.ToInt32(skill["a_job"]));
                    bw.Write(Convert.ToInt32(skill["a_job2"]));
                    bw.Write(Convert.ToInt32(skill["a_apet_index"]));
                }

                bw.Write(-9999);
            }

            Log("File written successfully in: " + stopwatch.Elapsed);
            MessageBox.Show("Export finished successfully!\nTotal time: " + stopwatch.Elapsed);
        }
        catch (Exception ex)
        {
            Log("Error during export: " + ex);
    ...
    public void ExportQuestAll_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_quest");
    ...
    public void ExportTitle_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num1 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_title");
    ...
    public void ExportString_V4(string fileType)
    {
      if (this.language == "THA")
      {
        ...
        if (fileType == "strItem")
        {
          str1 = "File strItem_th.lod|strItem*.lod";
          str2 = "strItem_th.lod";
          str3 = "Save strItem_th.lod file";
          str4 = "SELECT * FROM t_item";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_item");
          flag1 = true;
          flag2 = true;
        }
        SaveFileDialog saveFileDialog = new SaveFileDialog();
        ...
        while (mySqlDataReader.Read())
        {
          ...
          string s1 = mySqlDataReader.GetString(ordinal1);
          binaryWriter.Write(int.Parse(s1));
          int ordinal2 = mySqlDataReader.GetOrdinal("a_name_thai");
          string s2 = mySqlDataReader.GetString(ordinal2);
          string s3 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s2));
          binaryWriter.Write(Encoding.Default.GetBytes(s3).Length);
          binaryWriter.Write(Encoding.Default.GetBytes(s3));
          if (flag2)
          {
            int ordinal3 = mySqlDataReader.GetOrdinal("a_descr_thai");
            string s4 = mySqlDataReader.GetString(ordinal3);
            string s5 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s4));
            binaryWriter.Write(Encoding.Default.GetBytes(s5).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s5));
          }
        }
        mySqlConnection.Close();
        binaryWriter.Close();
      ...
      else
      {
        ...
        if (fileType == "strItem")
        {
          str5 = "File strItem.lod|strItem*.lod";
          str6 = "strItem.lod";
          str7 = "Save strItem.lod file";
          str8 = "SELECT * FROM t_item";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_item");
          flag3 = true;
          flag4 = true;
        }
        SaveFileDialog saveFileDialog = new SaveFileDialog();
        saveFileDialog.Filter = str5;
        saveFileDialog.FileName = str6;
        saveFileDialog.Title = str7;
        if (saveFileDialog.ShowDialog() != DialogResult.OK)
          return;
        BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
        MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
        ...
        while (mySqlDataReader.Read())
        {
          int ordinal4 = mySqlDataReader.GetOrdinal("a_index");
          string s6 = mySqlDataReader.GetString(ordinal4);
          binaryWriter.Write(int.Parse(s6));
          int ordinal5 = mySqlDataReader.GetOrdinal("a_name_usa");
          string s7 = mySqlDataReader.GetString(ordinal5);
          binaryWriter.Write(Encoding.UTF8.GetBytes(s7).Length);
          binaryWriter.Write(Encoding.UTF8.GetBytes(s7));
          if (flag4)
          {
            int ordinal6 = mySqlDataReader.GetOrdinal("a_descr_usa");
            string s8 = mySqlDataReader.GetString(ordinal6);
            binaryWriter.Write(Encoding.UTF8.GetBytes(s8).Length);
            binaryWriter.Write(Encoding.UTF8.GetBytes(s8));
          }
        }
        mySqlConnection.Close();
        binaryWriter.Close();
    ...
    public void ExportString_NPC_V4(string fileType)
    {
      if (this.language == "THA")
      {
        string str1 = "";
        ...
        bool flag1 = false;
        bool flag2 = false;
        if (fileType == "strNpcName")
        {
          str1 = "File strNpcName_th.lod|strNpcName*.lod";
          str2 = "strNpcName_th.lod";
          str3 = "Save strNpcName_th.lod file";
          str4 = "SELECT * FROM t_npc";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_npc");
          flag1 = true;
          flag2 = true;
        }
        SaveFileDialog saveFileDialog = new SaveFileDialog();
      ...
      else
      {
        ...
        if (fileType == "strNpcName")
        {
          str5 = "File strNpcName_us.lod|strNpcName*.lod";
          str6 = "strNpcName_us.lod";
          str7 = "Save strNpcName_us.lod file";
          str8 = "SELECT * FROM t_npc";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_npc");
          flag3 = true;
          flag4 = true;
        }
    ...
    public void ExportString_Quest_V4(string fileType)
    {
      if (this.language == "THA")
      {
        string str1 = "";
        ...
        bool flag3 = false;
        bool flag4 = false;
        if (fileType == "strQuest")
        {
          str1 = "File strQuest_th.lod|strQuest*.lod";
          str2 = "strQuest_th.lod";
          str3 = "Save strQuest_th.lod file";
          str4 = "SELECT * FROM t_quest ORDER BY a_index";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_quest");
          flag1 = true;
          flag2 = true;
          flag3 = true;
          flag4 = true;
        ...
        while (mySqlDataReader.Read())
        {
          ...
          if (flag2)
          {
            int ordinal3 = mySqlDataReader.GetOrdinal("a_desc_thai");
            string s4 = mySqlDataReader.GetString(ordinal3);
            string s5 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s4));
            binaryWriter.Write(Encoding.Default.GetBytes(s5).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s5));
          ...
          if (flag3)
          {
            int ordinal4 = mySqlDataReader.GetOrdinal("a_desc2_thai");
            string s6 = mySqlDataReader.GetString(ordinal4);
            string s7 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s6));
            binaryWriter.Write(Encoding.Default.GetBytes(s7).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s7));
          }
          if (flag4)
          {
            int ordinal5 = mySqlDataReader.GetOrdinal("a_desc3_thai");
            string s8 = mySqlDataReader.GetString(ordinal5);
            string s9 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s8));
            binaryWriter.Write(Encoding.Default.GetBytes(s9).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s9));
          }
        }
        mySqlConnection.Close();
        binaryWriter.Close();
      ...
      else
      {
        ...
        if (fileType == "strQuest")
        {
          str5 = "File strQuest_th.lod|strQuest*.lod";
          str6 = "strQuest_th.lod";
          str7 = "Save strQuest_th.lod file";
          str8 = "SELECT * FROM t_quest";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_quest");
          flag5 = true;
          flag6 = true;
          flag7 = true;
        ...
        while (mySqlDataReader.Read())
        {
          while (mySqlDataReader.Read())
          {
            int ordinal6 = mySqlDataReader.GetOrdinal("a_index");
            string s10 = mySqlDataReader.GetString(ordinal6);
            binaryWriter.Write(int.Parse(s10));
            int ordinal7 = mySqlDataReader.GetOrdinal("a_name_thai");
            string s11 = mySqlDataReader.GetString(ordinal7);
            string s12 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s11));
            binaryWriter.Write(Encoding.Default.GetBytes(s12).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s12));
            if (flag6)
            {
              int ordinal8 = mySqlDataReader.GetOrdinal("a_desc_thai");
              string s13 = mySqlDataReader.GetString(ordinal8);
              string s14 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s13));
              binaryWriter.Write(Encoding.Default.GetBytes(s14).Length);
              binaryWriter.Write(Encoding.Default.GetBytes(s14));
            }
            if (flag7)
            {
              int ordinal9 = mySqlDataReader.GetOrdinal("a_desc2_thai");
              string s15 = mySqlDataReader.GetString(ordinal9);
              string s16 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s15));
              binaryWriter.Write(Encoding.Default.GetBytes(s16).Length);
              binaryWriter.Write(Encoding.Default.GetBytes(s16));
            }
            if (flag8)
            {
              int ordinal10 = mySqlDataReader.GetOrdinal("a_desc3_thai");
              string s17 = mySqlDataReader.GetString(ordinal10);
              string s18 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s17));
              binaryWriter.Write(Encoding.Default.GetBytes(s18).Length);
              binaryWriter.Write(Encoding.Default.GetBytes(s18));
            }
          }
        }
        mySqlConnection.Close();
    ...
    public void ExportStringPassive_V4(string fileType)
    {
      if (this.language == "THA")
      {
        string str1 = "";
        ...
        bool flag1 = false;
        bool flag2 = false;
        if (fileType == "strPassiveSystem")
        {
          str1 = "File strPassiveSystem_th.lod|strPassiveSystem*.lod";
          str2 = "strPassiveSystem_th.lod";
          str3 = "Save strPassiveSystem_th.lod file";
          str4 = "SELECT * FROM t_passive_system";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_passive_system");
          flag1 = true;
          flag2 = true;
        }
        SaveFileDialog saveFileDialog = new SaveFileDialog();
        ...
        while (mySqlDataReader.Read())
        {
          ...
          if (flag2)
          {
            int ordinal3 = mySqlDataReader.GetOrdinal("a_client_description_thai");
            string s4 = mySqlDataReader.GetString(ordinal3);
            string s5 = Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s4));
            binaryWriter.Write(Encoding.Default.GetBytes(s5).Length);
            binaryWriter.Write(Encoding.Default.GetBytes(s5));
      ...
      else
      {
        ...
        if (fileType == "strPassiveSystem")
        {
          str5 = "File strPassiveSystem.lod|strPassiveSystem*.lod";
          str6 = "strPassiveSystem.lod";
          str7 = "Save strPassiveSystem.lod file";
          str8 = "SELECT * FROM t_passive_system";
          num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_passive_system");
          flag3 = true;
          flag4 = true;
        }
        ...
        while (mySqlDataReader.Read())
        {
          ...
          if (flag4)
          {
            int ordinal6 = mySqlDataReader.GetOrdinal("a_client_description_usa");
            string s8 = mySqlDataReader.GetString(ordinal6);
            binaryWriter.Write(Encoding.UTF8.GetBytes(s8).Length);
            binaryWriter.Write(Encoding.UTF8.GetBytes(s8));
          }
        ...
        public void ExportCatalog_V4()
        {
            SaveFileDialog saveFileDialog = new SaveFileDialog
            {
                Filter = "File catalog.lod|catalog*.lod",
                FileName = "catalog.lod",
                Title = "Save catalog.lod file"
            };
            ...
            // Choose encoding and language fields
            string nameField, descField;
            Encoding enc;

            switch (this.language)
            {
                case "THA":
                    nameField = "a_ctname_tld_eng";
                    descField = "a_ctdesc_tld_eng";
                    enc = Encoding.Default;
                    break;
                case "BRA":
                    nameField = "a_ctname_brz";
                    descField = "a_ctdesc_brz";
                    enc = Encoding.UTF8;
                    break;
                default:
                    nameField = "a_ctname";
            ...
            int totalCount = this.databaseHandle.CountByRow(
                this.Host, this.User, this.Password, this.Database,
                "SELECT COUNT(*) FROM t_catalog WHERE a_enable='1'"
            );
            writer.Write(totalCount);

            string queryCatalog = "SELECT * FROM t_catalog WHERE a_enable='1' ORDER BY a_ctid ASC";
            using var cmd = new MySqlCommand(queryCatalog, conn);
            using var reader = cmd.ExecuteReader();

            while (reader.Read())
            {
                int a_ctid = Convert.ToInt32(reader["a_ctid"]);
                int a_category = Convert.ToInt32(reader["a_category"]);
                int a_cash = Convert.ToInt32(reader["a_cash"]);
                int a_mileage = Convert.ToInt32(reader["a_mileage"]);
                int a_flag = Convert.ToInt32(reader["a_flag"]);
                bool a_enable = Convert.ToBoolean(reader["a_enable"]);

                writer.Write(a_ctid);
                writer.Write(a_category);
                writer.Write(a_cash);
                writer.Write(a_mileage);
                writer.Write(a_flag);
                writer.Write((byte)(a_enable ? 1 : 0));

                string ctname = reader[nameField]?.ToString() ?? "";
                string ctdesc = reader[descField]?.ToString() ?? "";

                byte[] nameBytes = enc.GetBytes(ctname);
                byte[] descBytes = enc.GetBytes(ctdesc);
                ...
                // Query item count
                int itemCount = this.databaseHandle.CountByRow(
                    this.Host, this.User, this.Password, this.Database,
                    $"SELECT COUNT(*) FROM t_ct_item WHERE a_ctid='{a_ctid}'"
                );
                writer.Write(itemCount);

                // --- NEW CONNECTION for item reader ---
                using (var itemConn = new MySqlConnection(connectionString))
                {
                    itemConn.Open();
                    string itemQuery = $"SELECT * FROM t_ct_item WHERE a_ctid='{a_ctid}' ORDER BY a_index";
                    using var itemCmd = new MySqlCommand(itemQuery, itemConn);
                    using var itemReader = itemCmd.ExecuteReader();

                    while (itemReader.Read())
                    {
                        writer.Write(Convert.ToInt32(itemReader["a_item_idx"]));
                        writer.Write(Convert.ToInt32(itemReader["a_item_flag"]));
                        writer.Write(Convert.ToInt32(itemReader["a_item_plus"]));
                        writer.Write(Convert.ToInt32(itemReader["a_item_option"]));
                        writer.Write(Convert.ToInt32(itemReader["a_item_num"]));
                    }
                }

                writer.Write(Convert.ToInt32(reader["a_icon"]));
            }
        ...
        public void ExportShop_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num1 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT CAST(MAX(a_keeper_idx) AS SIGNED) FROM t_shop");
      ...
      while (mySqlDataReader1.Read())
      {
        ...
        string s4 = mySqlDataReader1.GetString(ordinal4);
        binaryWriter.Write(int.Parse(s4));
        int num2 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_shopitem WHERE a_keeper_idx ='" + s1 + "'");
        binaryWriter.Write(num2);
    ...
    public void ExportExChange_V4()
    {
      ...
      while (mySqlDataReader.Read())
      {
        ...
        string s2 = mySqlDataReader.GetString(ordinal2);
        binaryWriter.Write(int.Parse(s2));
        int ordinal3 = mySqlDataReader.GetOrdinal("result_itemIndex");
        string s3 = mySqlDataReader.GetString(ordinal3);
        binaryWriter.Write(int.Parse(s3));
        int ordinal4 = mySqlDataReader.GetOrdinal("result_itemCount");
        string s4 = mySqlDataReader.GetString(ordinal4);
        binaryWriter.Write(int.Parse(s4));
        int ordinal5 = mySqlDataReader.GetOrdinal("source_itemIndex0");
        string s5 = mySqlDataReader.GetString(ordinal5);
        binaryWriter.Write(int.Parse(s5));
        int ordinal6 = mySqlDataReader.GetOrdinal("source_itemCount0");
        string s6 = mySqlDataReader.GetString(ordinal6);
        binaryWriter.Write(int.Parse(s6));
        int ordinal7 = mySqlDataReader.GetOrdinal("source_itemIndex1");
        string s7 = mySqlDataReader.GetString(ordinal7);
        binaryWriter.Write(int.Parse(s7));
        int ordinal8 = mySqlDataReader.GetOrdinal("source_itemCount1");
        string s8 = mySqlDataReader.GetString(ordinal8);
        binaryWriter.Write(int.Parse(s8));
        int ordinal9 = mySqlDataReader.GetOrdinal("source_itemIndex2");
        string s9 = mySqlDataReader.GetString(ordinal9);
        binaryWriter.Write(int.Parse(s9));
        int ordinal10 = mySqlDataReader.GetOrdinal("source_itemCount2");
        string s10 = mySqlDataReader.GetString(ordinal10);
        binaryWriter.Write(int.Parse(s10));
        int ordinal11 = mySqlDataReader.GetOrdinal("source_itemIndex3");
        string s11 = mySqlDataReader.GetString(ordinal11);
        binaryWriter.Write(int.Parse(s11));
        int ordinal12 = mySqlDataReader.GetOrdinal("source_itemCount3");
        string s12 = mySqlDataReader.GetString(ordinal12);
        binaryWriter.Write(int.Parse(s12));
        int ordinal13 = mySqlDataReader.GetOrdinal("source_itemIndex4");
        string s13 = mySqlDataReader.GetString(ordinal13);
        binaryWriter.Write(int.Parse(s13));
        int ordinal14 = mySqlDataReader.GetOrdinal("source_itemCount4");
        string s14 = mySqlDataReader.GetString(ordinal14);
        binaryWriter.Write(int.Parse(s14));
      }
      mySqlConnection.Close();
    ...
    public void ExportDailyLogin_V4()
    {
      SaveFileDialog saveFileDialog = new SaveFileDialog();
      saveFileDialog.Filter = "File dailyLogin.lod|dailyLogin*.lod";
      saveFileDialog.FileName = "dailyLogin.lod";
      saveFileDialog.Title = "Save dailyLogin.lod file";
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_loginrewardnew");
      string str = "SELECT * FROM t_loginrewardnew";
      MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
      MySqlCommand command = mySqlConnection.CreateCommand();
      command.CommandText = str;
      mySqlConnection.Open();
      ...
      while (mySqlDataReader.Read())
      {
        int ordinal1 = mySqlDataReader.GetOrdinal("a_month");
        string s1 = mySqlDataReader.GetString(ordinal1);
        binaryWriter.Write(int.Parse(s1));
        int ordinal2 = mySqlDataReader.GetOrdinal("a_day");
        string s2 = mySqlDataReader.GetString(ordinal2);
        binaryWriter.Write(int.Parse(s2));
        int ordinal3 = mySqlDataReader.GetOrdinal("a_item");
        string s3 = mySqlDataReader.GetString(ordinal3);
        binaryWriter.Write(int.Parse(s3));
    ...
    public void ExportPassiveSystem_V4()
    {
      SaveFileDialog saveFileDialog = new SaveFileDialog();
      saveFileDialog.Filter = "File passiveSystem.lod|passiveSystem*.lod";
      saveFileDialog.FileName = "passiveSystem.lod";
      saveFileDialog.Title = "Save passiveSystem.lod file";
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_passive_system");
      string str = "SELECT * FROM t_passive_system";
      MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
      MySqlCommand command = mySqlConnection.CreateCommand();
      command.CommandText = str;
      mySqlConnection.Open();
      ...
      while (mySqlDataReader.Read())
      {
        ...
        string s1 = mySqlDataReader.GetString(ordinal1);
        binaryWriter.Write(int.Parse(s1));
        int ordinal2 = mySqlDataReader.GetOrdinal("a_option_id");
        string s2 = mySqlDataReader.GetString(ordinal2);
        binaryWriter.Write(int.Parse(s2));
        int ordinal3 = mySqlDataReader.GetOrdinal("a_option_level");
        string s3 = mySqlDataReader.GetString(ordinal3);
        binaryWriter.Write(int.Parse(s3));
        int ordinal4 = mySqlDataReader.GetOrdinal("a_row");
        string s4 = mySqlDataReader.GetString(ordinal4);
        binaryWriter.Write(int.Parse(s4));
        int ordinal5 = mySqlDataReader.GetOrdinal("a_col");
        string s5 = mySqlDataReader.GetString(ordinal5);
        binaryWriter.Write(int.Parse(s5));
      }
      mySqlConnection.Close();
    ...
    public void ExportZoneFlag_V4()
    {
      SaveFileDialog saveFileDialog = new SaveFileDialog();
      saveFileDialog.Filter = "File ZoneFlag.lod|ZoneFlag*.lod";
      saveFileDialog.FileName = "ZoneFlag.lod";
      saveFileDialog.Title = "Save ZoneFlag.lod file";
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_npc WHERE a_zone_flag > 0");
      string str = "SELECT a_index, a_zone_flag, a_extra_flag FROM t_npc WHERE a_zone_flag > 0";
      MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
      MySqlCommand command = mySqlConnection.CreateCommand();
      command.CommandText = str;
      mySqlConnection.Open();
      ...
      while (mySqlDataReader.Read())
      {
        ...
        string s1 = mySqlDataReader.GetString(ordinal1);
        binaryWriter.Write(int.Parse(s1));
        int ordinal2 = mySqlDataReader.GetOrdinal("a_zone_flag");
        string s2 = mySqlDataReader.GetString(ordinal2);
        binaryWriter.Write(long.Parse(s2));
        int ordinal3 = mySqlDataReader.GetOrdinal("a_extra_flag");
        string s3 = mySqlDataReader.GetString(ordinal3);
        if (int.Parse(s3) == 0)
          binaryWriter.Write(long.Parse(s3 + 1.ToString()));
        else
          binaryWriter.Write(long.Parse(s3));
      }
      mySqlConnection.Close();
      binaryWriter.Close();
      this.messageHandle.SuccessFileMessage();
        ...
        public void ExportOption_V4()
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                string connectionString =
                    $"Server={this.Host};Port=3306;User ID={this.User};Password={this.Password};Database={this.Database};Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;";
                ...
                try
                {
                    ...
                    using (BinaryWriter writer = new BinaryWriter(File.Create(saveFileDialog.FileName)))
                    {
                        ...
                        int totalRows = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_option");
                        ...
                        using (MySqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                int a_index = reader.GetInt32(reader.GetOrdinal("a_index"));
                                int a_type = reader.GetInt32(reader.GetOrdinal("a_type"));

                                writer.Write(a_index);
                                writer.Write(a_type);

                                string a_levelStr = reader.GetString(reader.GetOrdinal("a_level"));
                                string[] parts = a_levelStr.Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
                ...
                {
                    MessageBox.Show("Error exporting option.lod:\n" + ex.Message, "Export Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }


        public void ExportMakeItem_V4()
    {
      if (this.language == "THA")
      {
        SaveFileDialog saveFileDialog = new SaveFileDialog();
        saveFileDialog.Filter = "File MakeItem.lod|MakeItem*.lod";
        saveFileDialog.FileName = "MakeItem.lod";
        saveFileDialog.Title = "Save MakeItem.lod file";
        if (saveFileDialog.ShowDialog() != DialogResult.OK)
          return;
        BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
        int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_factory_item WHERE a_enable = 1");
        string str1 = "SELECT * FROM t_factory_item WHERE a_enable = 1 ORDER BY a_index";
        MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
        MySqlCommand command = mySqlConnection.CreateCommand();
        command.CommandText = str1;
        mySqlConnection.Open();
        ...
        while (mySqlDataReader.Read())
        {
          ...
          binaryWriter.Write(Encoding.UTF8.GetBytes(s2).Length);
          binaryWriter.Write(Encoding.UTF8.GetBytes(s2));
          int ordinal3 = mySqlDataReader.GetOrdinal("a_seal_type");
          string s3 = mySqlDataReader.GetString(ordinal3);
          binaryWriter.Write(int.Parse(s3));
          int ordinal4 = mySqlDataReader.GetOrdinal("a_item_type");
          string s4 = mySqlDataReader.GetString(ordinal4);
          binaryWriter.Write(int.Parse(s4));
          int ordinal5 = mySqlDataReader.GetOrdinal("a_item_idx");
          string s5 = mySqlDataReader.GetString(ordinal5);
          binaryWriter.Write(int.Parse(s5));
          int ordinal6 = mySqlDataReader.GetOrdinal("a_make_exp");
          string s6 = mySqlDataReader.GetString(ordinal6);
          binaryWriter.Write(long.Parse(s6));
          int ordinal7 = mySqlDataReader.GetOrdinal("a_need_exp");
          string s7 = mySqlDataReader.GetString(ordinal7);
          binaryWriter.Write(long.Parse(s7));
          int ordinal8 = mySqlDataReader.GetOrdinal("a_nas");
          string s8 = mySqlDataReader.GetString(ordinal8);
          binaryWriter.Write(long.Parse(s8));
          int ordinal9 = mySqlDataReader.GetOrdinal("a_stuff");
          string[] strArray1 = mySqlDataReader.GetString(ordinal9).Split(' ');
          int ordinal10 = mySqlDataReader.GetOrdinal("a_stuff_cnt");
          string[] strArray2 = mySqlDataReader.GetString(ordinal10).Split(' ');
          ...
          foreach (string str2 in strArray1)
          {
            if (str2 != "")
            {
              numArray1[index1] = Convert.ToInt32(str2);
              ++index1;
            }
          }
          ...
          foreach (string str3 in strArray2)
          {
            if (str3 != "")
            {
              numArray2[index2] = Convert.ToInt32(str3);
              ++index2;
            }
          }
      ...
      else
      {
        ...
        BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
        int num = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_factory_item WHERE a_enable = 1");
        string str4 = "SELECT * FROM t_factory_item WHERE a_enable = 1 ORDER BY a_index";
        MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
        MySqlCommand command = mySqlConnection.CreateCommand();
        command.CommandText = str4;
        mySqlConnection.Open();
        ...
        while (mySqlDataReader.Read())
        {
          int ordinal11 = mySqlDataReader.GetOrdinal("a_index");
          string s9 = mySqlDataReader.GetString(ordinal11);
          binaryWriter.Write(int.Parse(s9));
          int ordinal12 = mySqlDataReader.GetOrdinal("a_name");
          string s10 = mySqlDataReader.GetString(ordinal12);
          binaryWriter.Write(Encoding.UTF8.GetBytes(s10).Length);
          binaryWriter.Write(Encoding.UTF8.GetBytes(s10));
          int ordinal13 = mySqlDataReader.GetOrdinal("a_seal_type");
          string s11 = mySqlDataReader.GetString(ordinal13);
          binaryWriter.Write(int.Parse(s11));
          int ordinal14 = mySqlDataReader.GetOrdinal("a_item_type");
          string s12 = mySqlDataReader.GetString(ordinal14);
          binaryWriter.Write(int.Parse(s12));
          int ordinal15 = mySqlDataReader.GetOrdinal("a_item_idx");
          string s13 = mySqlDataReader.GetString(ordinal15);
          binaryWriter.Write(int.Parse(s13));
          int ordinal16 = mySqlDataReader.GetOrdinal("a_make_exp");
          string s14 = mySqlDataReader.GetString(ordinal16);
          binaryWriter.Write(long.Parse(s14));
          int ordinal17 = mySqlDataReader.GetOrdinal("a_need_exp");
          string s15 = mySqlDataReader.GetString(ordinal17);
          binaryWriter.Write(long.Parse(s15));
          int ordinal18 = mySqlDataReader.GetOrdinal("a_nas");
          string s16 = mySqlDataReader.GetString(ordinal18);
          binaryWriter.Write(long.Parse(s16));
          int ordinal19 = mySqlDataReader.GetOrdinal("a_stuff");
          string[] strArray3 = mySqlDataReader.GetString(ordinal19).Split(' ');
          int ordinal20 = mySqlDataReader.GetOrdinal("a_stuff_cnt");
          string[] strArray4 = mySqlDataReader.GetString(ordinal20).Split(' ');
          ...
          foreach (string str5 in strArray3)
          {
            if (str5 != "")
            {
              numArray3[index4] = Convert.ToInt32(str5);
              ++index4;
            }
          }
          ...
          foreach (string str6 in strArray4)
          {
            if (str6 != "")
            {
              numArray4[index5] = Convert.ToInt32(str6);
              ++index5;
            }
          }
          for (int index6 = 0; index6 < 5; ++index6)
          {
            binaryWriter.Write(numArray3[index6]);
            binaryWriter.Write(numArray4[index6]);
          }
        }
        mySqlConnection.Close();
        binaryWriter.Close();
    ...
    public void ExportSkillTree_V4()
    {
      ...
      for (int index1 = 0; index1 < 9; ++index1)
      {
        ...
        {
          int num1 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_skill WHERE a_job = " + index1.ToString() + " AND a_job2 = " + index2.ToString());
          int num2 = (int) MessageBox.Show(num1.ToString());
          binaryWriter.Write(num1);
          string str = "SELECT * FROM t_skill WHERE a_job = " + index1.ToString() + " AND a_job2 = " + index2.ToString();
          MySqlConnection mySqlConnection = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
          MySqlCommand command = mySqlConnection.CreateCommand();
          command.CommandText = str;
          mySqlConnection.Open();
    ...
    public void ExportEvent_V4()
    {
      ...
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num1 = 9;
      int num2 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_event");
    ...
    public void ExportAffl_V4()
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Create(saveFileDialog.FileName));
      int num1 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_affinity");
      string str1 = "SELECT * FROM t_affinity WHERE a_enable=1 ORDER BY a_index";
      MySqlConnection mySqlConnection1 = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
      MySqlCommand command1 = mySqlConnection1.CreateCommand();
      command1.CommandText = str1;
      mySqlConnection1.Open();
      MySqlDataReader mySqlDataReader1 = command1.ExecuteReader();
      ...
      while (mySqlDataReader1.Read())
      {
        ...
        binaryWriter.Write(Encoding.UTF8.GetBytes(s2).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s2));
        int ordinal3 = mySqlDataReader1.GetOrdinal("a_maxvalue");
        string s3 = mySqlDataReader1.GetString(ordinal3);
        binaryWriter.Write(int.Parse(s3));
        int ordinal4 = mySqlDataReader1.GetOrdinal("a_enable");
        string s4 = mySqlDataReader1.GetString(ordinal4);
        binaryWriter.Write(int.Parse(s4));
        int ordinal5 = mySqlDataReader1.GetOrdinal("a_texture_id");
        string s5 = mySqlDataReader1.GetString(ordinal5);
        binaryWriter.Write(int.Parse(s5));
        int ordinal6 = mySqlDataReader1.GetOrdinal("a_texture_row");
        string s6 = mySqlDataReader1.GetString(ordinal6);
        binaryWriter.Write(int.Parse(s6));
        int ordinal7 = mySqlDataReader1.GetOrdinal("a_texture_col");
        string s7 = mySqlDataReader1.GetString(ordinal7);
        binaryWriter.Write(int.Parse(s7));
        int ordinal8 = mySqlDataReader1.GetOrdinal("a_nas");
        string s8 = mySqlDataReader1.GetString(ordinal8);
        binaryWriter.Write(int.Parse(s8));
        int ordinal9 = mySqlDataReader1.GetOrdinal("a_name_jpn");
        string s9 = mySqlDataReader1.GetString(ordinal9);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s9).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s9));
        int ordinal10 = mySqlDataReader1.GetOrdinal("a_name_mex");
        string s10 = mySqlDataReader1.GetString(ordinal10);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s10).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s10));
        int ordinal11 = mySqlDataReader1.GetOrdinal("a_name_brz");
        string s11 = mySqlDataReader1.GetString(ordinal11);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s11).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s11));
        int ordinal12 = mySqlDataReader1.GetOrdinal("a_needlevel");
        string s12 = mySqlDataReader1.GetString(ordinal12);
        binaryWriter.Write(int.Parse(s12));
        int ordinal13 = mySqlDataReader1.GetOrdinal("a_needitemidx");
        string s13 = mySqlDataReader1.GetString(ordinal13);
        binaryWriter.Write(int.Parse(s13));
        int ordinal14 = mySqlDataReader1.GetOrdinal("a_needitemcount");
        string s14 = mySqlDataReader1.GetString(ordinal14);
        binaryWriter.Write(int.Parse(s14));
        int ordinal15 = mySqlDataReader1.GetOrdinal("a_affinity_idx");
        string s15 = mySqlDataReader1.GetString(ordinal15);
        binaryWriter.Write(int.Parse(s15));
        int ordinal16 = mySqlDataReader1.GetOrdinal("a_affinity_value");
        string s16 = mySqlDataReader1.GetString(ordinal16);
        binaryWriter.Write(int.Parse(s16));
        int ordinal17 = mySqlDataReader1.GetOrdinal("a_name_ger");
        string s17 = mySqlDataReader1.GetString(ordinal17);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s17).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s17));
        int ordinal18 = mySqlDataReader1.GetOrdinal("a_name_spn");
        string s18 = mySqlDataReader1.GetString(ordinal18);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s18).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s18));
        int ordinal19 = mySqlDataReader1.GetOrdinal("a_name_frc");
        string s19 = mySqlDataReader1.GetString(ordinal19);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s19).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s19));
        int ordinal20 = mySqlDataReader1.GetOrdinal("a_name_rus");
        string s20 = mySqlDataReader1.GetString(ordinal20);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s20).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s20));
        int ordinal21 = mySqlDataReader1.GetOrdinal("a_name_hk_eng");
        string s21 = mySqlDataReader1.GetString(ordinal21);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s21).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s21));
        int ordinal22 = mySqlDataReader1.GetOrdinal("a_name_hk");
        string s22 = mySqlDataReader1.GetString(ordinal22);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s22).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s22));
        int ordinal23 = mySqlDataReader1.GetOrdinal("a_name_usa");
        string s23 = mySqlDataReader1.GetString(ordinal23);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s23).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s23));
        int ordinal24 = mySqlDataReader1.GetOrdinal("a_name_tur");
        string s24 = mySqlDataReader1.GetString(ordinal24);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s24).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s24));
        int ordinal25 = mySqlDataReader1.GetOrdinal("a_name_ita");
        string s25 = mySqlDataReader1.GetString(ordinal25);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s25).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s25));
        int ordinal26 = mySqlDataReader1.GetOrdinal("a_name_thai");
        string s26 = mySqlDataReader1.GetString(ordinal26);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s26).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s26));
        int ordinal27 = mySqlDataReader1.GetOrdinal("a_name_uk");
        string s27 = mySqlDataReader1.GetString(ordinal27);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s27).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s27));
        int ordinal28 = mySqlDataReader1.GetOrdinal("a_name_dev");
        string s28 = mySqlDataReader1.GetString(ordinal28);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s28).Length);
        binaryWriter.Write(Encoding.UTF8.GetBytes(s28));
        int num2 = this.databaseHandle.CountByRow(this.Host, this.User, this.Password, this.Database, "SELECT COUNT(*) FROM t_affinity_npc WHERE a_npcidx ='" + s1 + "'");
        binaryWriter.Write(num2);
        MySqlConnection mySqlConnection2 = new MySqlConnection("datasource=" + this.Host + ";Port=3306;User ID="  + this.User + ";Password=" + this.Password + ";Database=" + this.Database + ";Charset=utf8mb4;SslMode=Preferred;TlsVersion=Tls12;");
        string str2 = "SELECT * FROM t_affinity_npc WHERE a_npcidx='" + s1 + "' ORDER BY a_affinity_idx";
        MySqlCommand command2 = mySqlConnection2.CreateCommand();
        command2.CommandText = str2;
        mySqlConnection2.Open();
        MySqlDataReader mySqlDataReader2 = command2.ExecuteReader();
