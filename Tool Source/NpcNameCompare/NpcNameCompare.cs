...
// Type: LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare
...
#nullable disable
namespace LcDevPack_TeamDamonA.NpcNameCompare
{
  public class NpcNameCompare : Form
  {
    public static Connection connection = new Connection();
    private string Host = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.SqlHost;
    private string User = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.SqlUser;
    private string Password = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.SqlPassword;
    private string Database = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.SqlDatabase;
    private DatabaseHandle databaseHandle = new DatabaseHandle();
    public string _ClientPath = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.ClientPath;
    ...
    private string language = LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.connection.Settings.Language;
    ...
    private string StringFromLanguage()
    {
      ...
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_ger";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "POL")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_pld";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "BRA")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_brz";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "RUS")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_rus";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "FRA")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_frc";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "ESP")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_spn";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "MEX")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_mex";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "THA")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_thai";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (this.language == "ITA")
      {
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_ita";
        return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
      }
      if (!(this.language == "USA"))
        return (string) null;
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = "a_name_usa";
      return LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee;
    }

    public void SearchList(string searchString)
    {
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      string Query = "select a_index, " + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + " from t_npc WHERE " + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + " LIKE '%" + searchString + "%' ORDER BY a_index;";
      if (this.language == "GER")
    ...
    private void LoadListBox()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      string Query = "SELECT a_index, " + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + " FROM t_npc ORDER BY a_index;";
      if (this.language == "GER")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, Query);
      else if (this.language == "BRA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, Query);
    ...
    private void LoadListBox2()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayUSA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_name_usa FROM t_npc ORDER BY a_index;");
    ...
    private void LoadListBoxTHAI()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayTHA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_name_thai FROM t_npc ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxGER()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_name_ger FROM t_npc ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxESP()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayESP, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_name_spn FROM t_npc ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void LoadListBoxBRA()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee = this.StringFromLanguage();
      this.listBox2.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, "SELECT a_index, a_name_brz FROM t_npc ORDER BY a_index;");
      for (int index = 0; index < this.listBox2.Items.Count; ++index)
        this.MenuList.Add(this.listBox2.Items[index].ToString());
      this.listBox2.DataSource = (object) this.MenuList;
    }
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      string Query = "select a_index, " + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + " FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
      string[] rows = new string[2]
      {
        "a_index",
        LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee
      };
    ...
    private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (this.comboBox1.SelectedIndex == 0)
      {
        string Query = "select a_index, a_name_thai FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_name_thai"
      ...
      {
        string Query = "select a_index, a_name_usa FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_name_usa"
      ...
      {
        string Query = "select a_index, a_name_ger FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_name_ger"
      ...
      {
        string Query = "select a_index, a_name_spn FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_name_spn"
      ...
      {
        string Query = "select a_index, a_name_brz FROM t_npc WHERE a_index ='" + this.textBox6.Text + "';";
        string[] rows = new string[2]
        {
          "a_index",
          "a_name_brz"
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET " + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + "  = '" + str + "' WHERE a_index = '" + this.textBox6.Text + "'");
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "INSERT INTO t_npc (" + LcDevPack_TeamDamonA.NpcNameCompare.NpcNameCompare.namee + ") VALUES ('New String')");
      this.LoadListBox();
    ...
    private void button3_Click(object sender, EventArgs e)
    {
      ...
      {
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DROP TABLE IF EXISTS tempTable;CREATE TEMPORARY TABLE tempTable ENGINE=MEMORY SELECT * FROM t_npc WHERE a_index=" + this.textBox6.Text + ";SELECT a_index FROM tempTable;UPDATE tempTable SET a_index=(SELECT a_index from t_npc ORDER BY a_index DESC LIMIT 1)+1; SELECT a_index FROM tempTable;INSERT INTO t_npc SELECT * FROM tempTable;");
    ...
    private void button4_Click(object sender, EventArgs e)
    {
      if (MessageBox.Show("Do you want to Delete String " + this.textBox6.Text.Trim() + " ?", "Please confirm.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
      int selectedIndex = this.listBox1.SelectedIndex;
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_npc WHERE a_index = '" + this.textBox6.Text + "'");
      this.LoadListBox();
    ...
    private void InitializeComponent()
    {
      ...
      this.button1.Location = new Point(517, 90);
      ...
      this.Name = nameof (NpcNameCompare);
      this.Text = "LastChaos Npc Name Compare";
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      if (this.comboBox1.SelectedIndex == 0)
      {
        ...
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET a_name_thai = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 1)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET a_name_usa = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 2)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET a_name_ger = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 3)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET a_name_spn = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      if (this.comboBox1.SelectedIndex == 4)
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_npc SET a_name_brz = '" + this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "' WHERE a_index = '" + this.textBox2.Text + "'");
      }
      else
      {
        this.textBox3.Text.Replace("'", "\\'").Replace("\"", "\\\"");
