...
namespace SMCEditor4
{
  ...
  {
    private string titleBar = "SMC Editor 4.0 by wizatek";
    ...
    private ToolStripMenuItem copyRecordsFromOtherFileToolStripMenuItem;
    ...
    {
      if (this.lbList.SelectedIndex == -1)
        return;
      int id = int.Parse(this.lbList.SelectedItem.ToString().Split('-')[0]);
      int index = Smc.SMCFile.FindIndex((Predicate<tSmcRecords>) (p => p.ID.Equals(id)));
      if (index == -1)
        return;
    ...
    private void btnTexAdd_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        tTextures.TexID = Smc.SMCFile[index1].Models[index2].Textures.Max<tTextures>((Func<tTextures, int>) (p => p.TexID)) + 1;
      }
      catch
      {
        tTextures.TexID = 1;
      }
      tTextures.TextureName = "(new Name)";
      tTextures.TextureFile = "(new File)";
    ...
    private void InitializeComponent()
    {
      ...
      this.copyRecordsFromOtherFileToolStripMenuItem = new ToolStripMenuItem();
      ...
      this.loadFromDatabaseToolStripMenuItem.Size = new Size(180, 22);
      ...
      this.toolStripSeparator1.Size = new Size(111, 6);
      this.saveToolStripMenuItem.Name = "saveToolStripMenuItem";
      this.saveToolStripMenuItem.Size = new Size(114, 22);
      ...
      this.toolStripSeparator2.Size = new Size(111, 6);
      this.quitToolStripMenuItem.Name = "quitToolStripMenuItem";
      this.quitToolStripMenuItem.Size = new Size(114, 22);
      this.quitToolStripMenuItem.Text = "Quit";
      this.extraToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[1]
      {
        (ToolStripItem) this.copyRecordsFromOtherFileToolStripMenuItem
      });
      this.extraToolStripMenuItem.Name = "extraToolStripMenuItem";
      this.extraToolStripMenuItem.Size = new Size(44, 20);
      this.extraToolStripMenuItem.Text = "Extra";
      this.copyRecordsFromOtherFileToolStripMenuItem.Name = "copyRecordsFromOtherFileToolStripMenuItem";
      this.copyRecordsFromOtherFileToolStripMenuItem.Size = new Size(223, 22);
      this.copyRecordsFromOtherFileToolStripMenuItem.Text = "Copy records from other file";
      this.copyRecordsFromOtherFileToolStripMenuItem.Click += new EventHandler(this.copyRecordsFromOtherFileToolStripMenuItem_Click);
      ...
      this.splitContainer1.Panel2.Controls.Add((Control) this.btnReRead);
      ...
      this.btnReRead.Location = new Point(227, 438);
      this.btnReRead.Name = "btnReRead";
      this.btnReRead.Size = new Size(188, 23);
      this.btnReRead.TabIndex = 15;
      this.btnReRead.Text = "Reload SMC data from ItemAll";
      ...
      this.colTexFile.HeaderText = "File";
      ...
      this.colModFile.HeaderText = "File";
      ...
      this.ofd.Filter = "SMC.lod|smc.lod|All Files|*.*";
      ...
      this.Text = "SMC Editor 4.0 by wizatek ";
    ...
    {
      this.MenuList = Smc.Menu.FindAll(new Predicate<string>(this.SearchString));
      this.lbList.Items.Clear();
      this.lbList.Items.AddRange((object[]) this.MenuList.ToArray());
      this.status.Text = "Found " + this.MenuList.Count.ToString() + " items";
    }
    ...
    private void loadFromDatabaseToolStripMenuItem_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        Items.StringList = new List<StringContainer>();

        Encoding enc = Encoding.GetEncoding(Items.ISO);
        int loaded = 0;
        int skipped = 0;
        ...
        using (MySqlConnection connection = new MySqlConnection(connStr))
        {
          ...
          using (MySqlDataReader reader = cmd.ExecuteReader())
          {
            while (reader.Read())
            {
              ...
              Items.StringList.Add(new StringContainer()
              {
                Index = id,
                name = enc.GetBytes(name)
              });
            }
          }
        }
    ...
    private void openToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      if (versionSelect.ShowDialog() != DialogResult.OK)
        return;
      Items.Version = versionSelect.Version;
      if (this.ofd.ShowDialog() != DialogResult.OK || !Smc.ReadFile(this.ofd.FileName))
        return;
      this.openedFile = this.ofd.FileName;
      this.Text = this.titleBar + " [" + this.openedFile + "] ";
      string FileName1 = "";
      string FileName2 = "";
      foreach (string itemFile in Items.itemFiles)
      {
        if (File.Exists(Path.GetDirectoryName(this.openedFile) + "\\" + itemFile))
          FileName1 = Path.GetDirectoryName(this.openedFile) + "\\" + itemFile;
      }
      OpenFileDialog openFileDialog = new OpenFileDialog();
      openFileDialog.Title = " select strItem file";
      openFileDialog.Filter = "All Files|*.*";
      if (openFileDialog.ShowDialog() == DialogResult.OK)
        FileName2 = openFileDialog.FileName;
      if (FileName1 != string.Empty && FileName2 != string.Empty)
      {
        if (!Items.LoadFromFile(FileName1))
        {
          int num1 = (int) MessageBox.Show("Could not read items file, Wrong Version?");
        }
        else if (!Items.LoadSTRFromFile(FileName2))
        {
          int num2 = (int) MessageBox.Show("Could not read str file, Wrong Version?");
        }
        else
        {
          Smc.MakeList();
      ...
      {
        int num3 = (int) MessageBox.Show("Item file not found!\r\nItem Reference not loaded");
      }
    }
    ...
    private void saveAsToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      {
        int num1 = (int) MessageBox.Show("File Saved!");
      }
      else
      {
    ...
    {
      if (Smc.WriteFile(this.openedFile))
      {
        int num1 = (int) MessageBox.Show("File Saved!");
      }
      else
