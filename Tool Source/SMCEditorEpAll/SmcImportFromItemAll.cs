...
// Type: SMCEditor4.SmcImportFromItemAll
...
namespace SMCEditor4
{
  public class SmcImportFromItemAll : Form
  {
    ...
    private void btnUse_Click(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index < this.lbItems.CheckedIndices.Count; ++index)
      {
        ...
        if (id != -1)
        {
          ...
          this.SMCDATA.Add(this.ConvertToBin(SMCReader.ReadFile(smcPath.Replace("\0", string.Empty)), id));
        }
      }
    }
    ...
    private tSmcRecords ConvertToBin(List<smcMesh> curData, int ItemID)
    {
      ...
      try
      {
        bin.Name = curData[0].meshname;
      }
      catch
      {
        bin.Name = "";
      }
      bin.Models = new List<tModels>();
    ...
    private string GetSmcPath(int ItemID)
    {
      ...
      int index1 = Items.ItemList.FindIndex((Predicate<ItemContainer>) (p => p.ItemID.Equals(ItemID)));
      if (index1 != -1)
    ...
    private void InitializeComponent()
    {
      ...
      this.Text = nameof (SmcImportFromItemAll);
      this.Load += new EventHandler(this.SmcImportFromItemAll_Load);
    ...
    private void lbItems_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      this.tbSmcFile.Text = smcPath;
      this.data = SMCReader.ReadFile(smcPath.Replace("\0", string.Empty));
    ...
    private void MakeList()
    {
      ...
      this.lbItems.Items.AddRange((object[]) Items.Menu.ToArray());
    }
    ...
    private void SmcImportFromItemAll_Load(object sender, EventArgs e)
    {
    }
  }
}
