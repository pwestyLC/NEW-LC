...
namespace LcDevPack_TeamDamonA.Tools
{
  public class BigPetEditor : Form
  {
    ...
    private string Host = BigPetEditor.connection.Settings.SqlHost;
    private string User = BigPetEditor.connection.Settings.SqlUser;
    private string Password = BigPetEditor.connection.Settings.SqlPassword;
    private string Database = BigPetEditor.connection.Settings.SqlDatabase;
    private DatabaseHandle databaseHandle = new DatabaseHandle();
    public string _ClientPath = BigPetEditor.connection.Settings.ClientPath;
    ...
    public BigPetEditor() => this.InitializeComponent();
    ...
    {
      this._Device2.SetTransform(TransformState.Projection, Matrix.PerspectiveFovLH(100f, 1f, 1f, 450f));
      this._Device2.SetTransform(TransformState.View, Matrix.LookAtLH(new Vector3(0.0f, 0.0f, -5f), new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 1f, 0.0f)));
      this._Device2.SetTransform(TransformState.World, Matrix.RotationYawPitchRoll(0.0f, 0.0f, 0.0f));
    }
    ...
    {
      this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_index, a_name from t_attack_pet ORDER BY a_index;");
    }
    ...
    public void SearchList(string searchString)
    {
      ...
      this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_index, a_name from t_attack_pet WHERE a_name LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
    }
    ...
    {
      string Query = "select a_index, a_texture_id, a_texture_row, a_texture_col FROM t_item WHERE a_index ='" + this.textBox9.Text + "';";
      ...
      this.textBox201.Text = strArray[1];
      this.textBox202.Text = strArray[2];
      this.textBox203.Text = strArray[3];
    }

    private void ClearPicture()
    {
      if (!(this.textBox201.Text == ""))
        return;
    ...
    private void BigPetEditor_Load(object sender, EventArgs e)
    {
      ...
      {
        int num = (int) MessageBox.Show("test", ex.Message);
      }
      this.LoadListBox();
      this.LoadStartupString();
      this.SelectBoxes();
      this.IconPet();
      this.ClearPicture();
    }

    private void ResetTextComboBox()
    {
    ...
    private void listBox1_SelectedIndexChanged_1(object sender, EventArgs e)
    {
      ...
      string Query = "SELECT * FROM t_attack_pet WHERE a_index ='" + this.textBox1.Text + "';";
      ...
      Query.Replace("'", "\\'").Replace("\\", "\\\\").Replace("'", "\\'");
      string[] strArray = this.databaseHandle.SelectMySqlReturnArray(this.Host, this.User, this.Password, this.Database, Query, rows);
      if (this.chk3D.Checked && File.Exists(this._ClientPath + strArray[34]))
      {
        Console.WriteLine("Create Model > " + this._ClientPath + strArray[34]);
        this.MakeLCModels(this._ClientPath + strArray[34]);
      }
      this.textBox2.Text = strArray[0];
      this.tbEnable.Text = strArray[1];
      this.textBox4.Text = strArray[2];
      this.textBox5.Text = strArray[3];
      this.textBox6.Text = strArray[4];
      this.textBox7.Text = strArray[5];
      this.textBox8.Text = strArray[6];
      this.textBox9.Text = strArray[7];
      this.textBox10.Text = strArray[8];
      this.textBox11.Text = strArray[9];
      this.textBox14.Text = strArray[10];
      this.textBox15.Text = strArray[11];
      this.textBox12.Text = strArray[12];
      this.textBox13.Text = strArray[13];
      this.textBox17.Text = strArray[14];
      this.textBox18.Text = strArray[15];
      this.textBox22.Text = strArray[16];
      ...
      this.textBox25.Text = strArray[21];
      this.textBox26.Text = strArray[22];
      this.textBox24.Text = strArray[23];
      this.textBox27.Text = strArray[24];
      this.textBox28.Text = strArray[25];
      this.textBox38.Text = strArray[26];
      this.textBox35.Text = strArray[27];
      this.textBox32.Text = strArray[28];
      this.textBox36.Text = strArray[29];
      this.textBox33.Text = strArray[30];
      this.textBox37.Text = strArray[31];
      this.textBox34.Text = strArray[32];
      this.textBox29.Text = strArray[33];
      this.textBox16.Text = strArray[34];
      this.textBox46.Text = strArray[35];
      this.textBox40.Text = strArray[36];
      this.textBox41.Text = strArray[37];
      this.textBox39.Text = strArray[38];
      this.textBox30.Text = strArray[39];
      this.textBox43.Text = strArray[40];
      this.textBox44.Text = strArray[41];
      this.textBox63.Text = strArray[42];
      this.textBox45.Text = strArray[43];
      this.textBox42.Text = strArray[44];
      this.textBox31.Text = strArray[45];
      this.textBox52.Text = strArray[46];
      this.textBox53.Text = strArray[47];
      this.textBox50.Text = strArray[48];
      this.textBox47.Text = strArray[49];
      this.textBox51.Text = strArray[50];
      this.textBox49.Text = strArray[51];
      this.textBox54.Text = strArray[52];
      this.textBox48.Text = strArray[53];
      this.textBox58.Text = strArray[54];
      this.textBox64.Text = strArray[55];
      this.textBox56.Text = strArray[56];
      this.textBox57.Text = strArray[57];
      this.textBox55.Text = strArray[58];
      this.textBox61.Text = strArray[59];
      this.textBox62.Text = strArray[60];
      this.textBox59.Text = strArray[61];
      this.textBox60.Text = strArray[62];
      this.IconPet();
      this.ClearPicture();
      this.SelectBoxes();
      this.ResetTextComboBox();
      try
      {
        this.pictureBox1.Image = (Image) this.databaseHandle.IconItem(int.Parse(this.textBox201.Text), int.Parse(this.textBox202.Text), int.Parse(this.textBox203.Text));
      }
      catch
      {
      }
    ...
    {
      this.checkBox1.Checked = this.tbEnable.Text == "1";
      this.comboBox1.SelectedIndex = this.comboBox1.FindString(this.textBox4.Text);
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (BigPetEditor));
      this.menuStrip1 = new MenuStrip();
      this.fileExportToolStripMenuItem = new ToolStripMenuItem();
      this.exportBipetlodToolStripMenuItem = new ToolStripMenuItem();
      ...
      this.menuStrip1.Size = new Size(853, 24);
      this.menuStrip1.TabIndex = 1;
      this.menuStrip1.Text = "menuStrip1";
      this.fileExportToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[1]
      {
        (ToolStripItem) this.exportBipetlodToolStripMenuItem
      });
      ...
      this.exportBipetlodToolStripMenuItem.Size = new Size(157, 22);
      this.exportBipetlodToolStripMenuItem.Text = "Export bipet.lod";
      this.exportBipetlodToolStripMenuItem.Click += new EventHandler(this.exportBipetlodToolStripMenuItem_Click);
      this.label3.AutoSize = true;
      this.label3.Location = new Point(524, 7);
      ...
      this.textBox3.Location = new Point(573, 4);
      this.textBox3.Name = "textBox3";
      this.textBox3.Size = new Size(46, 20);
      ...
      this.tabControl1.Size = new Size(853, 519);
      ...
      this.tabPage1.Controls.Add((Control) this.textBox203);
      this.tabPage1.Controls.Add((Control) this.textBox29);
      this.tabPage1.Controls.Add((Control) this.label37);
      this.tabPage1.Controls.Add((Control) this.textBox202);
      this.tabPage1.Controls.Add((Control) this.label39);
      this.tabPage1.Controls.Add((Control) this.textBox201);
      this.tabPage1.Controls.Add((Control) this.textBox32);
      this.tabPage1.Controls.Add((Control) this.pictureBox1);
      this.tabPage1.Controls.Add((Control) this.groupBox4);
      this.tabPage1.Controls.Add((Control) this.textBox35);
      ...
      this.tabPage1.Controls.Add((Control) this.textBox36);
      ...
      this.tabPage1.Controls.Add((Control) this.textBox33);
      this.tabPage1.Controls.Add((Control) this.label38);
      this.tabPage1.Controls.Add((Control) this.textBox34);
      this.tabPage1.Controls.Add((Control) this.textBox37);
      this.tabPage1.Controls.Add((Control) this.textBox38);
      this.tabPage1.Controls.Add((Control) this.label35);
      this.tabPage1.Location = new Point(4, 25);
      this.tabPage1.Name = "tabPage1";
      this.tabPage1.Padding = new Padding(3);
      this.tabPage1.Size = new Size(845, 490);
      ...
      this.PbSelectID1.Location = new Point(773, 11);
      ...
      this.groupBox20.Location = new Point(562, 35);
      ...
      this.button4.Location = new Point(762, 465);
      ...
      this.groupBox4.Controls.Add((Control) this.textBox26);
      ...
      this.groupBox4.Location = new Point(256, 114);
      this.groupBox4.Name = "groupBox4";
      this.groupBox4.Size = new Size(319, 344);
      this.groupBox4.TabIndex = 67;
      this.groupBox4.TabStop = false;
      this.groupBox4.Text = "Habilities";
      this.textBox27.BorderStyle = BorderStyle.FixedSingle;
      this.textBox27.Location = new Point(81, 313);
      this.textBox27.Name = "textBox27";
      this.textBox27.Size = new Size(68, 20);
      ...
      this.textBox28.Location = new Point(233, 313);
      this.textBox28.Name = "textBox28";
      this.textBox28.Size = new Size(68, 20);
      ...
      this.textBox24.Location = new Point(81, 287);
      this.textBox24.Name = "textBox24";
      this.textBox24.Size = new Size(68, 20);
      ...
      this.textBox25.Location = new Point(81, 235);
      this.textBox25.Name = "textBox25";
      this.textBox25.Size = new Size(68, 20);
      ...
      this.textBox26.Location = new Point(81, 261);
      this.textBox26.Name = "textBox26";
      this.textBox26.Size = new Size(68, 20);
      ...
      this.textBox23.Location = new Point(233, 287);
      this.textBox23.Name = "textBox23";
      this.textBox23.Size = new Size(68, 20);
      ...
      this.textBox19.Location = new Point(233, 209);
      this.textBox19.Name = "textBox19";
      this.textBox19.Size = new Size(68, 20);
      ...
      this.textBox20.Location = new Point(233, 235);
      this.textBox20.Name = "textBox20";
      this.textBox20.Size = new Size(68, 20);
      ...
      this.textBox21.Location = new Point(233, 261);
      this.textBox21.Name = "textBox21";
      this.textBox21.Size = new Size(68, 20);
      ...
      this.textBox22.Location = new Point(81, 209);
      this.textBox22.Name = "textBox22";
      this.textBox22.Size = new Size(68, 20);
      ...
      this.textBox18.Location = new Point(233, 131);
      this.textBox18.Name = "textBox18";
      this.textBox18.Size = new Size(68, 20);
      ...
      this.textBox17.Location = new Point(233, 157);
      this.textBox17.Name = "textBox17";
      this.textBox17.Size = new Size(68, 20);
      ...
      this.textBox13.Location = new Point(233, 105);
      this.textBox13.Name = "textBox13";
      this.textBox13.Size = new Size(68, 20);
      ...
      this.textBox12.Location = new Point(233, 79);
      this.textBox12.Name = "textBox12";
      this.textBox12.Size = new Size(68, 20);
      ...
      this.textBox11.Location = new Point(81, 157);
      this.textBox11.Name = "textBox11";
      this.textBox11.Size = new Size(68, 20);
      ...
      this.textBox15.Location = new Point(81, 105);
      this.textBox15.Name = "textBox15";
      this.textBox15.Size = new Size(68, 20);
      ...
      this.textBox14.Location = new Point(81, 79);
      this.textBox14.Name = "textBox14";
      this.textBox14.Size = new Size(68, 20);
      ...
      this.textBox10.Location = new Point(81, 131);
      this.textBox10.Name = "textBox10";
      this.textBox10.Size = new Size(68, 20);
      ...
      this.textBox8.Location = new Point(252, 53);
      ...
      this.textBox7.Location = new Point(195, 53);
      this.textBox7.Name = "textBox7";
      this.textBox7.Size = new Size(49, 20);
      ...
      this.textBox6.Location = new Point(139, 53);
      ...
      this.textBox5.Location = new Point(81, 53);
      this.textBox5.Name = "textBox5";
      this.textBox5.Size = new Size(49, 20);
      ...
      this.textBox35.Location = new Point(769, 401);
      this.textBox35.Name = "textBox35";
      this.textBox35.Size = new Size(68, 20);
      ...
      this.textBox36.Location = new Point(769, 427);
      this.textBox36.Name = "textBox36";
      this.textBox36.Size = new Size(68, 20);
      ...
      this.groupBox3.Location = new Point(265, 2);
      this.groupBox3.Name = "groupBox3";
      this.groupBox3.Size = new Size(292, 110);
      this.groupBox3.TabIndex = 66;
      this.groupBox3.TabStop = false;
      this.groupBox3.Text = "Basic";
      this.textBox4.Location = new Point(165, 9);
      ...
      this.checkBox1.Location = new Point(93, 31);
      ...
      this.label5.Location = new Point(158, 32);
      ...
      this.comboBox1.Location = new Point(198, 29);
      ...
      this.label4.Location = new Point(6, 33);
      ...
      this.textBox2.Location = new Point(48, 66);
      this.textBox2.Name = "textBox2";
      this.textBox2.Size = new Size(225, 20);
      ...
      this.textBox1.Location = new Point(48, 30);
      this.textBox1.Name = "textBox1";
      this.textBox1.Size = new Size(36, 20);
      ...
      this.groupBox2.Location = new Point(2, 72);
      this.groupBox2.Name = "groupBox2";
      this.groupBox2.Size = new Size(257, 421);
      this.groupBox2.TabIndex = 65;
      this.groupBox2.TabStop = false;
      this.groupBox2.Text = "Pets";
      this.button3.FlatStyle = FlatStyle.Flat;
      this.button3.Location = new Point(170, 393);
      ...
      this.button2.Location = new Point(87, 393);
      ...
      this.button1.Location = new Point(6, 393);
      ...
      this.label34.Location = new Point(575, 352);
      ...
      this.textBox33.Location = new Point(617, 350);
      this.textBox33.Name = "textBox33";
      this.textBox33.Size = new Size(68, 20);
      this.textBox33.TabIndex = 85;
      this.textBox33.KeyPress += new KeyPressEventHandler(this.textBox33_KeyPress);
      this.label38.AutoSize = true;
      this.label38.Location = new Point(699, 352);
      ...
      this.textBox34.Location = new Point(769, 375);
      this.textBox34.Name = "textBox34";
      this.textBox34.Size = new Size(68, 20);
      ...
      this.textBox37.Location = new Point(769, 349);
      this.textBox37.Name = "textBox37";
      this.textBox37.Size = new Size(68, 20);
      ...
      this.textBox38.Location = new Point(617, 402);
      this.textBox38.Name = "textBox38";
      this.textBox38.Size = new Size(68, 20);
      this.textBox38.TabIndex = 75;
      this.textBox38.KeyPress += new KeyPressEventHandler(this.textBox38_KeyPress);
      this.label35.AutoSize = true;
      this.label35.Location = new Point(699, 376);
      ...
      this.tabPage2.Size = new Size(845, 490);
      this.tabPage2.TabIndex = 1;
      this.tabPage2.Text = "Animations Edit";
      this.tabPage2.UseVisualStyleBackColor = true;
      this.groupBox7.Controls.Add((Control) this.label51);
      this.groupBox7.Controls.Add((Control) this.textBox64);
      this.groupBox7.Controls.Add((Control) this.textBox51);
      this.groupBox7.Controls.Add((Control) this.label65);
      this.groupBox7.Controls.Add((Control) this.textBox49);
      this.groupBox7.Controls.Add((Control) this.label49);
      this.groupBox7.Controls.Add((Control) this.textBox54);
      this.groupBox7.Controls.Add((Control) this.label54);
      this.groupBox7.Controls.Add((Control) this.textBox55);
      this.groupBox7.Controls.Add((Control) this.label56);
      this.groupBox7.Controls.Add((Control) this.textBox59);
      this.groupBox7.Controls.Add((Control) this.textBox57);
      this.groupBox7.Controls.Add((Control) this.textBox48);
      ...
      this.groupBox7.Controls.Add((Control) this.textBox61);
      this.groupBox7.Controls.Add((Control) this.label62);
      this.groupBox7.Controls.Add((Control) this.textBox60);
      this.groupBox7.Controls.Add((Control) this.textBox58);
      this.groupBox7.Controls.Add((Control) this.label61);
      this.groupBox7.Controls.Add((Control) this.label59);
      this.groupBox7.Controls.Add((Control) this.textBox56);
      this.groupBox7.Controls.Add((Control) this.label57);
      this.groupBox7.Controls.Add((Control) this.label63);
      this.groupBox7.Controls.Add((Control) this.textBox62);
      this.groupBox7.Location = new Point(489, 6);
      this.groupBox7.Name = "groupBox7";
      this.groupBox7.Size = new Size(350, 208);
      ...
      this.textBox64.Location = new Point(229, 71);
      this.textBox64.Name = "textBox64";
      this.textBox64.Size = new Size(107, 20);
      ...
      this.textBox51.Location = new Point(64, 175);
      this.textBox51.Name = "textBox51";
      this.textBox51.Size = new Size(271, 20);
      this.textBox51.TabIndex = 65;
      this.textBox51.KeyPress += new KeyPressEventHandler(this.textBox51_KeyPress);
      this.label65.AutoSize = true;
      this.label65.Location = new Point(176, 75);
      ...
      this.textBox49.Location = new Point(50, 19);
      this.textBox49.Name = "textBox49";
      this.textBox49.Size = new Size(120, 20);
      ...
      this.textBox54.Location = new Point(50, 45);
      this.textBox54.Name = "textBox54";
      this.textBox54.Size = new Size(120, 20);
      ...
      this.textBox55.Location = new Point(211, 45);
      this.textBox55.Name = "textBox55";
      this.textBox55.Size = new Size(125, 20);
      this.textBox55.TabIndex = 85;
      this.textBox55.KeyPress += new KeyPressEventHandler(this.textBox55_KeyPress);
      this.label56.AutoSize = true;
      this.label56.Location = new Point(176, 47);
      ...
      this.textBox59.Location = new Point(251, 123);
      this.textBox59.Name = "textBox59";
      this.textBox59.Size = new Size(84, 20);
      ...
      this.textBox57.Location = new Point(211, 19);
      this.textBox57.Name = "textBox57";
      this.textBox57.Size = new Size(125, 20);
      ...
      this.textBox61.Location = new Point(228, 97);
      this.textBox61.Name = "textBox61";
      this.textBox61.Size = new Size(107, 20);
      this.textBox61.TabIndex = 89;
      this.textBox61.KeyPress += new KeyPressEventHandler(this.textBox61_KeyPress);
      this.label62.AutoSize = true;
      this.label62.Location = new Point(176, 104);
      ...
      this.textBox60.Location = new Point(229, 149);
      this.textBox60.Name = "textBox60";
      this.textBox60.Size = new Size(106, 20);
      ...
      this.textBox58.Location = new Point(64, 97);
      this.textBox58.Name = "textBox58";
      this.textBox58.Size = new Size(106, 20);
      this.textBox58.TabIndex = 79;
      this.textBox58.KeyPress += new KeyPressEventHandler(this.textBox58_KeyPress);
      this.label61.AutoSize = true;
      this.label61.Location = new Point(176, 151);
      ...
      this.textBox56.Location = new Point(64, 123);
      this.textBox56.Name = "textBox56";
      this.textBox56.Size = new Size(106, 20);
      ...
      this.textBox62.Location = new Point(64, 149);
      this.textBox62.Name = "textBox62";
      this.textBox62.Size = new Size(106, 20);
      ...
      this.groupBox6.Controls.Add((Control) this.textBox44);
      ...
      this.groupBox6.Controls.Add((Control) this.textBox63);
      this.groupBox6.Controls.Add((Control) this.label45);
      this.groupBox6.Controls.Add((Control) this.textBox50);
      this.groupBox6.Controls.Add((Control) this.label64);
      this.groupBox6.Controls.Add((Control) this.textBox43);
      this.groupBox6.Controls.Add((Control) this.label52);
      this.groupBox6.Controls.Add((Control) this.textBox30);
      this.groupBox6.Controls.Add((Control) this.label40);
      this.groupBox6.Controls.Add((Control) this.textBox53);
      this.groupBox6.Controls.Add((Control) this.label55);
      this.groupBox6.Controls.Add((Control) this.textBox39);
      this.groupBox6.Controls.Add((Control) this.label31);
      this.groupBox6.Controls.Add((Control) this.textBox45);
      this.groupBox6.Controls.Add((Control) this.textBox42);
      ...
      this.groupBox6.Controls.Add((Control) this.textBox31);
      this.groupBox6.Controls.Add((Control) this.textBox52);
      this.groupBox6.Controls.Add((Control) this.label53);
      this.groupBox6.Location = new Point(8, 6);
      this.groupBox6.Name = "groupBox6";
      this.groupBox6.Size = new Size(359, 207);
      this.groupBox6.TabIndex = 63;
      this.groupBox6.TabStop = false;
      this.groupBox6.Text = "Animations 1";
      this.textBox16.BorderStyle = BorderStyle.FixedSingle;
      this.textBox16.Location = new Point(59, 175);
      this.textBox16.Name = "textBox16";
      this.textBox16.Size = new Size(290, 20);
      ...
      this.textBox44.Location = new Point(59, 97);
      this.textBox44.Name = "textBox44";
      this.textBox44.Size = new Size(106, 20);
      ...
      this.textBox47.Location = new Point(224, 148);
      this.textBox47.Name = "textBox47";
      this.textBox47.Size = new Size(125, 20);
      this.textBox47.TabIndex = 77;
      this.textBox47.KeyPress += new KeyPressEventHandler(this.textBox47_KeyPress);
      this.label48.AutoSize = true;
      this.label48.Location = new Point(171, 151);
      ...
      this.textBox63.Location = new Point(224, 71);
      this.textBox63.Name = "textBox63";
      this.textBox63.Size = new Size(125, 20);
      this.textBox63.TabIndex = 95;
      this.textBox63.TextChanged += new EventHandler(this.textBox63_TextChanged);
      ...
      this.textBox50.Location = new Point(247, 123);
      ...
      this.label64.Location = new Point(171, 73);
      ...
      this.textBox43.Location = new Point(59, 71);
      this.textBox43.Name = "textBox43";
      this.textBox43.Size = new Size(106, 20);
      this.textBox43.TabIndex = 49;
      this.textBox43.KeyPress += new KeyPressEventHandler(this.textBox43_KeyPress);
      this.label52.AutoSize = true;
      this.label52.Location = new Point(171, 125);
      ...
      this.textBox30.Location = new Point(45, 45);
      ...
      this.textBox53.Location = new Point(59, 149);
      this.textBox53.Name = "textBox53";
      this.textBox53.Size = new Size(106, 20);
      ...
      this.textBox39.Location = new Point(45, 19);
      this.textBox39.Name = "textBox39";
      this.textBox39.Size = new Size(120, 20);
      ...
      this.textBox45.Location = new Point(59, 123);
      this.textBox45.Name = "textBox45";
      this.textBox45.Size = new Size(106, 20);
      ...
      this.textBox42.Location = new Point(209, 19);
      this.textBox42.Name = "textBox42";
      this.textBox42.Size = new Size(140, 20);
      this.textBox42.TabIndex = 51;
      this.textBox42.KeyPress += new KeyPressEventHandler(this.textBox42_KeyPress);
      this.label43.AutoSize = true;
      this.label43.Location = new Point(171, 21);
      ...
      this.label32.Location = new Point(171, 47);
      ...
      this.textBox31.Location = new Point(209, 45);
      this.textBox31.Name = "textBox31";
      this.textBox31.Size = new Size(140, 20);
      ...
      this.textBox52.Location = new Point(228, 98);
      this.textBox52.Name = "textBox52";
      this.textBox52.Size = new Size(121, 20);
      this.textBox52.TabIndex = 71;
      this.textBox52.KeyPress += new KeyPressEventHandler(this.textBox52_KeyPress);
      this.label53.AutoSize = true;
      this.label53.Location = new Point(171, 99);
      ...
      this.groupBox5.Controls.Add((Control) this.textBox46);
      this.groupBox5.Controls.Add((Control) this.textBox40);
      this.groupBox5.Controls.Add((Control) this.label41);
      this.groupBox5.Controls.Add((Control) this.textBox41);
      this.groupBox5.Controls.Add((Control) this.label42);
      this.groupBox5.Location = new Point(8, 219);
      this.groupBox5.Name = "groupBox5";
      this.groupBox5.Size = new Size(144, 208);
      ...
      this.textBox46.Location = new Point(105, 35);
      this.textBox46.Name = "textBox46";
      this.textBox46.Size = new Size(33, 20);
      ...
      this.textBox40.Location = new Point(105, 61);
      this.textBox40.Name = "textBox40";
      this.textBox40.Size = new Size(33, 20);
      ...
      this.textBox41.Location = new Point(105, 87);
      this.textBox41.Name = "textBox41";
      this.textBox41.Size = new Size(33, 20);
      ...
      this.tbEnable.BorderStyle = BorderStyle.FixedSingle;
      this.tbEnable.Location = new Point(573, 4);
      this.tbEnable.Name = "tbEnable";
      this.tbEnable.Size = new Size(46, 20);
      this.tbEnable.TabIndex = 8;
      this.tbEnable.Visible = false;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(853, 543);
      ...
      this.Name = nameof (BigPetEditor);
      this.Text = nameof (BigPetEditor);
      this.Load += new EventHandler(this.BigPetEditor_Load);
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "INSERT INTO t_attack_pet DEFAULT VALUES");
      this.LoadListBox();
    ...
    private void button3_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_attack_pet WHERE a_index = '" + this.textBox1.Text + "'");
      this.LoadListBox();
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DROP TABLE IF EXISTS tempTable;CREATE TEMPORARY TABLE tempTable ENGINE=MEMORY SELECT * FROM t_attack_pet WHERE a_index=" + this.textBox1.Text + ";SELECT a_index FROM tempTable;UPDATE tempTable SET a_index=(SELECT a_index from t_attack_pet ORDER BY a_index DESC LIMIT 1)+1; SELECT a_index FROM tempTable;INSERT INTO t_attack_pet SELECT * FROM tempTable;");
      this.LoadListBox();
      this.listBox1.SelectedIndex = this.listBox1.Items.Count - 1;
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_attack_pet SET a_index = '" + this.textBox1.Text + "', a_enable = '" + this.tbEnable.Text + "', a_name = '" + this.textBox2.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "', a_type = '" + this.comboBox1.Text + "', a_str = '" + this.textBox5.Text + "', a_con = '" + this.textBox8.Text + "', a_dex = '" + this.textBox6.Text + "', a_int = '" + this.textBox7.Text + "', a_item_idx = '" + this.textBox9.Text + "', a_maxFaith = '" + this.textBox10.Text + "', a_maxStm = '" + this.textBox11.Text + "', a_maxHP = '" + this.textBox14.Text + "', a_maxMP = '" + this.textBox15.Text + "', a_recoverHP = '" + this.textBox12.Text + "', a_recoverMP = '" + this.textBox13.Text + "', a_delay = '" + this.textBox17.Text + "', a_AISlot = '" + this.textBox18.Text + "', a_after_dead = '" + this.textBox22.Text + "', a_attack = '" + this.textBox19.Text + "', a_defence = '" + this.textBox20.Text + "', a_Mattack = '" + this.textBox21.Text + "', a_Mdefence = '" + this.textBox23.Text + "', a_hitpoint = '" + this.textBox25.Text + "', a_avoidpoint = '" + this.textBox26.Text + "', a_Mavoidpoint = '" + this.textBox24.Text + "', a_attackSpeed = '" + this.textBox27.Text + "', a_deadly = '" + this.textBox28.Text + "', a_critical = '" + this.textBox38.Text + "', a_awful = '" + this.textBox35.Text + "', a_strong = '" + this.textBox32.Text + "', a_normal = '" + this.textBox36.Text + "', a_week = '" + this.textBox33.Text + "', a_bagic_skill1 = '" + this.textBox37.Text + "', a_bagic_skill2 = '" + this.textBox34.Text + "', a_flag = '" + this.textBox29.Text + "', a_trans_type = '" + this.textBox46.Text + "', a_trans_start = '" + this.textBox40.Text + "', a_trans_end = '" + this.textBox41.Text + "', a_smcFileName_1 = '" + this.textBox16.Text.Replace("'", "\\'").Replace("\\", "\\\\").Replace("'", "\\'") + "', a_ani_idle1_1 = '" + this.textBox39.Text + "', a_ani_idle2_1 = '" + this.textBox30.Text + "', a_ani_attack1_1 = '" + this.textBox43.Text + "', a_ani_attack2_1 = '" + this.textBox44.Text + "', a_ani_damage_1 = '" + this.textBox63.Text + "', a_ani_die_1 = '" + this.textBox45.Text + "', a_ani_walk_1 = '" + this.textBox42.Text + "', a_ani_run_1 = '" + this.textBox31.Text + "', a_ani_levelup_1 = '" + this.textBox52.Text + "', a_mount_1 = '" + this.textBox53.Text + "', a_summon_skill_1 = '" + this.textBox50.Text + "', a_speed_1 = '" + this.textBox47.Text + "', a_smcFileName_2 = '" + this.textBox51.Text.Replace("'", "\\'").Replace("\\", "\\\\").Replace("'", "\\'") + "', a_ani_idle1_2 = '" + this.textBox49.Text + "', a_ani_idle2_2 = '" + this.textBox54.Text + "', a_ani_attack1_2 = '" + this.textBox48.Text + "', a_ani_attack2_2 = '" + this.textBox58.Text + "', a_ani_damage_2 = '" + this.textBox64.Text + "', a_ani_die_2 = '" + this.textBox56.Text + "', a_ani_walk_2 = '" + this.textBox5.Text + "', a_ani_run_2 = '" + this.textBox55.Text + "', a_ani_levelup_2 = '" + this.textBox61.Text + "', a_mount_2 = '" + this.textBox62.Text + "', a_summon_skill_2 = '" + this.textBox59.Text + "', a_speed_2 = '" + this.textBox60.Text + "' WHERE a_index = '" + this.textBox1.Text + "'");
      int selectedIndex = this.listBox1.SelectedIndex;
    ...
    {
      this.textBox4.Text = this.GetIndexByComboBox(this.comboBox1.Text).ToString();
    }
    ...
    {
      this.textBox5.BackColor = Color.PaleTurquoise;
    }

    private void textBox6_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox6.BackColor = Color.PaleTurquoise;
    }

    private void textBox7_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox7.BackColor = Color.PaleTurquoise;
    }

    private void textBox8_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox8.BackColor = Color.PaleTurquoise;
    }
    ...
    {
      this.textBox15.BackColor = Color.PaleTurquoise;
    }
    ...
    {
      this.textBox13.BackColor = Color.PaleTurquoise;
    }

    private void textBox18_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox18.BackColor = Color.PaleTurquoise;
    }

    private void textBox17_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox17.BackColor = Color.PaleTurquoise;
    }

    private void textBox22_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox22.BackColor = Color.PaleTurquoise;
    }

    private void textBox25_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox25.BackColor = Color.PaleTurquoise;
    }

    private void textBox26_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox26.BackColor = Color.PaleTurquoise;
    }

    private void textBox24_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox24.BackColor = Color.PaleTurquoise;
    }

    private void textBox27_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox27.BackColor = Color.PaleTurquoise;
    }

    private void textBox19_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox19.BackColor = Color.PaleTurquoise;
    }

    private void textBox20_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox20.BackColor = Color.PaleTurquoise;
    }

    private void textBox21_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox21.BackColor = Color.PaleTurquoise;
    }

    private void textBox23_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox23.BackColor = Color.PaleTurquoise;
    }

    private void textBox28_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox28.BackColor = Color.PaleTurquoise;
    }

    private void textBox33_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox33.BackColor = Color.PaleTurquoise;
    }

    private void textBox29_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox29.BackColor = Color.PaleTurquoise;
    }

    private void textBox38_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox38.BackColor = Color.PaleTurquoise;
    }

    private void textBox32_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox32.BackColor = Color.PaleTurquoise;
    }

    private void textBox37_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox37.BackColor = Color.PaleTurquoise;
    }

    private void textBox34_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox34.BackColor = Color.PaleTurquoise;
    }

    private void textBox35_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox35.BackColor = Color.PaleTurquoise;
    }

    private void textBox36_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox36.BackColor = Color.PaleTurquoise;
    }

    private void textBox9_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox9.BackColor = Color.PaleTurquoise;
    }

    private void textBox39_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox39.BackColor = Color.PaleTurquoise;
    }

    private void textBox30_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox30.BackColor = Color.PaleTurquoise;
    }

    private void textBox43_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox43.BackColor = Color.PaleTurquoise;
    }

    private void textBox44_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox44.BackColor = Color.PaleTurquoise;
    }

    private void textBox45_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox45.BackColor = Color.PaleTurquoise;
    }

    private void textBox53_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox53.BackColor = Color.PaleTurquoise;
    }

    private void textBox16_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox16.BackColor = Color.PaleTurquoise;
    }

    private void textBox42_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox42.BackColor = Color.PaleTurquoise;
    }

    private void textBox31_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox31.BackColor = Color.PaleTurquoise;
    }

    private void textBox63_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox63.BackColor = Color.PaleTurquoise;
    }

    private void textBox52_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox52.BackColor = Color.PaleTurquoise;
    }

    private void textBox50_KeyPress(object sender, KeyPressEventArgs e)
    {
      this.textBox50.BackColor = Color.PaleTurquoise;
    }
    ...
    private void PbSelectID1_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox9.Text = Convert.ToString(itemPicker.ItemIndex);
    }
  }
}
