...
namespace LcDevPack_TeamDamonA.Tools
{
  public class CatalogEditor : Form
  {
    ...
    private string Host = CatalogEditor.connection.Settings.SqlHost;
    private string User = CatalogEditor.connection.Settings.SqlUser;
    private string Password = CatalogEditor.connection.Settings.SqlPassword;
    private string Database = CatalogEditor.connection.Settings.SqlDatabase;
    private DatabaseHandle databaseHandle = new DatabaseHandle();
    private Encoding encoding = Encoding.GetEncoding("ISO-8859-1");
    private ASCIIEncoding _Enc = new ASCIIEncoding();
    public string _ClientPath = CatalogEditor.connection.Settings.ClientPath;
    ...
    public CatalogEditor() => this.InitializeComponent();

    public void SearchList(string searchString)
    {
      string Query = "select a_ctid, a_ctname from t_catalog WHERE a_ctname_tld LIKE '%" + searchString + "%' ORDER BY a_ctid;";
      if (this.language == "THA")
      {
      ...
      else
      {
        ...
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_ctid, a_ctname from t_catalog WHERE a_ctname LIKE '%" + searchString + "%' ORDER BY a_ctid;");
      }
    }

    public void SortCategory(string category)
    {
      string Query = "select a_ctid, a_ctname_tld from t_catalog WHERE a_category ='" + category + "'";
      if (this.language == "THA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayTHA, this.Host, this.User, this.Password, this.Database, Query);
      else
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_ctid, a_ctname from t_catalog WHERE a_category ='" + category + "'");
    }
    ...
    public void LoadListBox()
    {
      ...
      string Query = "select a_ctid, " + this.namee + " from t_catalog ORDER BY a_ctid;";
      if (this.language == "GER")
        ...
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_ctid, a_ctname from t_catalog ORDER BY a_ctid;");
    }
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      string[] strArray = this.databaseHandle.SelectMySqlReturnArray(this.Host, this.User, this.Password, this.Database, " select * from t_catalog WHERE a_ctid ='" + this.textBox1.Text + "';", new string[23]
      {
        "a_ctid",
        "a_ctname",
        "a_category",
    ...
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "INSERT INTO t_catalog DEFAULT VALUES");
      this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select * from t_catalog ORDER BY a_ctid;");
    ...
    private void button3_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_catalog WHERE a_ctid = '" + this.textBox1.Text + "'");
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_ct_item WHERE a_ctid = '" + this.textBox1.Text + "'");
      this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select * from t_catalog ORDER BY a_ctid;");
    ...
    private void btnAddItems_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "INSERT INTO t_ct_item (a_ctid, a_item_idx, a_item_num) VALUES (" + this.textBox1.Text + "," + itemPicker.ItemIndex.ToString() + ", '1')");
      this.dgItems.Rows.Clear();
      this.LoadDG();
    ...
    public void LoadDG()
    {
      ...
      string str1 = " select * from t_ct_item WHERE a_ctid ='" + this.textBox1.Text + "' ORDER BY a_index;";
    ...
    private void btnSaveSelected_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_ct_item SET a_ctid = '" + Convert.ToString(row.Cells["Column9"].Value) + "', a_item_idx = '" + str1 + "', a_item_flag = '" + str5 + "', a_item_plus = '" + str3 + "', a_item_option = '" + str4 + "', a_item_num = '" + str2 + "' WHERE a_index ='" + str6 + "'");
      this.dgItems.Rows.Clear();
      this.LoadDG();
    }
    ...
    private void button2_Click(object sender, EventArgs e)
    {
      ...
      else if (this.language == "USA")
      {
        ...
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_catalog SET a_ctname = '" + str3 + "', a_ctname_ger = '" + str3 + "', a_ctname_spn = '" + str3 + "', " + this.namee + " = '" + str3 + "', a_category = '" + this.textBox3.Text + "', a_type = '" + this.textBox4.Text + "', a_subtype = '" + this.textBox5.Text + "', a_cash = '" + this.textBox6.Text + "', a_ctdesc = '" + str4 + "', a_ctdesc_ger = '" + str4 + "', a_ctdesc_spn = '" + str4 + "', " + this.descrr + " = '" + str4 + "', a_mileage = '" + this.textBox8.Text + "', a_enable = '" + this.textBox9.Text + "', a_flag = '" + this.textBox10.Text + "', a_icon = '" + this.textBox11.Text + "' WHERE a_ctid = '" + this.textBox1.Text + "'");
      }
      else
      {
        this.descrr = this.DescrFromLanguage();
        this.namee = this.StringFromLanguage();
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_catalog SET " + this.namee + " = '" + this.textBox2.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "', a_category = '" + this.textBox3.Text + "', a_type = '" + this.textBox4.Text + "', a_subtype = '" + this.textBox5.Text + "', a_cash = '" + this.textBox6.Text + "', " + this.descrr + " = '" + this.textBox7.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "', a_mileage = '" + this.textBox8.Text + "', a_enable = '" + this.textBox9.Text + "', a_flag = '" + this.textBox10.Text + "', a_icon = '" + this.textBox11.Text + "' WHERE a_ctid = '" + this.textBox1.Text + "'");
      }
      int selectedIndex = this.listBox1.SelectedIndex;
    ...
    private void textBox12_TextChanged(object sender, EventArgs e)
    {
      if (this.language == "GER")
      {
        this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayGER, "t_catalog");
      }
      else
      {
        if (this.language == "POL")
          return;
        if (this.language == "BRA")
          this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayBRA, "t_catalog");
        else if (this.language == "RUS")
        {
          this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayRUS, "t_catalog");
        }
        else
        {
          if (this.language == "FRA")
          ...
          if (this.language == "ESP")
          {
            this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayESP, "t_catalog");
          }
          else
          {
            ...
            if (this.language == "THA")
            {
              this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayTHA, "t_catalog");
            }
            else
            {
              if (this.language == "ITA")
                return;
              if (this.language == "USA")
                this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArrayUSA, "t_catalog");
              else
                this.listBox1.DataSource = (object) this.databaseHandle.SearchListCatalog(this.textBox12.Text, this.menuArray, "t_catalog");
            }
          }
        }
      }
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (CatalogEditor));
      ...
      this.menuStrip1.Size = new Size(1146, 30);
      ...
      this.label3.Size = new Size(42, 16);
      ...
      this.label6.Size = new Size(41, 16);
      ...
      this.textBox8.Size = new Size(68, 22);
      ...
      this.label10.Size = new Size(42, 16);
      this.label10.TabIndex = 20;
      this.label10.Text = "Type:";
      this.label11.AutoSize = true;
      this.label11.Location = new Point(597, 8);
      this.label11.Name = "label11";
      this.label11.Size = new Size(66, 16);
      ...
      this.label12.Size = new Size(35, 16);
      ...
      this.button13.Location = new Point(312, 66);
      ...
      this.label13.Size = new Size(37, 16);
      ...
      this.tbLimit.Size = new Size(68, 22);
      ...
      this.dgItems.Size = new Size(638, 298);
      ...
      this.toolStrip2.Location = new Point(3, 316);
      this.toolStrip2.Name = "toolStrip2";
      this.toolStrip2.Size = new Size(638, 31);
      ...
      this.btnSaveSelected.Size = new Size(78, 28);
      ...
      this.btnAddItems.Size = new Size(75, 28);
      ...
      this.btnDelete.Size = new Size(118, 28);
      ...
      this.btnUpdateName.Size = new Size(171, 28);
      ...
      this.clbFlagTest.Location = new Point(3, 18);
      this.clbFlagTest.MultiColumn = true;
      this.clbFlagTest.Name = "clbFlagTest";
      this.clbFlagTest.Size = new Size(161, 152);
      ...
      this.statusStrip1.Location = new Point(0, 706);
      this.statusStrip1.Name = "statusStrip1";
      this.statusStrip1.Size = new Size(1146, 26);
      ...
      this.checkedListBox1.Location = new Point(5, 20);
      this.checkedListBox1.MultiColumn = true;
      this.checkedListBox1.Name = "checkedListBox1";
      this.checkedListBox1.Size = new Size(165, 148);
      ...
      this.checkedListBox2.Location = new Point(5, 20);
      this.checkedListBox2.Name = "checkedListBox2";
      this.checkedListBox2.Size = new Size(195, 609);
      ...
      this.checkBox1.Size = new Size(171, 20);
      ...
      this.label113.Size = new Size(192, 20);
      ...
      this.lblLang.Size = new Size(37, 16);
      this.lblLang.TabIndex = 53;
      this.lblLang.Text = "Lang";
      this.button14.FlatStyle = FlatStyle.Flat;
      this.button14.Location = new Point(1005, 670);
      this.button14.Name = "button14";
      this.button14.Size = new Size(100, 23);
      this.button14.TabIndex = 54;
      this.button14.Text = "Save&Next";
      ...
      this.Name = nameof (CatalogEditor);
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      if (MessageBox.Show("Do you want to Delete Item ?", "Please confirm.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_ct_item WHERE a_index ='" + Convert.ToString(this.dgItems.Rows[this.dgItems.CurrentRow.Index].Cells["Column8"].Value) + "'");
      this.dgItems.Rows.Clear();
      this.LoadDG();
    }
    ...
    private void button12_Click(object sender, EventArgs e)
    {
      if (MessageBox.Show("Do you want to Copy Item ?", "Please confirm.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DROP TABLE IF EXISTS tempTable;CREATE TEMPORARY TABLE tempTable ENGINE=MyISAM SELECT * FROM t_catalog WHERE a_ctid=" + this.textBox1.Text + ";SELECT a_ctid FROM tempTable;UPDATE tempTable SET a_ctid=(SELECT a_ctid from t_catalog ORDER BY a_ctid DESC LIMIT 1)+1; SELECT a_ctid FROM tempTable;INSERT INTO t_catalog SELECT * FROM tempTable;");
