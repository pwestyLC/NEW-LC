...
// Type: LcDevPack_TeamDamonA.Tools.CatalogPicker
...
{
  public class CatalogPicker : Form
  {
    ...
    public string mSortCat = "-1";

    public CatalogPicker() => this.InitializeComponent();
    ...
    private void LoadStartup()
    {
      this.ClbSort.Items.AddRange(new object[8]
      {
        ...
        (object) "6 - Rogue",
        (object) "7 - Sorcerer",
        (object) "8 - NightShadow"
      });
    }

    private void CatalogPicker_Load(object sender, EventArgs e)
    {
      this.LoadStartup();
      this.MenuList.Clear();
      for (int index = 0; index < CatalogList.List.Count<tCatalog>(); ++index)
        this.MenuList.Add(CatalogList.List[index].ItemID.ToString() + " - " + CatalogList.List[index].Name.ToString());
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (tCatalog == null)
        return;
      this.ItemIndex = tCatalog.ItemID;
      this.textBox2.Text = tCatalog.Name;
      this.textBox3.Text = tCatalog.Desc;
      this.pictureBox1.Image = (Image) new DatabaseHandle().IconFast(tCatalog.ItemID);
    }

    private void button1_Click(object sender, EventArgs e)
    {
      this.ItemAmount = !(this.tbAmount.Text == "") ? Convert.ToInt32(this.tbAmount.Text) : -1;
    ...
    private void LoadListBox()
    {
      ...
      this.MenuList.Clear();
      string Query = "SELECT a_ctid, a_ctname, a_ctdesc FROM t_catalog WHERE a_category ='" + this.mSortCat + "' ORDER BY a_ctid;";
      if (this.mSortCat == "-1")
        Query = "SELECT a_ctid, a_ctname, a_ctdesc FROM t_catalog ORDER BY a_ctid;";
    ...
    private void InitializeComponent()
    {
      ...
      this.listBox1.Size = new Size(214, 303);
      this.listBox1.TabIndex = 4;
      this.listBox1.SelectedIndexChanged += new EventHandler(this.listBox1_SelectedIndexChanged_2);
      ...
      this.label1.Location = new Point(254, 375);
      this.label1.Name = "label1";
      this.label1.Size = new Size(46, 13);
      this.label1.TabIndex = 6;
      this.label1.Text = "Amount:";
      this.tbAmount.Location = new Point(306, 372);
      ...
      this.Name = nameof (CatalogPicker);
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = nameof (CatalogPicker);
      this.Load += new EventHandler(this.CatalogPicker_Load);
    ...
    {
      this.mSortCat = this.GetIndexByComboBox(this.ClbSort.Text).ToString();
