...
namespace LcDevPack_TeamDamonA.Tools
{
  public class ItemPicker : Form
  {
    ...
    public ItemPicker() => this.InitializeComponent();
    ...
    private void ItemPicker_Load(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index < IconList.List.Count<ticon>(); ++index)
        this.MenuList.Add(IconList.List[index].ItemID.ToString() + " - " + IconList.List[index].Name.ToString());
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ItemPicker));
