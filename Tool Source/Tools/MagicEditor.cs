...
namespace LcDevPack_TeamDamonA.Tools
{
  public class MagicEditor : Form
  {
    ...
    private string Host = MagicEditor.connection.Settings.SqlHost;
    private string User = MagicEditor.connection.Settings.SqlUser;
    private string Password = MagicEditor.connection.Settings.SqlPassword;
    private string Database = MagicEditor.connection.Settings.SqlDatabase;
    ...
    public MagicEditor() => this.InitializeComponent();
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MagicEditor));
      ...
      this.textBox7.Location = new Point(858, 109);
      ...
      this.groupBox5.Size = new Size(539, 351);
      ...
      this.dgItems.Size = new Size(533, 307);
      ...
      this.toolStrip2.Location = new Point(3, 323);
      ...
      this.button3.Location = new Point(680, 623);
      ...
      this.tbSubtype.Location = new Point(922, 57);
      ...
      this.ClientSize = new Size(1067, 660);
      ...
      this.Name = nameof (MagicEditor);
      this.Text = "Magic Editor";
      this.Load += new EventHandler(this.MagicEditor_Load);
