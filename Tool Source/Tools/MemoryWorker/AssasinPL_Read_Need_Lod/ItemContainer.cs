...
// Type: LcDevPack_TeamDamonA.Tools.MemoryWorker.AssasinPL_Read_Need_Lod.ItemContainer
...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.AssasinPL_Read_Need_Lod
{
  public class ItemContainer
  {
    ...
    public int JewelOptionLevel { get; set; }

    public int JewelOptionType { get; set; }

    public int[] rareOptionType { get; set; }

    public int[] rareOptionChance { get; set; }

    public int syndicate_type { get; set; }

    public int fortuneIndex { get; set; }

    public int castleWar { get; set; }

    public int syndicate_grade { get; set; }
