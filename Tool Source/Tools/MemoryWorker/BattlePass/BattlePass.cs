...
// Type: LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass
...
#nullable disable
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass
{
  public class BattlePass : Form
  {
    public static Connection connection = new Connection();
    private string Host = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.SqlHost;
    private string User = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.SqlUser;
    private string Password = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.SqlPassword;
    private string Database = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.SqlDatabase;
    private DatabaseHandle databaseHandle = new DatabaseHandle();
    public string _ClientPath = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.ClientPath;
    ...
    private string language = LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.connection.Settings.Language;
    ...
    private string StringFromLanguage()
    {
      ...
      {
        LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee = "a_name";
        return LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee;
      }
    ...
    {
      LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee = this.StringFromLanguage();
      string Query = "select a_index, " + LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee + " from t_battle_pass WHERE " + LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee + " LIKE '%" + searchString + "%' ORDER BY a_index;";
      if (this.language == "GER")
    ...
    private void LoadListBox()
    {
      ...
      this.MenuList.Clear();
      LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee = this.StringFromLanguage();
      string Query = "SELECT a_index," + LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee + " FROM t_battle_pass ORDER BY a_index;";
      if (this.language == "GER")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, Query);
      else if (this.language == "BRA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, Query);
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      string Query = "select a_index, " + LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee + ", a_points, a_premium_points, a_level, a_season FROM t_battle_pass WHERE a_index ='" + this.textBox5.Text + "';";
      string[] rows = new string[6]
      {
        "a_index",
        LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee,
        "a_level",
        "a_points",
        "a_premium_points",
        "a_season"
    ...
    private void Reward_List(object sender, EventArgs e)
    {
      ...
      string Query = "select a_index, a_battle_pass_idx, a_item_idx, a_item_count, a_premium_item_idx, a_premium_item_count FROM t_battle_pass_reward WHERE a_battle_pass_idx ='" + this.textBox2.Text + "';";
      string[] rows = new string[6]
      {
        "a_index",
        "a_battle_pass_idx",
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_battle_pass SET " + LcDevPack_TeamDamonA.Tools.MemoryWorker.BattlePass.BattlePass.namee + "  = '" + str + "', a_points = '" + this.textBox9.Text + "', a_premium_points = '" + this.textBox10.Text + "', a_season = '" + this.textBox8.Text + "' WHERE a_index = '" + this.textBox5.Text + "'");
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "UPDATE t_battle_pass_reward SET a_item_idx  = '" + this.tb_reward_id.Text + "', a_item_count = '" + this.tb_reward_qty.Text + "', a_premium_item_idx = '" + this.textBox7.Text + "',  a_premium_item_count = '" + this.textBox3.Text + "' WHERE a_index = '" + this.textBox11.Text + "'");
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (BattlePass);
      this.Text = "LastChaos BattlePass Editor";
