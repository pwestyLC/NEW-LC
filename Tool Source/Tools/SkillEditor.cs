...
namespace LcDevPack_TeamDamonA.Tools
{
  public class SkillEditor : Form
  {
    ...
    private string Episode = SkillEditor.connection.Settings.Episode;
    ...
    public string mSortPet = "0";
    private ExportLodHandle exportLodhandle = new ExportLodHandle();
    private IContainer components = (IContainer) null;
    public int SkillLevelSelect;
    public int MagicLevelSelect;
    ...
    private ToolStripMenuItem exportStrSkillslodToolStripMenuItem;
    ...
    private ToolStripMenuItem exportSkillTreebinToolStripMenuItem;
    ...
    {
      if (this.cbMagicLevel.Text == "t_magicLevel" || this.cbMagicLevel.Text == "t_magiclevel" && this.cbMagicLevel.Text != "")
      {
        if (this.cbMagicLevel.Text == "t_magiclevel")
          this.MagicLevelSelect = 1;
        else
          this.MagicLevelSelect = 2;
      }
      else
      {
        if (!(this.cbSkillLevel.Text == "t_skilllevel") && (!(this.cbSkillLevel.Text == "t_skillLevel") || !(this.cbSkillLevel.Text != "")))
          return;
        this.SkillLevelSelect = !(this.cbSkillLevel.Text == "t_skilllevel") ? 2 : 1;
      }
    }

    private void PetBoxTest()
    {
      if (this.textBox84.Text != "0" && this.textBox2.Text != "11")
        this.CBPet.Enabled = false;
      else
        this.CBPet.Enabled = true;
    }
    ...
    public string ClientDescrFromLanguage()
    {
      if (this.language == "GER")
      {
        this.ClientDescription = "a_client_description_ger";
        return this.ClientDescription;
      }
      if (this.language == "POL")
      {
        this.ClientDescription = "a_client_description_pld";
        return this.ClientDescription;
      }
      if (this.language == "BRA")
      {
        this.ClientDescription = "a_client_description_brz";
        return this.ClientDescription;
      }
      if (this.language == "RUS")
      {
        this.ClientDescription = "a_client_description_rus";
        return this.ClientDescription;
      }
      if (this.language == "FRA")
      {
        this.ClientDescription = "a_client_description_frc";
        return this.ClientDescription;
      }
      if (this.language == "ESP")
      {
        this.ClientDescription = "a_client_description_spn";
        return this.ClientDescription;
      }
      if (this.language == "MEX")
      {
        this.ClientDescription = "a_client_description_mex";
        return this.ClientDescription;
      }
      if (this.language == "THA")
      {
        this.ClientDescription = "a_client_description_thai";
        return this.ClientDescription;
      }
      if (this.language == "ITA")
      {
        this.ClientDescription = "a_client_description_ita";
        return this.ClientDescription;
      }
      if (!(this.language == "USA"))
        return (string) null;
      this.ClientDescription = "a_client_description_usa";
      return this.ClientDescription;
    }

    public string ToolTipFromLanguage()
    {
      if (this.language == "GER")
      {
        this.ToolTip = "a_client_tooltip_ger";
        return this.ToolTip;
      }
      if (this.language == "POL")
      {
        this.ToolTip = "a_client_tooltip_pld";
        return this.ToolTip;
      }
      if (this.language == "BRA")
      {
        this.ToolTip = "a_client_tooltip_brz";
        return this.ToolTip;
      }
      if (this.language == "RUS")
      {
        this.ToolTip = "a_client_tooltip_rus";
        return this.ToolTip;
      }
      if (this.language == "FRA")
      {
        this.ToolTip = "a_client_tooltip_frc";
        return this.ToolTip;
      }
      if (this.language == "ESP")
      {
        this.ToolTip = "a_client_tooltip_spn";
        return this.ToolTip;
      }
      if (this.language == "MEX")
      {
        this.ToolTip = "a_client_tooltip_mex";
        return this.ToolTip;
      }
      if (this.language == "THA")
      {
        this.ToolTip = "a_client_tooltip_thai";
        return this.ToolTip;
      }
      if (this.language == "ITA")
      {
        this.ToolTip = "a_client_tooltip_ita";
        return this.ToolTip;
      }
      if (!(this.language == "USA"))
        return (string) null;
      this.ToolTip = "a_client_tooltip_usa";
      return this.ToolTip;
    }

    public SkillEditor() => this.InitializeComponent();

    private void LoadListBox()
    {
      this.aname = this.StringFromLanguage();
      this.MenuList.Clear();
      string Query = "SELECT a_index, " + this.aname + " FROM t_skill WHERE a_job ='" + this.mSortJob + "' AND a_job2 ='" + this.mSortJob2 + "' ORDER BY a_index;";
      if (this.mSortJob == "-1")
        Query = "SELECT a_index, " + this.aname + " FROM t_skill ORDER BY a_index;";
      if (this.mSortJob2 == "-1" && this.mSortJob != "-1" && this.mSortPet == "0")
        Query = "SELECT a_index, " + this.aname + " FROM t_skill WHERE a_job ='" + this.mSortJob + "' ORDER BY a_index;";
      if (this.mSortJob2 == "-1" && this.mSortJob != "-1" && this.mSortPet != "0")
        Query = "SELECT a_index, " + this.aname + " FROM t_skill WHERE a_job ='" + this.mSortJob + "' AND a_apet_index ='" + this.mSortPet + "' ORDER BY a_index;";
      if (this.mSortJob2 == "-1" && this.mSortJob == "-1" && this.mSortPet == "0")
        Query = "SELECT a_index, " + this.aname + " FROM t_skill ORDER BY a_index;";
      if (this.mSortJob2 != "-1" && this.mSortJob != "-1" && this.mSortPet != "-1")
        Query = "SELECT a_index, " + this.aname + " FROM t_skill WHERE a_job ='" + this.mSortJob + "' AND a_job2 ='" + this.mSortJob2 + "' ORDER BY a_index;";
      if (this.language == "GER")
    ...
    public void SearchList(string searchString)
    {
      ...
      if (this.language == "GER")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayGER, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_ger from t_skill WHERE a_name_ger LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_ger LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_ger LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_ger LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "POL")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayPOL, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_pld from t_skill WHERE a_name_pld LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_pld LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_pld LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_pld LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "BRA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayBRA, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_brz from t_skill WHERE a_name_brz LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_brz LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_brz LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_brz LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "RUS")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayRUS, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_rus from t_skill WHERE a_name_rus LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_rus LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_rus LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_rus LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "FRA")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayFRA, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_frc from t_skill WHERE a_name_frc LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_frc LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_frc LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_frc LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "ESP")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayESP, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_spn from t_skill WHERE a_name_spn LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_spn LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_spn LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_spn LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "MEX")
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayMEX, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_mex from t_skill WHERE a_name_mex LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_mex LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_mex LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_mex LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "THA")
        ...
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArrayITA, this.Host, this.User, this.Password, this.Database, "select a_index, a_name_ita from t_skill WHERE a_name_ita LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name_ita LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name_ita LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name_ita LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
      else if (this.language == "USA")
        ...
        this.listBox1.DataSource = (object) this.databaseHandle.SelectMySqlReturnList(this.menuArray, this.Host, this.User, this.Password, this.Database, "select a_index, a_name from t_skill WHERE a_name LIKE '%" + searchString + "%' OR a_index LIKE '%" + searchString + "%' OR a_name LIKE '%" + lower + "%' OR a_index  LIKE '%" + lower + "%' OR a_name LIKE '%" + upper + "%' OR a_index LIKE '%" + upper + "%' OR a_name LIKE '%" + str + "%' OR a_index LIKE '%" + str + "%' ORDER BY a_index;");
    }
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (this.language == "GER")
      {
        this.textBox4.Text = strArray[86];
        this.textBox5.Text = strArray[87];
        this.textBox54.Text = strArray[88];
      }
      else if (this.language == "POL")
      {
        this.textBox4.Text = strArray[110];
        this.textBox5.Text = strArray[111];
        this.textBox54.Text = strArray[112];
      }
      else if (this.language == "BRA")
      {
        this.textBox4.Text = strArray[101];
        this.textBox5.Text = strArray[102];
        this.textBox54.Text = strArray[103];
      }
      else if (this.language == "RUS")
      {
        this.textBox4.Text = strArray[89];
        this.textBox5.Text = strArray[90];
        this.textBox54.Text = strArray[91];
      }
      else if (this.language == "FRA")
      {
        this.textBox4.Text = strArray[95];
        this.textBox5.Text = strArray[96];
        this.textBox54.Text = strArray[97];
      }
      else if (this.language == "ESP")
      {
        this.textBox4.Text = strArray[104];
        this.textBox5.Text = strArray[105];
        this.textBox54.Text = strArray[106];
      }
      else if (this.language == "MEX")
      {
        this.textBox4.Text = strArray[98];
        this.textBox5.Text = strArray[99];
        this.textBox54.Text = strArray[100];
      }
      else if (this.language == "THA")
      {
        this.textBox4.Text = strArray[92];
        this.textBox5.Text = strArray[93];
        this.textBox54.Text = strArray[94];
      }
      else if (this.language == "ITA")
      {
        this.textBox4.Text = strArray[107];
        this.textBox5.Text = strArray[108];
        this.textBox54.Text = strArray[109];
      }
      else if (this.language == "USA")
      {
        this.textBox4.Text = strArray[83];
        this.textBox5.Text = strArray[84];
        this.textBox54.Text = strArray[85];
      }
      else
      {
    ...
    private void button2_Click(object sender, EventArgs e)
    {
      ...
      {
        this.aname = this.StringFromLanguage();
        this.aClientDescripton = this.ClientDescrFromLanguage();
        this.aToolTip = this.ToolTipFromLanguage();
      ...
      else if (this.language == "USA")
      {
        ...
        this.aClientDescripton = this.ClientDescrFromLanguage();
        this.aToolTip = this.ToolTipFromLanguage();
        string str5 = "UPDATE t_skill SET a_index = '" + this.textBox1.Text + "', a_job = '" + this.textBox2.Text + "', a_job2 = '" + this.textBox3.Text + "', ";
        this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str6 = this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str7 = this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str8 = this.textBox54.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string Query = str5 + "a_name = '" + str6 + "', " + this.aname + "= '" + str6 + "', " + this.aClientDescripton + "= '" + str7 + "',a_client_description = '" + str7 + "', a_type = '" + this.textBox6.Text + "',a_flag= '" + this.textBox7.Text + "',a_maxLevel = '" + this.textBox8.Text + "',a_appRange = '" + this.textBox9.Text + "',a_fireRange = '" + this.textBox10.Text + "',a_fireRange2 = '" + this.textBox11.Text + "',a_minRange = '" + this.textBox12.Text + "',a_targetType = '" + this.textBox13.Text + "',a_targetNum = '" + this.textBox14.Text + "',a_useState = '" + this.textBox15.Text + "',a_useWeaponType0 = '" + this.textBox16.Text + "',a_useWeaponType1 = '" + this.textBox17.Text + "',a_use_needWearingType = '" + this.textBox18.Text + "',a_useMagicIndex1 = '" + this.textBox19.Text + "',a_useMagicIndex2 = '" + this.textBox20.Text + "',a_useMagicIndex3 = '" + this.textBox21.Text + "',a_useMagicLevel1 = '" + this.textBox22.Text + "',a_useMagicLevel2 = '" + this.textBox23.Text + "',a_useMagicLevel3 = '" + this.textBox24.Text + "',a_appState = '" + this.textBox25.Text + "',a_appWeaponType0 = '" + this.textBox26.Text + "',a_appWeaponType1 = '" + this.textBox27.Text + "',a_app_needWearingType = '" + this.textBox28.Text + "',a_readyTime = '" + this.textBox29.Text + "',a_stillTime = '" + this.textBox30.Text + "',a_fireTime = '" + this.textBox31.Text + "',a_reuseTime = '" + this.textBox32.Text + "',a_cd_ra = '" + this.textBox33.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re = '" + this.textBox34.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa = '" + this.textBox35.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa = '" + this.textBox36.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe0 = '" + this.textBox37.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe1 = '" + this.textBox38.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe2 = '" + this.textBox39.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot = '" + this.textBox40.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fos = '" + this.textBox41.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_ox = '" + this.textBox42.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oz = '" + this.textBox43.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oh = '" + this.textBox44.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oc = '" + this.textBox45.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fdc = '" + this.textBox46.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fd0 = '" + this.textBox47.Text.Replace(",", ".") + "',a_cd_fd1 = '" + this.textBox48.Text.Replace(",", ".") + "',a_cd_fd2 = '" + this.textBox49.Text.Replace(",", ".") + "',a_cd_fd3 = '" + this.textBox50.Text.Replace(",", ".") + "',a_cd_dd = '" + this.textBox51.Text + "',a_cd_fe_after = '" + this.textBox52.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe_after2 = '" + this.textBox53.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_client_tooltip = '" + str8 + "', " + this.aToolTip + "='" + str8 + "',a_client_icon_texid = '" + this.textBox55.Text + "',a_client_icon_row = '" + this.textBox56.Text + "',a_client_icon_col = '" + this.textBox57.Text + "',a_cd_ra2 = '" + this.textBox58.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re2 = '" + this.textBox59.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa2 = '" + this.textBox60.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa2 = '" + this.textBox61.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe3 = '" + this.textBox62.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe4 = '" + this.textBox63.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe5 = '" + this.textBox64.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot2 = '" + this.textBox65.Text + "',a_cd_fos2 = '" + this.textBox66.Text + "',a_cd_ox2 = '" + this.textBox67.Text + "',a_cd_oz2 = '" + this.textBox68.Text + "',a_cd_oh2 = '" + this.textBox69.Text + "',a_cd_oc2 = '" + this.textBox70.Text + "',a_cd_fdc2 = '" + this.textBox71.Text + "',a_cd_fd4 = '" + this.textBox72.Text.Replace(",", ".") + "',a_cd_fd5 = '" + this.textBox73.Text.Replace(",", ".") + "',a_cd_fd6 = '" + this.textBox74.Text.Replace(",", ".") + "',a_cd_fd7 = '" + this.textBox75.Text.Replace(",", ".") + "',a_cd_dd2 = '" + this.textBox76.Text + "',a_selfparam = '" + this.textBox77.Text + "',a_targetparam = '" + this.textBox78.Text + "',a_soul_consum = '" + this.textBox79.Text + "',a_summon_idx = '" + this.textBox80.Text + "',a_sorcerer_flag = '" + this.textBox81.Text + "',a_apet_index = '" + this.textBox82.Text + "',a_allowzone = '" + this.textBox83.Text + "' WHERE a_index = '" + this.textBox1.Text + "'";
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, Query);
        Console.WriteLine(Query);
      }
      else
      {
        ...
        this.aClientDescripton = this.ClientDescrFromLanguage();
        this.aToolTip = this.ToolTipFromLanguage();
        string str9 = "UPDATE t_skill SET a_index = '" + this.textBox1.Text + "', a_job = '" + this.textBox2.Text + "', a_job2 = '" + this.textBox3.Text + "', ";
        string str10 = this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str11 = this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str12 = this.textBox54.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string Query = str9 + this.aname + "= '" + str10 + "', " + this.aClientDescripton + "= '" + str11 + "', a_type = '" + this.textBox6.Text + "',a_flag= '" + this.textBox7.Text + "',a_maxLevel = '" + this.textBox8.Text + "',a_appRange = '" + this.textBox9.Text + "',a_fireRange = '" + this.textBox10.Text + "',a_fireRange2 = '" + this.textBox11.Text + "',a_minRange = '" + this.textBox12.Text + "',a_targetType = '" + this.textBox13.Text + "',a_targetNum = '" + this.textBox14.Text + "',a_useState = '" + this.textBox15.Text + "',a_useWeaponType0 = '" + this.textBox16.Text + "',a_useWeaponType1 = '" + this.textBox17.Text + "',a_use_needWearingType = '" + this.textBox18.Text + "',a_useMagicIndex1 = '" + this.textBox19.Text + "',a_useMagicIndex2 = '" + this.textBox20.Text + "',a_useMagicIndex3 = '" + this.textBox21.Text + "',a_useMagicLevel1 = '" + this.textBox22.Text + "',a_useMagicLevel2 = '" + this.textBox23.Text + "',a_useMagicLevel3 = '" + this.textBox24.Text + "',a_appState = '" + this.textBox25.Text + "',a_appWeaponType0 = '" + this.textBox26.Text + "',a_appWeaponType1 = '" + this.textBox27.Text + "',a_app_needWearingType = '" + this.textBox28.Text + "',a_readyTime = '" + this.textBox29.Text + "',a_stillTime = '" + this.textBox30.Text + "',a_fireTime = '" + this.textBox31.Text + "',a_reuseTime = '" + this.textBox32.Text + "',a_cd_ra = '" + this.textBox33.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re = '" + this.textBox34.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa = '" + this.textBox35.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa = '" + this.textBox36.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe0 = '" + this.textBox37.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe1 = '" + this.textBox38.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe2 = '" + this.textBox39.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot = '" + this.textBox40.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fos = '" + this.textBox41.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_ox = '" + this.textBox42.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oz = '" + this.textBox43.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oh = '" + this.textBox44.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oc = '" + this.textBox45.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fdc = '" + this.textBox46.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fd0 = '" + this.textBox47.Text.Replace(",", ".") + "',a_cd_fd1 = '" + this.textBox48.Text.Replace(",", ".") + "',a_cd_fd2 = '" + this.textBox49.Text.Replace(",", ".") + "',a_cd_fd3 = '" + this.textBox50.Text.Replace(",", ".") + "',a_cd_dd = '" + this.textBox51.Text + "',a_cd_fe_after = '" + this.textBox52.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe_after2 = '" + this.textBox53.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "', " + this.aToolTip + "='" + str12 + "',a_client_icon_texid = '" + this.textBox55.Text + "',a_client_icon_row = '" + this.textBox56.Text + "',a_client_icon_col = '" + this.textBox57.Text + "',a_cd_ra2 = '" + this.textBox58.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re2 = '" + this.textBox59.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa2 = '" + this.textBox60.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa2 = '" + this.textBox61.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe3 = '" + this.textBox62.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe4 = '" + this.textBox63.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe5 = '" + this.textBox64.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot2 = '" + this.textBox65.Text + "',a_cd_fos2 = '" + this.textBox66.Text + "',a_cd_ox2 = '" + this.textBox67.Text + "',a_cd_oz2 = '" + this.textBox68.Text + "',a_cd_oh2 = '" + this.textBox69.Text + "',a_cd_oc2 = '" + this.textBox70.Text + "',a_cd_fdc2 = '" + this.textBox71.Text + "',a_cd_fd4 = '" + this.textBox72.Text.Replace(",", ".") + "',a_cd_fd5 = '" + this.textBox73.Text.Replace(",", ".") + "',a_cd_fd6 = '" + this.textBox74.Text.Replace(",", ".") + "',a_cd_fd7 = '" + this.textBox75.Text.Replace(",", ".") + "',a_cd_dd2 = '" + this.textBox76.Text + "',a_selfparam = '" + this.textBox77.Text + "',a_targetparam = '" + this.textBox78.Text + "',a_soul_consum = '" + this.textBox79.Text + "',a_summon_idx = '" + this.textBox80.Text + "',a_sorcerer_flag = '" + this.textBox81.Text + "',a_apet_index = '" + this.textBox82.Text + "',a_allowzone = '" + this.textBox83.Text + "' WHERE a_index = '" + this.textBox1.Text + "'";
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, Query);
        Console.WriteLine(Query);
      }
    ...
    {
      if (MessageBox.Show("Do you want to Delete Skill " + this.textBox1.Text.Trim() + " ?", "Please confirm.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
      int selectedIndex = this.listBox1.SelectedIndex;
      ...
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DELETE FROM t_skillLevel WHERE a_index = '" + this.textBox1.Text + "'");
      this.LoadListBox();
      if (this.textBox203.Text != "")
        this.SearchList(this.textBox203.Text);
    ...
    private void LoadStartUp()
    {
      ...
      this.CBPet.Items.AddRange(new object[165]
      {
        (object) "-1 - none",
        (object) "0 - none",
        (object) "1 - Sca-chi",
        (object) "2 - Ichi",
        (object) "3 - Mystery Pet",
        (object) "4 - Polar Bear Cub",
        (object) "5 - Ursus",
        (object) "6 - Nanook",
        (object) "7 - Jaguar Cub",
        (object) "8 - Jaguar",
        (object) "9 - Panthera Onca",
        (object) "10 - Pet",
        (object) "11 - Baby Panda",
        (object) "12 - Panda",
        (object) "13 - Battle Panda",
        (object) "14 - Mystery Pet",
        (object) "15 - Lizard Linko Baby",
        (object) "16 - Lizard Lingko",
        (object) "17 - Lizard Battle Lingko",
        (object) "18 - Strange Bat",
        (object) "19 - Thorny Demon Bat",
        (object) "20 - Scar Demon Bat",
        (object) "21 - Succubus of Flame",
        (object) "22 - Succubus of Seduction",
        (object) "23 - Succubus of Lightning",
        (object) "24 - Succubus of Seduction 2",
        (object) "25 - Lizard Ruv Baby",
        (object) "26 - Lizard Ruv",
        (object) "27 - Lizard Battle Ruv",
        (object) "28 - Lizard Kai Baby",
        (object) "29 - Lizard Kai",
        (object) "30 - Lizard Battle Kai",
        (object) "31 - Swift Horse Diesel",
        (object) "32 - Strong Pony",
        (object) "33 - Imposing Pony",
        (object) "34 - Arrogant Pony",
        (object) "35 - Attractive Pony",
        (object) "36 - Swift Pony",
        (object) "37 - Mysterious Pony",
        (object) "38 - Swift Horse Diesel Event",
        (object) "39 - Red Diesel",
        (object) "40 - Popenian",
        (object) "41 - Rideable Popenian",
        (object) "42 - Eaglet Zeppy",
        (object) "43 - Eagle Zeppy",
        (object) "44 - Battle Eagle Zeppy",
        (object) "47 - Eagle Maxie",
        (object) "48 - Suspicious Bat",
        (object) "49 - Scar Nightmare",
        (object) "50 - Incubus",
        (object) "51 - Elephant Chang Thai",
        (object) "52 - Leopard",
        (object) "53 - Liopard",
        (object) "54 - Zappy",
        (object) "55 - Lingkogator",
        (object) "56 - Panda Plush",
        (object) "57 - Halloween Pumpkin Ghost",
        (object) "58 - Qilin",
        (object) "59 - Chameleon",
        (object) "60 - Tiny Dragon",
        (object) "61 - Bear",
        (object) "62 - Bike",
        (object) "63 - Red Okami",
        (object) "64 - Black Lion-Wolf",
        (object) "71 - Russia_elk",
        (object) "72 - Exp_horse",
        (object) "73 - Ghost_horse",
        (object) "74 - Horse_Gray",
        (object) "75 - Ice_horse",
        (object) "76 - eInferno_horse Inf",
        (object) "77 - Pegas a Fix",
        (object) "78 - Tiger Lord",
        (object) "79 - Lion Lord",
        (object) "80 - Unicorn pink",
        (object) "81 - Unicorn blue",
        (object) "82 - Cat",
        (object) "83 - Event Sca-chi",
        (object) "84 - Event Ichi",
        (object) "85 - Event Panda Cub",
        (object) "86 - Event Panda",
        (object) "87 - Event Battle Panda",
        (object) "88 - Event Jaguar Cub",
        (object) "89 - Event Jaguar",
        (object) "90 - Event Panthera Onca",
        (object) "91 - Event Pb Cub",
        (object) "92 - Event Ursus",
        (object) "93 - Event Nanook",
        (object) "94 - newpet",
        (object) "95 - newpet",
        (object) "96 - newpet",
        (object) "97 - newpet",
    ...
    private void pictureBox4_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox91.Text = Convert.ToString(itemPicker.ItemIndex);
    }
    ...
    private void pictureBox5_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox93.Text = Convert.ToString(itemPicker.ItemIndex);
    }
    ...
    private void pictureBox9_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox103.Text = Convert.ToString(itemPicker.ItemIndex);
    }
    ...
    private void pictureBox10_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox105.Text = Convert.ToString(itemPicker.ItemIndex);
    }
    ...
    private void pictureBox11_Click(object sender, EventArgs e)
    {
      ...
      if (itemPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox107.Text = Convert.ToString(itemPicker.ItemIndex);
    }
    ...
    {
      string Query = "INSERT INTO t_skillLevel (a_index, a_level, a_needItemIndex1, a_needItemIndex2,a_learnSkillIndex1, a_learnSkillIndex2, a_learnSkillIndex3, a_learnItemIndex1, a_learnItemIndex2, a_learnItemIndex3 ) VALUES ('" + this.textBox1.Text + "', '" + Convert.ToString(this.listBox2.Items.Count + 1) + "','-1','-1','-1','-1','-1','-1','-1','-1')";
      Console.WriteLine(Query);
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, Query);
      this.LoadListBox2();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (SkillEditor));
      this.menuStrip1 = new MenuStrip();
      this.fileExportToolStripMenuItem = new ToolStripMenuItem();
      this.exportSkilllodToolStripMenuItem = new ToolStripMenuItem();
      this.exportStrSkillslodToolStripMenuItem = new ToolStripMenuItem();
      this.exportSkillTreebinToolStripMenuItem = new ToolStripMenuItem();
      this.saveToolStripMenuItem = new ToolStripMenuItem();
      this.mYSQLToolStripMenuItem = new ToolStripMenuItem();
      this.sKILLSCOST0SPToolStripMenuItem = new ToolStripMenuItem();
      this.sKILLSREQUIRENOITEMSToolStripMenuItem = new ToolStripMenuItem();
      this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem = new ToolStripMenuItem();
      ...
      this.PbMagicIdx3 = new PictureBox();
      this.PbMagicIdx2 = new PictureBox();
      this.PbMagicIdx1 = new PictureBox();
      ...
      this.PbUseState = new PictureBox();
      this.PbAppState = new PictureBox();
      ...
      this.cbMagicLevel = new ComboBox();
      ...
      ((ISupportInitialize) this.PbMagicIdx3).BeginInit();
      ((ISupportInitialize) this.PbMagicIdx2).BeginInit();
      ((ISupportInitialize) this.PbMagicIdx1).BeginInit();
      ...
      ((ISupportInitialize) this.PbUseState).BeginInit();
      ((ISupportInitialize) this.PbAppState).BeginInit();
      ...
      this.menuStrip1.Size = new Size(1346, 28);
      ...
      this.fileExportToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[4]
      {
        ...
        (ToolStripItem) this.exportStrSkillslodToolStripMenuItem,
        (ToolStripItem) this.exportSkillTreebinToolStripMenuItem,
      ...
      this.exportSkilllodToolStripMenuItem.Size = new Size(220, 26);
      ...
      this.exportStrSkillslodToolStripMenuItem.Name = "exportStrSkillslodToolStripMenuItem";
      this.exportStrSkillslodToolStripMenuItem.Size = new Size(220, 26);
      this.exportStrSkillslodToolStripMenuItem.Text = "Export strSkills.lod";
      this.exportStrSkillslodToolStripMenuItem.Click += new EventHandler(this.exportStrSkillslodToolStripMenuItem_Click);
      this.exportSkillTreebinToolStripMenuItem.Name = "exportSkillTreebinToolStripMenuItem";
      this.exportSkillTreebinToolStripMenuItem.Size = new Size(220, 26);
      this.exportSkillTreebinToolStripMenuItem.Text = "Export skill_tree.bin";
      this.exportSkillTreebinToolStripMenuItem.Click += new EventHandler(this.exportSkillTreebinToolStripMenuItem_Click);
      this.saveToolStripMenuItem.Name = "saveToolStripMenuItem";
      this.saveToolStripMenuItem.Size = new Size(220, 26);
      this.saveToolStripMenuItem.Text = "save";
      this.saveToolStripMenuItem.Click += new EventHandler(this.saveToolStripMenuItem_Click);
      this.mYSQLToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[3]
      {
        (ToolStripItem) this.sKILLSCOST0SPToolStripMenuItem,
        (ToolStripItem) this.sKILLSREQUIRENOITEMSToolStripMenuItem,
        (ToolStripItem) this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem
      });
      ...
      this.sKILLSCOST0SPToolStripMenuItem.Size = new Size(310, 26);
      this.sKILLSCOST0SPToolStripMenuItem.Text = "SKILLS COST 0 SP";
      this.sKILLSCOST0SPToolStripMenuItem.Click += new EventHandler(this.SKILLSCOST0SPToolStripMenuItem_Click);
      this.sKILLSREQUIRENOITEMSToolStripMenuItem.Name = "sKILLSREQUIRENOITEMSToolStripMenuItem";
      this.sKILLSREQUIRENOITEMSToolStripMenuItem.Size = new Size(310, 26);
      this.sKILLSREQUIRENOITEMSToolStripMenuItem.Text = "SKILLS REQUIRE NO ITEMS CAST";
      this.sKILLSREQUIRENOITEMSToolStripMenuItem.Click += new EventHandler(this.SKILLSREQUIRENOITEMSToolStripMenuItem_Click);
      this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem.Name = "sKILLSREQUIRENOITEMLEARNToolStripMenuItem";
      this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem.Size = new Size(310, 26);
      this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem.Text = "SKILLS REQUIRE NO ITEM LEARN";
      this.sKILLSREQUIRENOITEMLEARNToolStripMenuItem.Click += new EventHandler(this.SKILLSREQUIRENOITEMLEARNToolStripMenuItem_Click);
      ...
      this.groupBox3.Location = new Point(12, 147);
      this.groupBox3.Name = "groupBox3";
      this.groupBox3.Size = new Size(265, 542);
      this.groupBox3.TabIndex = 31;
      this.groupBox3.TabStop = false;
      this.groupBox3.Text = "Skills";
      this.btnCopy.FlatStyle = FlatStyle.Flat;
      this.btnCopy.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.btnCopy.Location = new Point(92, 517);
      this.btnCopy.Name = "btnCopy";
      this.btnCopy.Size = new Size(70, 24);
      ...
      this.button3.Location = new Point(177, 517);
      this.button3.Name = "button3";
      this.button3.Size = new Size(82, 24);
      ...
      this.button1.Location = new Point(6, 517);
      this.button1.Name = "button1";
      this.button1.Size = new Size(70, 24);
      ...
      this.listBox1.Size = new Size(253, 484);
      this.listBox1.TabIndex = 1;
      this.listBox1.SelectedIndexChanged += new EventHandler(this.listBox1_SelectedIndexChanged);
      this.groupBox5.Controls.Add((Control) this.CBPet);
      this.groupBox5.Controls.Add((Control) this.label132);
      ...
      this.groupBox5.Size = new Size(265, 120);
      this.groupBox5.TabIndex = 32;
      this.groupBox5.TabStop = false;
      this.groupBox5.Text = "Search";
      this.CBPet.FlatStyle = FlatStyle.Flat;
      this.CBPet.FormattingEnabled = true;
      this.CBPet.Location = new Point(43, 95);
      this.CBPet.Name = "CBPet";
      this.CBPet.Size = new Size(204, 24);
      this.CBPet.TabIndex = 54;
      this.CBPet.SelectedIndexChanged += new EventHandler(this.CBPet_SelectedIndexChanged);
      this.label132.AutoSize = true;
      this.label132.Location = new Point(6, 99);
      this.label132.Name = "label132";
      this.label132.Size = new Size(30, 16);
      this.label132.TabIndex = 53;
      this.label132.Text = "Pet:";
      this.label139.AutoSize = true;
      this.label139.Location = new Point(6, 73);
      this.label139.Name = "label139";
      this.label139.Size = new Size(33, 16);
      this.label139.TabIndex = 52;
      this.label139.Text = "Job:";
      this.label138.AutoSize = true;
      this.label138.Location = new Point(6, 48);
      this.label138.Name = "label138";
      this.label138.Size = new Size(44, 16);
      this.label138.TabIndex = 51;
      this.label138.Text = "Class:";
      this.comboBox19.FlatStyle = FlatStyle.Flat;
      this.comboBox19.FormattingEnabled = true;
      this.comboBox19.Location = new Point(43, 43);
      this.comboBox19.Name = "comboBox19";
      this.comboBox19.Size = new Size(204, 24);
      ...
      this.comboBox20.Location = new Point(43, 70);
      this.comboBox20.Name = "comboBox20";
      this.comboBox20.Size = new Size(204, 24);
      ...
      this.textBox203.Size = new Size(204, 22);
      ...
      this.tabPage1.Controls.Add((Control) this.textBox8);
      ...
      this.tabPage1.Size = new Size(1041, 595);
      ...
      this.tabPage5.Size = new Size(1027, 232);
      ...
      this.label115.Size = new Size(43, 16);
      ...
      this.textBox109.Size = new Size(38, 22);
      this.textBox109.TabIndex = 0;
      this.groupBox30.Controls.Add((Control) this.button16);
      this.groupBox30.Controls.Add((Control) this.button13);
      this.groupBox30.Controls.Add((Control) this.button14);
      this.groupBox30.Controls.Add((Control) this.button15);
      this.groupBox30.Controls.Add((Control) this.label142);
      this.groupBox30.Controls.Add((Control) this.button12);
      this.groupBox30.Controls.Add((Control) this.button11);
      this.groupBox30.Controls.Add((Control) this.button10);
      this.groupBox30.Controls.Add((Control) this.label134);
      this.groupBox30.Controls.Add((Control) this.label133);
      this.groupBox30.Controls.Add((Control) this.button9);
      this.groupBox30.Controls.Add((Control) this.button8);
      this.groupBox30.Controls.Add((Control) this.button7);
      ...
      this.groupBox30.Size = new Size(236, 113);
      this.groupBox30.TabIndex = 60;
      this.groupBox30.TabStop = false;
      this.groupBox30.Text = "Basic";
      this.button16.FlatStyle = FlatStyle.Flat;
      this.button16.Location = new Point(135, 88);
      this.button16.Name = "button16";
      this.button16.Size = new Size(29, 22);
      ...
      this.button13.Location = new Point(107, 88);
      this.button13.Name = "button13";
      this.button13.Size = new Size(29, 22);
      ...
      this.button14.Location = new Point(79, 88);
      this.button14.Name = "button14";
      this.button14.Size = new Size(29, 22);
      ...
      this.button10.Location = new Point(168, 63);
      this.button10.Name = "button10";
      this.button10.Size = new Size(22, 22);
      this.button10.TabIndex = 62;
      this.button10.Text = "1";
      this.button10.UseVisualStyleBackColor = true;
      this.button10.Click += new EventHandler(this.Button10_Click);
      this.label134.AutoSize = true;
      this.label134.Location = new Point(137, 68);
      this.label134.Name = "label134";
      this.label134.Size = new Size(42, 16);
      this.label134.TabIndex = 61;
      this.label134.Text = "Days:";
      this.label133.AutoSize = true;
      this.label133.Location = new Point(6, 69);
      this.label133.Name = "label133";
      this.label133.Size = new Size(56, 16);
      this.label133.TabIndex = 60;
      this.label133.Text = "Minutes:";
      this.button9.FlatStyle = FlatStyle.Flat;
      this.button9.Location = new Point(107, 64);
      this.button9.Name = "button9";
      this.button9.Size = new Size(29, 22);
      this.button9.TabIndex = 59;
      this.button9.Text = "60";
      this.button9.UseVisualStyleBackColor = true;
      this.button9.Click += new EventHandler(this.Button9_Click);
      this.button8.FlatStyle = FlatStyle.Flat;
      this.button8.Location = new Point(79, 64);
      this.button8.Name = "button8";
      this.button8.Size = new Size(29, 22);
      this.button8.TabIndex = 58;
      this.button8.Text = "30";
      this.button8.UseVisualStyleBackColor = true;
      this.button8.Click += new EventHandler(this.Button8_Click);
      this.button7.FlatStyle = FlatStyle.Flat;
      this.button7.Location = new Point(57, 64);
      this.button7.Name = "button7";
      this.button7.Size = new Size(23, 22);
      this.button7.TabIndex = 4;
      this.button7.Text = "5";
      this.button7.UseVisualStyleBackColor = true;
      this.button7.Click += new EventHandler(this.Button7_Click);
      this.textBox128.BorderStyle = BorderStyle.FixedSingle;
      this.textBox128.Location = new Point(172, 12);
      this.textBox128.Name = "textBox128";
      this.textBox128.Size = new Size(58, 22);
      this.textBox128.TabIndex = 57;
      this.textBox85.BorderStyle = BorderStyle.FixedSingle;
      this.textBox85.Location = new Point(71, 12);
      this.textBox85.Name = "textBox85";
      this.textBox85.Size = new Size(28, 22);
      this.textBox85.TabIndex = 3;
      this.label129.AutoSize = true;
      this.label129.Location = new Point(125, 14);
      this.label129.Name = "label129";
      this.label129.Size = new Size(50, 16);
      this.label129.TabIndex = 56;
      this.label129.Text = "Target:";
      this.label86.AutoSize = true;
      this.label86.Location = new Point(6, 14);
      this.label86.Name = "label86";
      this.label86.Size = new Size(43, 16);
      this.label86.TabIndex = 4;
      this.label86.Text = "Level:";
      this.textBox89.BorderStyle = BorderStyle.FixedSingle;
      this.textBox89.Location = new Point(172, 39);
      this.textBox89.Name = "textBox89";
      this.textBox89.Size = new Size(59, 22);
      this.textBox89.TabIndex = 11;
      this.toolTip1.SetToolTip((Control) this.textBox89, "10 duration is 1 second actual time");
      this.label90.AutoSize = true;
      this.label90.Location = new Point(125, 41);
      this.label90.Name = "label90";
      this.label90.Size = new Size(39, 16);
      this.label90.TabIndex = 12;
      this.label90.Text = "Dure:";
      this.textBox90.BorderStyle = BorderStyle.FixedSingle;
      this.textBox90.Location = new Point(54, 39);
      this.textBox90.Name = "textBox90";
      this.textBox90.Size = new Size(62, 22);
      this.textBox90.TabIndex = 14;
      this.label91.AutoSize = true;
      this.label91.Location = new Point(6, 41);
      this.label91.Name = "label91";
      this.label91.Size = new Size(48, 16);
      ...
      this.textBox124.Size = new Size(28, 22);
      ...
      this.textBox123.Size = new Size(28, 22);
      ...
      this.textBox122.Size = new Size(28, 22);
      ...
      this.pictureBox6.Location = new Point(346, 20);
      ...
      this.pictureBox7.BackgroundImage = (Image) Resources.oie_transparent;
      this.pictureBox7.BackgroundImageLayout = ImageLayout.Stretch;
      this.pictureBox7.Cursor = Cursors.Hand;
      this.pictureBox7.Location = new Point(346, 46);
      ...
      this.pictureBox8.Location = new Point(346, 73);
      ...
      this.pictureBox9.BackgroundImage = (Image) Resources.oie_transparent;
      ...
      this.pictureBox9.Location = new Point(666, 25);
      ...
      this.pictureBox10.Location = new Point(666, 51);
      ...
      this.pictureBox11.BackgroundImage = (Image) Resources.oie_transparent;
      ...
      this.pictureBox11.Location = new Point(666, 77);
      ...
      this.groupBox27.Controls.Add((Control) this.PbMagicIdx3);
      this.groupBox27.Controls.Add((Control) this.PbMagicIdx2);
      this.groupBox27.Controls.Add((Control) this.PbMagicIdx1);
      ...
      this.PbMagicIdx3.BackColor = SystemColors.Control;
      this.PbMagicIdx3.BackgroundImage = (Image) Resources.oie_transparent;
      this.PbMagicIdx3.BackgroundImageLayout = ImageLayout.Stretch;
      this.PbMagicIdx3.Cursor = Cursors.Hand;
      this.PbMagicIdx3.Location = new Point(47, 70);
      this.PbMagicIdx3.Name = "PbMagicIdx3";
      this.PbMagicIdx3.Size = new Size(20, 20);
      this.PbMagicIdx3.SizeMode = PictureBoxSizeMode.Zoom;
      this.PbMagicIdx3.TabIndex = 39;
      this.PbMagicIdx3.TabStop = false;
      this.toolTip1.SetToolTip((Control) this.PbMagicIdx3, "Select MagicID");
      this.PbMagicIdx3.Click += new EventHandler(this.PbMagicIdx3_Click);
      this.PbMagicIdx2.BackColor = SystemColors.Control;
      this.PbMagicIdx2.BackgroundImage = (Image) Resources.oie_transparent;
      this.PbMagicIdx2.BackgroundImageLayout = ImageLayout.Stretch;
      this.PbMagicIdx2.Cursor = Cursors.Hand;
      this.PbMagicIdx2.Location = new Point(47, 44);
      this.PbMagicIdx2.Name = "PbMagicIdx2";
      this.PbMagicIdx2.Size = new Size(20, 20);
      this.PbMagicIdx2.SizeMode = PictureBoxSizeMode.Zoom;
      this.PbMagicIdx2.TabIndex = 38;
      this.PbMagicIdx2.TabStop = false;
      this.toolTip1.SetToolTip((Control) this.PbMagicIdx2, "Select MagicID");
      this.PbMagicIdx2.Click += new EventHandler(this.PbMagicIdx2_Click);
      this.PbMagicIdx1.BackColor = SystemColors.Control;
      this.PbMagicIdx1.BackgroundImage = (Image) Resources.oie_transparent;
      this.PbMagicIdx1.BackgroundImageLayout = ImageLayout.Stretch;
      this.PbMagicIdx1.Cursor = Cursors.Hand;
      this.PbMagicIdx1.Location = new Point(47, 16);
      this.PbMagicIdx1.Name = "PbMagicIdx1";
      this.PbMagicIdx1.Size = new Size(20, 20);
      this.PbMagicIdx1.SizeMode = PictureBoxSizeMode.Zoom;
      this.PbMagicIdx1.TabIndex = 37;
      this.PbMagicIdx1.TabStop = false;
      this.toolTip1.SetToolTip((Control) this.PbMagicIdx1, "Select MagicID");
      this.PbMagicIdx1.Click += new EventHandler(this.PbMagicIdx1_Click);
      this.textBox120.BorderStyle = BorderStyle.FixedSingle;
      this.textBox120.Location = new Point(169, 69);
      this.textBox120.Name = "textBox120";
      this.textBox120.Size = new Size(21, 22);
      this.textBox120.TabIndex = 11;
      this.label121.AutoSize = true;
      this.label121.Location = new Point(121, 71);
      this.label121.Name = "label121";
      this.label121.Size = new Size(43, 16);
      this.label121.TabIndex = 10;
      this.label121.Text = "Level:";
      this.textBox119.BorderStyle = BorderStyle.FixedSingle;
      this.textBox119.Location = new Point(73, 69);
      this.textBox119.Name = "textBox119";
      this.textBox119.Size = new Size(36, 22);
      this.textBox119.TabIndex = 9;
      this.label120.AutoSize = true;
      this.label120.Location = new Point(9, 70);
      this.label120.Name = "label120";
      this.label120.Size = new Size(42, 16);
      this.label120.TabIndex = 8;
      this.label120.Text = "Index:";
      this.textBox118.BorderStyle = BorderStyle.FixedSingle;
      this.textBox118.Location = new Point(169, 42);
      this.textBox118.Name = "textBox118";
      this.textBox118.Size = new Size(21, 22);
      this.textBox118.TabIndex = 7;
      this.label119.AutoSize = true;
      this.label119.Location = new Point(121, 42);
      this.label119.Name = "label119";
      this.label119.Size = new Size(43, 16);
      this.label119.TabIndex = 6;
      this.label119.Text = "Level:";
      this.textBox117.BorderStyle = BorderStyle.FixedSingle;
      this.textBox117.Location = new Point(73, 42);
      this.textBox117.Name = "textBox117";
      this.textBox117.Size = new Size(36, 22);
      this.textBox117.TabIndex = 5;
      this.label118.AutoSize = true;
      this.label118.Location = new Point(9, 45);
      this.label118.Name = "label118";
      this.label118.Size = new Size(42, 16);
      this.label118.TabIndex = 4;
      this.label118.Text = "Index:";
      this.textBox116.BorderStyle = BorderStyle.FixedSingle;
      this.textBox116.Location = new Point(169, 16);
      this.textBox116.Name = "textBox116";
      this.textBox116.Size = new Size(21, 22);
      this.textBox116.TabIndex = 3;
      this.label117.AutoSize = true;
      this.label117.Location = new Point(121, 18);
      this.label117.Name = "label117";
      this.label117.Size = new Size(43, 16);
      this.label117.TabIndex = 2;
      this.label117.Text = "Level:";
      this.textBox115.BorderStyle = BorderStyle.FixedSingle;
      this.textBox115.Location = new Point(73, 16);
      this.textBox115.Name = "textBox115";
      this.textBox115.Size = new Size(36, 22);
      this.textBox115.TabIndex = 1;
      this.label116.AutoSize = true;
      this.label116.Location = new Point(9, 18);
      this.label116.Name = "label116";
      this.label116.Size = new Size(42, 16);
      ...
      this.label95.Size = new Size(29, 16);
      ...
      this.textBox94.Size = new Size(43, 22);
      ...
      this.label94.Size = new Size(35, 16);
      ...
      this.textBox92.Size = new Size(43, 22);
      ...
      this.label92.Size = new Size(35, 16);
      ...
      this.textBox86.Size = new Size(65, 22);
      this.textBox86.TabIndex = 5;
      this.label87.AutoSize = true;
      this.label87.Location = new Point(6, 26);
      this.label87.Name = "label87";
      this.label87.Size = new Size(29, 16);
      this.label87.TabIndex = 6;
      this.label87.Text = "HP:";
      this.groupBox7.Controls.Add((Control) this.btnCopyLevel);
      ...
      this.btnCopyLevel.FlatStyle = FlatStyle.Flat;
      this.btnCopyLevel.Location = new Point(62, 71);
      this.btnCopyLevel.Margin = new Padding(2);
      this.btnCopyLevel.Name = "btnCopyLevel";
      this.btnCopyLevel.Size = new Size(51, 25);
      this.btnCopyLevel.TabIndex = 3;
      this.btnCopyLevel.Text = "Copy";
      this.btnCopyLevel.UseVisualStyleBackColor = true;
      this.btnCopyLevel.Click += new EventHandler(this.BtnCopyLevel_Click);
      ...
      this.listBox2.Size = new Size(50, 196);
      ...
      this.textBox136.Size = new Size(30, 22);
      ...
      this.textBox132.Size = new Size(30, 22);
      ...
      this.linkLabel1.Size = new Size(73, 16);
      ...
      this.label75.Size = new Size(30, 16);
      ...
      this.textBox55.Size = new Size(41, 22);
      ...
      this.textBox52.Size = new Size(185, 22);
      ...
      this.label31.Size = new Size(72, 16);
      ...
      this.textBox29.Size = new Size(52, 22);
      ...
      this.textBox22.Size = new Size(35, 22);
      ...
      this.textBox23.Size = new Size(35, 22);
      ...
      this.label19.Size = new Size(52, 16);
      ...
      this.comboBox18.Size = new Size(180, 24);
      ...
      this.textBox17.Size = new Size(22, 22);
      ...
      this.comboBox17.Size = new Size(180, 24);
      ...
      this.label18.Size = new Size(52, 16);
      ...
      this.textBox16.Size = new Size(22, 22);
      ...
      this.textBox14.Size = new Size(34, 22);
      ...
      this.textBox13.Size = new Size(17, 22);
      ...
      this.comboBox16.Size = new Size(130, 24);
      ...
      this.pictureBox3.BackgroundImage = (Image) Resources.Flag;
      ...
      this.label82.Size = new Size(68, 16);
      ...
      this.textBox81.Size = new Size(66, 22);
      this.textBox81.TabIndex = 24;
      this.pictureBox2.BackgroundImage = (Image) Resources.Flag;
      ...
      this.label78.Size = new Size(65, 16);
      ...
      this.textBox7.Size = new Size(66, 22);
      this.textBox7.TabIndex = 21;
      this.groupBox4.Controls.Add((Control) this.PbUseState);
      this.groupBox4.Controls.Add((Control) this.PbAppState);
      ...
      this.groupBox4.Size = new Size(337, 145);
      this.groupBox4.TabIndex = 20;
      this.groupBox4.TabStop = false;
      this.groupBox4.Text = "Other";
      this.PbUseState.BackColor = SystemColors.Control;
      this.PbUseState.BackgroundImage = (Image) Resources.oie_transparent;
      this.PbUseState.BackgroundImageLayout = ImageLayout.Stretch;
      this.PbUseState.Cursor = Cursors.Hand;
      this.PbUseState.Location = new Point(257, 84);
      this.PbUseState.Name = "PbUseState";
      this.PbUseState.Size = new Size(20, 20);
      this.PbUseState.SizeMode = PictureBoxSizeMode.Zoom;
      this.PbUseState.TabIndex = 48;
      this.PbUseState.TabStop = false;
      this.toolTip1.SetToolTip((Control) this.PbUseState, "Use State Select");
      this.PbUseState.Click += new EventHandler(this.PbUseState_Click);
      this.PbAppState.BackColor = SystemColors.Control;
      this.PbAppState.BackgroundImage = (Image) Resources.oie_transparent;
      this.PbAppState.BackgroundImageLayout = ImageLayout.Stretch;
      this.PbAppState.Cursor = Cursors.Hand;
      this.PbAppState.Location = new Point(257, 53);
      this.PbAppState.Name = "PbAppState";
      this.PbAppState.Size = new Size(20, 20);
      this.PbAppState.SizeMode = PictureBoxSizeMode.Zoom;
      this.PbAppState.TabIndex = 40;
      this.PbAppState.TabStop = false;
      this.toolTip1.SetToolTip((Control) this.PbAppState, "App State Select");
      this.PbAppState.Click += new EventHandler(this.PbAppState_Click);
      this.textBox25.BorderStyle = BorderStyle.FixedSingle;
      this.textBox25.Location = new Point(217, 53);
      this.textBox25.Name = "textBox25";
      this.textBox25.Size = new Size(34, 22);
      this.textBox25.TabIndex = 47;
      this.textBox15.BorderStyle = BorderStyle.FixedSingle;
      this.textBox15.Location = new Point(217, 82);
      this.textBox15.Name = "textBox15";
      this.textBox15.Size = new Size(34, 22);
      this.textBox15.TabIndex = 30;
      this.label16.AutoSize = true;
      this.label16.Location = new Point(144, 57);
      this.label16.Name = "label16";
      this.label16.Size = new Size(69, 16);
      this.label16.TabIndex = 38;
      this.label16.Text = "App State:";
      this.label8.AutoSize = true;
      this.label8.Location = new Point(7, 24);
      this.label8.Name = "label8";
      this.label8.Size = new Size(42, 16);
      this.label8.TabIndex = 21;
      this.label8.Text = "Type:";
      this.textBox6.BorderStyle = BorderStyle.FixedSingle;
      this.textBox6.Location = new Point(294, 20);
      this.textBox6.Name = "textBox6";
      this.textBox6.Size = new Size(34, 22);
      this.textBox6.TabIndex = 19;
      this.textBox6.Visible = false;
      this.label15.AutoSize = true;
      this.label15.Location = new Point(144, 88);
      this.label15.Name = "label15";
      this.label15.Size = new Size(69, 16);
      ...
      this.comboBox15.Size = new Size(235, 24);
      ...
      this.textBox9.Location = new Point(217, 110);
      this.textBox9.Name = "textBox9";
      this.textBox9.Size = new Size(34, 22);
      this.textBox9.TabIndex = 27;
      this.label14.AutoSize = true;
      this.label14.Location = new Point(10, 108);
      this.label14.Name = "label14";
      this.label14.Size = new Size(89, 16);
      this.label14.TabIndex = 34;
      this.label14.Text = "Soul Consum:";
      this.label11.AutoSize = true;
      this.label11.Location = new Point(144, 113);
      ...
      this.textBox11.Size = new Size(34, 22);
      ...
      this.comboBox1.Size = new Size(174, 24);
      ...
      this.comboBox14.Size = new Size(174, 24);
      ...
      this.textBox3.Size = new Size(26, 22);
      ...
      this.comboBox3.Size = new Size(174, 24);
      ...
      this.comboBox5.Size = new Size(174, 24);
      ...
      this.comboBox10.Size = new Size(174, 24);
      ...
      this.comboBox13.Size = new Size(174, 24);
      ...
      this.comboBox9.Size = new Size(174, 24);
      ...
      this.comboBox11.Size = new Size(174, 24);
      ...
      this.comboBox2.Size = new Size(174, 24);
      ...
      this.comboBox6.Size = new Size(174, 24);
      ...
      this.comboBox7.Size = new Size(174, 24);
      ...
      this.comboBox4.Size = new Size(174, 24);
      ...
      this.comboBox12.Size = new Size(174, 24);
      ...
      this.comboBox8.Size = new Size(174, 24);
      ...
      this.tabPage3.Size = new Size(1041, 595);
      ...
      this.textBox76.Size = new Size(65, 22);
      ...
      this.textBox75.Size = new Size(65, 22);
      ...
      this.textBox51.Size = new Size(65, 22);
      ...
      this.textBox50.Size = new Size(65, 22);
      ...
      this.textBox33.Size = new Size(169, 22);
      ...
      this.textBox148.Size = new Size(30, 22);
      ...
      this.textBox140.Size = new Size(30, 22);
      ...
      this.textBox144.Size = new Size(30, 22);
      ...
      this.textBox53.Size = new Size(58, 22);
      ...
      this.button6.Location = new Point(939, 653);
      ...
      this.button2.Location = new Point(1040, 653);
      ...
      this.label130.Size = new Size(81, 24);
      this.label130.TabIndex = 59;
      this.label130.Text = "label130";
      this.label130.Visible = false;
      this.label131.AutoSize = true;
      this.label131.BackColor = SystemColors.Menu;
      this.label131.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.label131.Location = new Point(1076, 3);
      this.label131.Name = "label131";
      this.label131.Size = new Size(192, 20);
      ...
      this.lblLang.Location = new Point(1230, 5);
      ...
      this.btnSaveAndNext.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.btnSaveAndNext.Location = new Point(1184, 653);
      this.btnSaveAndNext.Name = "btnSaveAndNext";
      this.btnSaveAndNext.Size = new Size(143, 31);
      ...
      this.cbSkillLevel.Items.AddRange(new object[2]
      {
        (object) "t_skilllevel",
        (object) "t_skillLevel"
      });
      this.cbSkillLevel.Location = new Point(543, 2);
      this.cbSkillLevel.Name = "cbSkillLevel";
      this.cbSkillLevel.Size = new Size(121, 24);
      this.cbSkillLevel.TabIndex = 58;
      this.cbMagicLevel.FormattingEnabled = true;
      this.cbMagicLevel.Items.AddRange(new object[2]
      {
        (object) "t_magiclevel",
        (object) "t_magicLevel"
      });
      this.cbMagicLevel.Location = new Point(721, 2);
      this.cbMagicLevel.Name = "cbMagicLevel";
      this.cbMagicLevel.Size = new Size(73, 24);
      this.cbMagicLevel.TabIndex = 106;
      this.label140.AutoSize = true;
      this.label140.Location = new Point(500, 6);
      this.label140.Name = "label140";
      this.label140.Size = new Size(44, 16);
      this.label140.TabIndex = 107;
      this.label140.Text = "SKILL:";
      this.label141.AutoSize = true;
      this.label141.BackColor = SystemColors.Menu;
      this.label141.Location = new Point(671, 5);
      this.label141.Name = "label141";
      this.label141.Size = new Size(52, 16);
      this.label141.TabIndex = 108;
      this.label141.Text = "MAGIC:";
      this.textBox8.BorderStyle = BorderStyle.FixedSingle;
      this.textBox8.Location = new Point(502, 312);
      this.textBox8.Name = "textBox8";
      this.textBox8.Size = new Size(46, 22);
      this.textBox8.TabIndex = 58;
      this.label9.AutoSize = true;
      this.label9.Location = new Point(413, 314);
      ...
      this.Controls.Add((Control) this.cbMagicLevel);
      this.Controls.Add((Control) this.cbSkillLevel);
      ...
      ((ISupportInitialize) this.PbMagicIdx3).EndInit();
      ((ISupportInitialize) this.PbMagicIdx2).EndInit();
      ((ISupportInitialize) this.PbMagicIdx1).EndInit();
      ...
      ((ISupportInitialize) this.PbUseState).EndInit();
      ((ISupportInitialize) this.PbAppState).EndInit();
    ...
    private void pictureBox7_Click(object sender, EventArgs e)
    {
      ...
      if (skillPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox99.Text = skillPicker.SkillIndex.ToString();
    }
    ...
    private void pictureBox8_Click(object sender, EventArgs e)
    {
      ...
      if (skillPicker.ShowDialog() != DialogResult.OK)
        return;
      this.textBox101.Text = skillPicker.SkillIndex.ToString();
    }
    ...
    {
      FlagBuilder flagBuilder = new FlagBuilder();
      flagBuilder.flagSmall = Convert.ToInt32(this.textBox81.Text);
      flagBuilder.flagBuilderType = "skills2";
      if (flagBuilder.ShowDialog() != DialogResult.OK)
        return;
      this.textBox81.Text = flagBuilder.flagSmall.ToString();
    }

    private void PbUseState_Click(object sender, EventArgs e)
    {
      FlagBuilder flagBuilder = new FlagBuilder();
      flagBuilder.flagSmall = Convert.ToInt32(this.textBox15.Text);
      flagBuilder.flagBuilderType = "skills1";
      if (flagBuilder.ShowDialog() != DialogResult.OK)
        return;
      this.textBox15.Text = flagBuilder.flagSmall.ToString();
    }

    private void PbAppState_Click(object sender, EventArgs e)
    {
      FlagBuilder flagBuilder = new FlagBuilder();
      flagBuilder.flagSmall = Convert.ToInt32(this.textBox25.Text);
      flagBuilder.flagBuilderType = "skills1";
      if (flagBuilder.ShowDialog() != DialogResult.OK)
        return;
      this.textBox25.Text = flagBuilder.flagSmall.ToString();
    }

    private void btnCopy_Click(object sender, EventArgs e)
    {
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DROP TABLE IF EXISTS tempTable;CREATE TEMPORARY TABLE tempTable ENGINE=MEMORY SELECT * FROM t_skill WHERE a_index=" + this.textBox1.Text + ";SELECT a_index FROM tempTable;UPDATE tempTable SET a_index=(SELECT a_index from t_skill ORDER BY a_index DESC LIMIT 1)+1; SELECT a_index FROM tempTable;INSERT INTO t_skill SELECT * FROM tempTable;");
      this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, "DROP TABLE IF EXISTS tempTable;CREATE TEMPORARY TABLE tempTable ENGINE=MEMORY SELECT * FROM t_skillLevel WHERE a_index=" + this.textBox1.Text + ";SELECT a_index FROM tempTable;UPDATE tempTable SET a_index=(SELECT a_index from t_skillLevel ORDER BY a_index DESC LIMIT 1)+1; SELECT a_index FROM tempTable;INSERT INTO t_skillLevel SELECT * FROM tempTable;");
      this.LoadListBox();
      if (this.textBox203.Text != "")
        this.SearchList(this.textBox203.Text);
      this.listBox1.SelectedIndex = this.listBox1.Items.Count - 2;
    ...
    {
      if (this.textBox82.Text != "0" && this.textBox2.Text == "11")
      {
        this.mSortPet = this.GetIndexByComboBox(this.CBPet.Text).ToString();
        this.LoadListBox();
      }
      else
      {
    ...
    private void btnSaveAndNext_Click(object sender, EventArgs e)
    {
      ...
      else if (this.language == "USA")
      {
        ...
        this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str7 = this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string s = this.textBox54.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s));
        string Query = str5 + "a_name = '" + str6 + "', " + this.aname + "= '" + str6 + "', " + this.aClientDescripton + "= '" + str7 + "',a_client_description = '" + str7 + "', a_type = '" + this.textBox6.Text + "',a_flag= '" + this.textBox7.Text + "',a_maxLevel = '" + this.textBox8.Text + "',a_appRange = '" + this.textBox9.Text + "',a_fireRange = '" + this.textBox10.Text + "',a_fireRange2 = '" + this.textBox11.Text + "',a_minRange = '" + this.textBox12.Text + "',a_targetType = '" + this.textBox13.Text + "',a_targetNum = '" + this.textBox14.Text + "',a_useState = '" + this.textBox15.Text + "',a_useWeaponType0 = '" + this.textBox16.Text + "',a_useWeaponType1 = '" + this.textBox17.Text + "',a_use_needWearingType = '" + this.textBox18.Text + "',a_useMagicIndex1 = '" + this.textBox19.Text + "',a_useMagicIndex2 = '" + this.textBox20.Text + "',a_useMagicIndex3 = '" + this.textBox21.Text + "',a_useMagicLevel1 = '" + this.textBox22.Text + "',a_useMagicLevel2 = '" + this.textBox23.Text + "',a_useMagicLevel3 = '" + this.textBox24.Text + "',a_appState = '" + this.textBox25.Text + "',a_appWeaponType0 = '" + this.textBox26.Text + "',a_appWeaponType1 = '" + this.textBox27.Text + "',a_app_needWearingType = '" + this.textBox28.Text + "',a_readyTime = '" + this.textBox29.Text + "',a_stillTime = '" + this.textBox30.Text + "',a_fireTime = '" + this.textBox31.Text + "',a_reuseTime = '" + this.textBox32.Text + "',a_cd_ra = '" + this.textBox33.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re = '" + this.textBox34.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa = '" + this.textBox35.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa = '" + this.textBox36.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe0 = '" + this.textBox37.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe1 = '" + this.textBox38.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe2 = '" + this.textBox39.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot = '" + this.textBox40.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fos = '" + this.textBox41.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_ox = '" + this.textBox42.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oz = '" + this.textBox43.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oh = '" + this.textBox44.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oc = '" + this.textBox45.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fdc = '" + this.textBox46.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fd0 = '" + this.textBox47.Text.Replace(",", ".") + "',a_cd_fd1 = '" + this.textBox48.Text.Replace(",", ".") + "',a_cd_fd2 = '" + this.textBox49.Text.Replace(",", ".") + "',a_cd_fd3 = '" + this.textBox50.Text.Replace(",", ".") + "',a_cd_dd = '" + this.textBox51.Text + "',a_cd_fe_after = '" + this.textBox52.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe_after2 = '" + this.textBox53.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_client_tooltip = '" + s + "', " + this.aToolTip + "='" + s + "',a_client_icon_texid = '" + this.textBox55.Text + "',a_client_icon_row = '" + this.textBox56.Text + "',a_client_icon_col = '" + this.textBox57.Text + "',a_cd_ra2 = '" + this.textBox58.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re2 = '" + this.textBox59.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa2 = '" + this.textBox60.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa2 = '" + this.textBox61.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe3 = '" + this.textBox62.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe4 = '" + this.textBox63.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe5 = '" + this.textBox64.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot2 = '" + this.textBox65.Text + "',a_cd_fos2 = '" + this.textBox66.Text + "',a_cd_ox2 = '" + this.textBox67.Text + "',a_cd_oz2 = '" + this.textBox68.Text + "',a_cd_oh2 = '" + this.textBox69.Text + "',a_cd_oc2 = '" + this.textBox70.Text + "',a_cd_fdc2 = '" + this.textBox71.Text + "',a_cd_fd4 = '" + this.textBox72.Text.Replace(",", ".") + "',a_cd_fd5 = '" + this.textBox73.Text.Replace(",", ".") + "',a_cd_fd6 = '" + this.textBox74.Text.Replace(",", ".") + "',a_cd_fd7 = '" + this.textBox75.Text.Replace(",", ".") + "',a_cd_dd2 = '" + this.textBox76.Text + "',a_selfparam = '" + this.textBox77.Text + "',a_targetparam = '" + this.textBox78.Text + "',a_soul_consum = '" + this.textBox79.Text + "',a_summon_idx = '" + this.textBox80.Text + "',a_sorcerer_flag = '" + this.textBox81.Text + "',a_apet_index = '" + this.textBox82.Text + "',a_allowzone = '" + this.textBox83.Text + "' WHERE a_index = '" + this.textBox1.Text + "'";
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, Query);
        Console.WriteLine(Query);
      }
      else
      {
        ...
        this.aClientDescripton = this.ClientDescrFromLanguage();
        this.aToolTip = this.ToolTipFromLanguage();
        string str8 = "UPDATE t_skill SET a_index = '" + this.textBox1.Text + "', a_job = '" + this.textBox2.Text + "', a_job2 = '" + this.textBox3.Text + "', ";
        string str9 = this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.textBox4.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string str10 = this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        this.textBox5.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        string s = this.textBox54.Text.Replace("'", "\\'").Replace("\"", "\\\"");
        Encoding.GetEncoding("iso-8859-1").GetString(Encoding.GetEncoding("TIS-620").GetBytes(s));
        string Query = str8 + this.aname + "= '" + str9 + "', " + this.aClientDescripton + "= '" + str10 + "', a_type = '" + this.textBox6.Text + "',a_flag= '" + this.textBox7.Text + "',a_maxLevel = '" + this.textBox8.Text + "',a_appRange = '" + this.textBox9.Text + "',a_fireRange = '" + this.textBox10.Text + "',a_fireRange2 = '" + this.textBox11.Text + "',a_minRange = '" + this.textBox12.Text + "',a_targetType = '" + this.textBox13.Text + "',a_targetNum = '" + this.textBox14.Text + "',a_useState = '" + this.textBox15.Text + "',a_useWeaponType0 = '" + this.textBox16.Text + "',a_useWeaponType1 = '" + this.textBox17.Text + "',a_use_needWearingType = '" + this.textBox18.Text + "',a_useMagicIndex1 = '" + this.textBox19.Text + "',a_useMagicIndex2 = '" + this.textBox20.Text + "',a_useMagicIndex3 = '" + this.textBox21.Text + "',a_useMagicLevel1 = '" + this.textBox22.Text + "',a_useMagicLevel2 = '" + this.textBox23.Text + "',a_useMagicLevel3 = '" + this.textBox24.Text + "',a_appState = '" + this.textBox25.Text + "',a_appWeaponType0 = '" + this.textBox26.Text + "',a_appWeaponType1 = '" + this.textBox27.Text + "',a_app_needWearingType = '" + this.textBox28.Text + "',a_readyTime = '" + this.textBox29.Text + "',a_stillTime = '" + this.textBox30.Text + "',a_fireTime = '" + this.textBox31.Text + "',a_reuseTime = '" + this.textBox32.Text + "',a_cd_ra = '" + this.textBox33.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re = '" + this.textBox34.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa = '" + this.textBox35.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa = '" + this.textBox36.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe0 = '" + this.textBox37.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe1 = '" + this.textBox38.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe2 = '" + this.textBox39.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot = '" + this.textBox40.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fos = '" + this.textBox41.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_ox = '" + this.textBox42.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oz = '" + this.textBox43.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oh = '" + this.textBox44.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_oc = '" + this.textBox45.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fdc = '" + this.textBox46.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fd0 = '" + this.textBox47.Text.Replace(",", ".") + "',a_cd_fd1 = '" + this.textBox48.Text.Replace(",", ".") + "',a_cd_fd2 = '" + this.textBox49.Text.Replace(",", ".") + "',a_cd_fd3 = '" + this.textBox50.Text.Replace(",", ".") + "',a_cd_dd = '" + this.textBox51.Text + "',a_cd_fe_after = '" + this.textBox52.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe_after2 = '" + this.textBox53.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "', " + this.aToolTip + "='" + s + "',a_client_icon_texid = '" + this.textBox55.Text + "',a_client_icon_row = '" + this.textBox56.Text + "',a_client_icon_col = '" + this.textBox57.Text + "',a_cd_ra2 = '" + this.textBox58.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_re2 = '" + this.textBox59.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_sa2 = '" + this.textBox60.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fa2 = '" + this.textBox61.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe3 = '" + this.textBox62.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe4 = '" + this.textBox63.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fe5 = '" + this.textBox64.Text.Replace("'", "\\'").Replace("\"", "\\\"") + "',a_cd_fot2 = '" + this.textBox65.Text + "',a_cd_fos2 = '" + this.textBox66.Text + "',a_cd_ox2 = '" + this.textBox67.Text + "',a_cd_oz2 = '" + this.textBox68.Text + "',a_cd_oh2 = '" + this.textBox69.Text + "',a_cd_oc2 = '" + this.textBox70.Text + "',a_cd_fdc2 = '" + this.textBox71.Text + "',a_cd_fd4 = '" + this.textBox72.Text.Replace(",", ".") + "',a_cd_fd5 = '" + this.textBox73.Text.Replace(",", ".") + "',a_cd_fd6 = '" + this.textBox74.Text.Replace(",", ".") + "',a_cd_fd7 = '" + this.textBox75.Text.Replace(",", ".") + "',a_cd_dd2 = '" + this.textBox76.Text + "',a_selfparam = '" + this.textBox77.Text + "',a_targetparam = '" + this.textBox78.Text + "',a_soul_consum = '" + this.textBox79.Text + "',a_summon_idx = '" + this.textBox80.Text + "',a_sorcerer_flag = '" + this.textBox81.Text + "',a_apet_index = '" + this.textBox82.Text + "',a_allowzone = '" + this.textBox83.Text + "' WHERE a_index = '" + this.textBox1.Text + "'";
        this.databaseHandle.SendQueryMySql(this.Host, this.User, this.Password, this.Database, Query);
        Console.WriteLine(Query);
      }
      this.label130.Text = "Update Skill Succesfully!";
    ...
    {
      this.textBox89.Text = Convert.ToString(3000);
    }

    private void Button8_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(18000);
    }

    private void Button9_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(36000);
    }

    private void Button10_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(864000);
    }

    private void Button11_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(2592000);
    }

    private void Button12_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(6048000);
    }

    private void SKILLSCOST0SPToolStripMenuItem_Click(object sender, EventArgs e)
    {
      if (this.cbSkillLevel.Text == "" || this.cbMagicLevel.Text == "")
      {
        int num1 = (int) MessageBox.Show("Please Select Skill Level or Magic Level");
      }
      else
      {
        int num2 = (int) MessageBox.Show(this.cbSkillLevel.Text);
      }
    }

    private void SKILLSREQUIRENOITEMSToolStripMenuItem_Click(object sender, EventArgs e)
    {
      if (!(this.cbSkillLevel.Text == "") && !(this.cbMagicLevel.Text == ""))
        return;
      int num = (int) MessageBox.Show("Please Select Skill Level or Magic Level");
    }

    private void SKILLSREQUIRENOITEMLEARNToolStripMenuItem_Click(object sender, EventArgs e)
    {
      if (!(this.cbSkillLevel.Text == "") && !(this.cbMagicLevel.Text == ""))
        return;
      int num = (int) MessageBox.Show("Please Select Skill Level or Magic Level");
    ...
    {
      this.textBox89.Text = Convert.ToString(72000);
    }

    private void Button14_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(108000);
    }

    private void Button13_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(216000);
    }

    private void Button16_Click(object sender, EventArgs e)
    {
      this.textBox89.Text = Convert.ToString(252000);
    }

    private void exportSkillTreebinToolStripMenuItem_Click(object sender, EventArgs e)
    {
      this.exportLodHandle.ExportSkillTree_V4();
    }

    private void exportStrSkillslodToolStripMenuItem_Click(object sender, EventArgs e)
    {
      new FormExport().Show();
    }
